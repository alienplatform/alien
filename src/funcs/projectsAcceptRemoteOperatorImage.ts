 ...
 */
export function projectsAcceptRemoteOperatorImage(
  client: AlienCore,
  request: operations.AcceptRemoteOperatorImageRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AcceptRemoteOperatorImageResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AcceptRemoteOperatorImageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/v1/projects/{idOrName}/remote-operator-summary/installations/{deploymentId}/accept-image",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "acceptRemoteOperatorImage",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AcceptRemoteOperatorImageResponse$inboundSchema),
