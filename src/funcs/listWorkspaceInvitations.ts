...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListWorkspaceInvitationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/workspaces/{id}/invitations")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListWorkspaceInvitationsResponse$inboundSchema),
