 ...
 */
export function projectsConfigureRegistry(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConfigureProjectRegistryRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "configureProjectRegistry",
    oAuth2Scopes: null,
