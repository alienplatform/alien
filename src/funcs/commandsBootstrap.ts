...
export function commandsBootstrap(
  ...
  Result<
    models.CommandBootstrapResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CommandBootstrapRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/commands/bootstrap")();
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "403", "404", "422", "4XX", "500", "503", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CommandBootstrapResponse$inboundSchema),
    M.jsonErr([400, 401, 403, 404, 422], errors.APIError$inboundSchema),
