...
export function operatorManifestsPrepareOperatorManifestPackage(
  ...
  Result<
    models.PrepareOperatorManifestPackageResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const context = {
    ...
    operationID: "prepareOperatorManifestPackage",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PrepareOperatorManifestPackageResponse$inboundSchema),
