 ...
 */
export function deploymentGroupsDeleteExternalAIBinding(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteExternalAIBindingRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "deleteExternalAIBinding",
    oAuth2Scopes: null,
