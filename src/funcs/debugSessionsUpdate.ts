...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateDebugSessionRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateDebugSessionRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/debug-sessions/{id}")(pathParams);
  ...
  const context = {
    ...
    operationID: "updateDebugSession",
    oAuth2Scopes: null,
