 ...
 */
export function releasesListDeployments(
  client: AlienCore,
  request: operations.ListReleaseDeploymentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ReleaseDeploymentsResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListReleaseDeploymentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/releases/{id}/deployments")(pathParams);
  ...
  const context = {
    ...
    operationID: "listReleaseDeployments",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ReleaseDeploymentsResponse$inboundSchema),
