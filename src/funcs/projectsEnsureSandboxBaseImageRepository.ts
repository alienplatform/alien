 ...
 */
export function projectsEnsureSandboxBaseImageRepository(
  client: AlienCore,
  request: operations.EnsureProjectSandboxBaseImageRepositoryRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.SandboxBaseImageRepository,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.EnsureProjectSandboxBaseImageRepositoryRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc(
    "/v1/projects/{idOrName}/project-capabilities/remote-sandbox/base-image-repository",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "ensureProjectSandboxBaseImageRepository",
    oAuth2Scopes: null,
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["403", "404", "4XX", "500", "502", "503", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SandboxBaseImageRepository$inboundSchema),
