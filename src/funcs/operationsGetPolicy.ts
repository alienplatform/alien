 ...
 */
export function operationsGetPolicy(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetOperationsPolicyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/operations/policy")();
  ...
  const context = {
    ...
    operationID: "getOperationsPolicy",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.OperationsPolicyResponse$inboundSchema),
