...
export function operationsVerifyCheck(
  ...
  Result<
    models.VerifyOperationCheckResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.VerifyOperationCheckRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.VerifyOperationCheckRequest, {
    explode: true,
  });

  const path = pathToFunc("/v1/operations/verify-check")();
  ...
  const context = {
    ...
    operationID: "verifyOperationCheck",
    oAuth2Scopes: null,
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "403", "404", "4XX", "500", "502", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VerifyOperationCheckResponse$inboundSchema),
