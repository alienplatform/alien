 ...
 */
export function deploymentsSetFirstPartyDeploymentInputs(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.SetFirstPartyDeploymentInputsRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/v1/deployments/first-party-inputs")();
  ...
  const context = {
    ...
    operationID: "setFirstPartyDeploymentInputs",
    oAuth2Scopes: null,
