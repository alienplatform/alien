 ...
 */
export function agentSessionsEvents(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAgentSessionEventsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/agent-sessions/{id}/events")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AgentSessionEventsResponse$inboundSchema),
    M.jsonErr([400, 403, 404, 422], errors.APIError$inboundSchema),
