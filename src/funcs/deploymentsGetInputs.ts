 ...
 */
export function deploymentsGetInputs(
  client: AlienCore,
  request: operations.GetDeploymentInputsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.DeploymentInputsResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDeploymentInputsRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getDeploymentInputs",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeploymentInputsResponse$inboundSchema),
