...
> {
  ...
  const body = encodeJSON("body", payload.UpdateWorkspaceSettingsRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/workspaces/{id}/settings")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AgentSettings$inboundSchema),
