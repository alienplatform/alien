 ...
 */
export function deploymentGroupsGetDeploymentGroupByExternalId(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDeploymentGroupByExternalIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "getDeploymentGroupByExternalId",
    oAuth2Scopes: null,
