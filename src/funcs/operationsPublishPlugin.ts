...
> {
  ...
  const body = encodeJSON("body", payload.PublishOperationsPluginRequest, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "publishOperationsPlugin",
    oAuth2Scopes: null,
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "402", "409", "4XX", "500", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.PublishOperationsPluginResponse$inboundSchema),
    M.jsonErr([400, 402, 409], errors.APIError$inboundSchema),
