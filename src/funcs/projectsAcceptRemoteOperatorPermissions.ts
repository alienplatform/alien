 ...
 */
export function projectsAcceptRemoteOperatorPermissions(
  client: AlienCore,
  request: operations.AcceptRemoteOperatorPermissionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AcceptRemoteOperatorPermissionsResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AcceptRemoteOperatorPermissionsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc(
    "/v1/projects/{idOrName}/remote-operator-summary/installations/{deploymentId}/accept-permissions",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "acceptRemoteOperatorPermissions",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.AcceptRemoteOperatorPermissionsResponse$inboundSchema,
    ),
