...
export function operationsSetPluginEnabled(
  ...
  Result<
    models.SetOperationsPluginEnabledResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SetOperationsPluginEnabledRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.SetOperationsPluginEnabledRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/operations/plugins/{name}/enabled")(pathParams);
  ...
  const context = {
    ...
    operationID: "setOperationsPluginEnabled",
    oAuth2Scopes: null,
