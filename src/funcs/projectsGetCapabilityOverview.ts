 ...
 */
export function projectsGetCapabilityOverview(
  client: AlienCore,
  request: operations.GetProjectCapabilityOverviewRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ProjectCapabilityOverview,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetProjectCapabilityOverviewRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "getProjectCapabilityOverview",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProjectCapabilityOverview$inboundSchema),
