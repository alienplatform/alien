...
export function releasesPromote(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PromoteReleaseRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/release-channels/{name}/promote")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ReleaseChannel$inboundSchema),
