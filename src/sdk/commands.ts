 ...
 * @generated-id: 607335816380
 */

import { commandsBootstrap } from "../funcs/commandsBootstrap.js";
...
export class Commands extends ClientSDK {
   ...
   */
  async bootstrap(
    request: models.CommandBootstrapRequest,
    options?: RequestOptions,
  ): Promise<models.CommandBootstrapResponse> {
    return unwrapAsync(commandsBootstrap(
      this,
      request,
      options,
    ));
