...
export function eventActor4FromJSON(
  jsonString: string,
): SafeParseResult<EventActor4, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EventActor4$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EventActor4' from JSON`,
  );
}
...
export function eventActorUnion4FromJSON(
  jsonString: string,
): SafeParseResult<EventActorUnion4, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EventActorUnion4$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EventActorUnion4' from JSON`,
  );
}
...
/** @internal */
export const EventKind3$inboundSchema: z.ZodEnum<typeof EventKind3> = z.enum(
  EventKind3,
);
...
export function eventActor3FromJSON(
  jsonString: string,
): SafeParseResult<EventActor3, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EventActor3$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EventActor3' from JSON`,
  );
}
...
export function eventActorUnion3FromJSON(
  jsonString: string,
): SafeParseResult<EventActorUnion3, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EventActorUnion3$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EventActorUnion3' from JSON`,
  );
}
...
/** @internal */
export const EventDataDeploymentReleaseChannelChanged$inboundSchema: z.ZodType<
  EventDataDeploymentReleaseChannelChanged,
  unknown
> = z.object({
...
export function eventDataDeploymentReleaseChannelChangedFromJSON(
  jsonString: string,
): SafeParseResult<
  EventDataDeploymentReleaseChannelChanged,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      EventDataDeploymentReleaseChannelChanged$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'EventDataDeploymentReleaseChannelChanged' from JSON`,
  );
}
...
/** @internal */
export const EventDataReleaseChannelUpdated$inboundSchema: z.ZodType<
  EventDataReleaseChannelUpdated,
  unknown
> = z.object({
...
export function eventDataReleaseChannelUpdatedFromJSON(
  jsonString: string,
): SafeParseResult<EventDataReleaseChannelUpdated, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EventDataReleaseChannelUpdated$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EventDataReleaseChannelUpdated' from JSON`,
  );
}
...
export const EventDataUnion$inboundSchema: z.ZodType<EventDataUnion, unknown> =
  z.union([
    ...
    z.lazy(() => EventDataReleaseChannelUpdated$inboundSchema),
    z.lazy(() => EventDataDeploymentReleaseChannelChanged$inboundSchema),
