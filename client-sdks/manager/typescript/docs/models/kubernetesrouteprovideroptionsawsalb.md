...
```typescript
import { KubernetesRouteProviderOptionsAwsAlb } from "@alienplatform/manager-api/models";

let value: KubernetesRouteProviderOptionsAwsAlb = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                | *"awsAlb"*                                                                | :heavy_check_mark:                                                        | N/A                                                                       |
