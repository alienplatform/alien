...
```typescript
import { MachinesComputeMachineStatus } from "@alienplatform/manager-api/models";

let value: MachinesComputeMachineStatus = {
  capacityGroup: "<value>",
  drainForce: true,
  lastHeartbeat: "<value>",
  machineId: "<id>",
...
| `drainBlockers`                                                  | [models.ComputeDrainBlocker](../models/computedrainblocker.md)[] | :heavy_minus_sign:                                               | N/A                                                              |
