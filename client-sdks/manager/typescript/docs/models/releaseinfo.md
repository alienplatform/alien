...
```typescript
import { ReleaseInfo } from "@alienplatform/manager-api/models";

let value: ReleaseInfo = {
  releaseId: "<id>",
  stack: {
    id: "<id>",
    resources: {
...
| `stack`                                   | [models.Stack](../models/stack.md)        | :heavy_check_mark:                        | A bag of resources, unaware of any cloud. |
