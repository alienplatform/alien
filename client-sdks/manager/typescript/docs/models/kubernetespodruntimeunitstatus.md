...
```typescript
import { KubernetesPodRuntimeUnitStatus } from "@alienplatform/manager-api/models";

let value: KubernetesPodRuntimeUnitStatus = {
  name: "<value>",
  ownerReferences: [],
  ready: true,
  restartCount: 247791,
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `containers`                                                               | [models.ContainerImageIdentity](../models/containerimageidentity.md)[]     | :heavy_minus_sign:                                                         | N/A                                                                        |
