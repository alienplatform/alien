...
| `created`                                                                                                                          | *boolean*                                                                                                                          | :heavy_minus_sign:                                                                                                                 | Whether this request created the returned command. False means an<br/>idempotent replay returned a command created by another request. |
