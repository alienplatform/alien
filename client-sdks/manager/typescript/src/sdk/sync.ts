...
import { syncOperatorSync } from "../funcs/syncOperatorSync.js";
...
export class Sync extends ClientSDK {
  ...
  async operatorSync(
    request: models.OperatorSyncRequest,
    options?: RequestOptions,
  ): Promise<models.OperatorSyncResponse> {
    return unwrapAsync(syncOperatorSync(
      this,
      request,
      options,
    ));
