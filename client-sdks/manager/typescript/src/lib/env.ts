...
export interface Env {
  ALIEN_MANAGER_BEARER?: string | undefined;

  ALIEN_MANAGER_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, unknown> = z.object({
  ALIEN_MANAGER_BEARER: z.string().optional(),

  ALIEN_MANAGER_DEBUG: z.coerce.boolean().optional(),
});
