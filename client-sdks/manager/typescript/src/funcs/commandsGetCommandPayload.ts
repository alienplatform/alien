 ...
 */
export function commandsGetCommandPayload(
  client: AlienManagerCore,
  request: operations.GetCommandPayloadRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.CommandPayloadResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCommandPayloadRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/commands/{command_id}/payload")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CommandPayloadResponse$inboundSchema),
