 ...
 */
export function commandsCreateCommand(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateCommandRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateCommandResponse$inboundSchema),
