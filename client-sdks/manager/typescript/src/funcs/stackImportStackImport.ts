 ...
 * other endpoint.
 */
export function stackImportStackImport(
  client: AlienManagerCore,
  request: models.StackImportRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.StackImportResponse,
    | AlienManagerError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.StackImportRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/stack/import")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json([200, 201], models.StackImportResponse$inboundSchema),
