...
> {
  ...
  const body = encodeJSON("body", payload.UploadCompleteRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/commands/{command_id}/upload-complete")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UploadCompleteResponse$inboundSchema),
