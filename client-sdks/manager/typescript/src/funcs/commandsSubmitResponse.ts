 ...
 */
export function commandsSubmitResponse(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SubmitResponseRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CommandResponse, { explode: true });
  ...
  const path = pathToFunc("/v1/commands/{command_id}/response")(pathParams);
