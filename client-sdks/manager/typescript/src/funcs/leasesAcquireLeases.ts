 ...
 */
export function leasesAcquireLeases(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.LeaseRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/commands/leases")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LeaseResponse$inboundSchema),
