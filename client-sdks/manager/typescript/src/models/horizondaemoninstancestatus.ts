...
export type HorizonDaemonInstanceStatus = {
...
/** @internal */
export type HorizonDaemonInstanceStatus$Outbound = {
...
/** @internal */
export const HorizonDaemonInstanceStatus$outboundSchema: z.ZodType<
...
export function horizonDaemonInstanceStatusToJSON(
  horizonDaemonInstanceStatus: HorizonDaemonInstanceStatus,
): string {
  return JSON.stringify(
    HorizonDaemonInstanceStatus$outboundSchema.parse(
      horizonDaemonInstanceStatus,
    ),
  );
}
