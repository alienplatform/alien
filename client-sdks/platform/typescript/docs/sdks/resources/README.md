...
* [getRawHeartbeat](#getrawheartbeat)
...
<!-- UsageSnippet language="typescript" operationID="getRawResourceHeartbeat" method="get" path="/v1/resources/{area}/deployments/{deploymentId}/{resourceId}/raw-heartbeat" -->
```typescript
import { Alien } from "@alienplatform/platform-api";
...
async function run() {
  const result = await alien.resources.getRawHeartbeat({
    area: "worker",
    deploymentId: "<id>",
    resourceId: "<id>",
    workspace: "my-workspace",
...
```typescript
import { AlienCore } from "@alienplatform/platform-api/core.js";
import { resourcesGetRawHeartbeat } from "@alienplatform/platform-api/funcs/resourcesGetRawHeartbeat.js";
...
async function run() {
  const res = await resourcesGetRawHeartbeat(alien, {
    area: "worker",
    deploymentId: "<id>",
    resourceId: "<id>",
    workspace: "my-workspace",
  ...
  if (res.ok) {
    ...
    console.log("resourcesGetRawHeartbeat failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetRawResourceHeartbeatRequest](../../models/operations/getrawresourceheartbeatrequest.md)                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetRawResourceHeartbeatResponse](../../models/operations/getrawresourceheartbeatresponse.md)\>**
