...
* [getDomainBinding](#getdomainbinding) - Get the custom domain binding for a private manager.
* [updateDomainBinding](#updatedomainbinding) - Create, update, or remove the custom domain binding for a private manager.
...
* [generateManagerBindingToken](#generatemanagerbindingtoken) - Generate a short-lived deployment-scoped token for resolving opted-in remote bindings through the currently assigned manager.
...
<!-- UsageSnippet language="typescript" operationID="getManagerDomainBinding" method="get" path="/v1/managers/{id}/domain-binding" -->
```typescript
import { Alien } from "@alienplatform/platform-api";
...
```typescript
import { AlienCore } from "@alienplatform/platform-api/core.js";
import { managersGetDomainBinding } from "@alienplatform/platform-api/funcs/managersGetDomainBinding.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("managersGetDomainBinding failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetManagerDomainBindingRequest](../../models/operations/getmanagerdomainbindingrequest.md)                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.ManagerDomainBindingResponse](../../models/managerdomainbindingresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="updateManagerDomainBinding" method="put" path="/v1/managers/{id}/domain-binding" -->
```typescript
import { Alien } from "@alienplatform/platform-api";
...
```typescript
import { AlienCore } from "@alienplatform/platform-api/core.js";
import { managersUpdateDomainBinding } from "@alienplatform/platform-api/funcs/managersUpdateDomainBinding.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("managersUpdateDomainBinding failed:", res.error);
  }
}
...
**Promise\<[models.GenerateManagerBindingTokenResponse](../../models/generatemanagerbindingtokenresponse.md)\>**
