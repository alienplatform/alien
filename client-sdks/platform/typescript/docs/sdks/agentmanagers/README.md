...
async function run() {
  const result = await alien.agentManagers.list({
...
async function run() {
  const res = await agentManagersList(alien, {
    workspace: "my-workspace",
  });
  if (res.ok) {
    ...
    console.log("agentManagersList failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.create({
    workspace: "my-workspace",
  });
...
async function run() {
  const res = await agentManagersCreate(alien, {
    workspace: "my-workspace",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("agentManagersCreate failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.get({
...
async function run() {
  const res = await agentManagersGet(alien, {
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
  if (res.ok) {
    ...
    console.log("agentManagersGet failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.delete({
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
...
async function run() {
  const res = await agentManagersDelete(alien, {
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
  if (res.ok) {
    ...
    console.log("agentManagersDelete failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.getManagementConfig({
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
...
async function run() {
  const res = await agentManagersGetManagementConfig(alien, {
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
  if (res.ok) {
    ...
    console.log("agentManagersGetManagementConfig failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.provision({
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
...
async function run() {
  const res = await agentManagersProvision(alien, {
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
  if (res.ok) {
    ...
    console.log("agentManagersProvision failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.update({
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
...
async function run() {
  const res = await agentManagersUpdate(alien, {
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
    updateManagerRequest: {
      releaseId: "rel_WbhQgksrawSKIpEN0NAssHX9",
  ...
  if (res.ok) {
    ...
    console.log("agentManagersUpdate failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.listEvents({
    id: "<id>",
    workspace: "my-workspace",
  });
...
async function run() {
  const res = await agentManagersListEvents(alien, {
    id: "<id>",
    workspace: "my-workspace",
  });
  if (res.ok) {
    ...
    console.log("agentManagersListEvents failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.generateDeepstoreToken({
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
...
async function run() {
  const res = await agentManagersGenerateDeepstoreToken(alien, {
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
    generateDeepstoreTokenRequest: {},
  });
  if (res.ok) {
    ...
    console.log("agentManagersGenerateDeepstoreToken failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.reportHeartbeat({
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
...
async function run() {
  const res = await agentManagersReportHeartbeat(alien, {
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
  if (res.ok) {
    ...
    console.log("agentManagersReportHeartbeat failed:", res.error);
  }
}
...
async function run() {
  const result = await alien.agentManagers.getDeployment({
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
...
async function run() {
  const res = await agentManagersGetDeployment(alien, {
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
  });
  if (res.ok) {
    ...
    console.log("agentManagersGetDeployment failed:", res.error);
  }
}
...
async function run() {
  await alien.agentManagers.googleCloudConnect({
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
    projectId: "<id>",
    region: "<value>",
...
async function run() {
  const res = await agentManagersGoogleCloudConnect(alien, {
    id: "mgr_enxscjrqiiu2lrc672hwwuc5",
    workspace: "my-workspace",
    projectId: "<id>",
    region: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("agentManagersGoogleCloudConnect failed:", res.error);
  }
}
