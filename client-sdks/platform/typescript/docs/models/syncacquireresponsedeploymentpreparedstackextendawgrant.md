...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackExtendAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackExtendAwGrant = {};
```
