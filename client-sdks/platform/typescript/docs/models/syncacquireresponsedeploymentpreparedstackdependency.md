...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackDependency } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackDependency = {
  id: "<id>",
  type: "<value>",
};
```
