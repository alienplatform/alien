...
```typescript
import { SyncListResponsePendingPreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackExtendAzureGrant = {};
```
