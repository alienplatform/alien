...
| `inputs`                                                                                                                       | [models.SyncAcquireResponseCurrentReleaseInput](../models/syncacquireresponsecurrentreleaseinput.md)[]                         | :heavy_minus_sign:                                                                                                             | Input definitions required before setup or deployment can proceed.                                                             |
...
| `supportedPlatforms`                                                                                                           | [models.SyncAcquireResponseCurrentReleaseSupportedPlatform](../models/syncacquireresponsecurrentreleasesupportedplatform.md)[] | :heavy_minus_sign:                                                                                                             | Which platforms this stack supports. When None, all platforms are supported.                                                   |