...
```typescript
import { DeploymentInfoSetupConfigEnv } from "@alienplatform/platform-api/models";

let value: DeploymentInfoSetupConfigEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.DeploymentInfoSetupConfigTypeUnion*                             | :heavy_minus_sign:                                                      | N/A                                                                     |