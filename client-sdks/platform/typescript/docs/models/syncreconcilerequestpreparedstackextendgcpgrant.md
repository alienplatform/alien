...
```typescript
import { SyncReconcileRequestPreparedStackExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPreparedStackExtendGcpGrant = {};
```
