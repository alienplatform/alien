...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseOverrideGcpGrant = {};
```
