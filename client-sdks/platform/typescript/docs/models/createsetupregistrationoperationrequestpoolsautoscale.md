...
```typescript
import { CreateSetupRegistrationOperationRequestPoolsAutoscale } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestPoolsAutoscale = {
  max: 179929,
  min: 730585,
  mode: "autoscale",
};
...
| -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `failureDomains`                                                     | *models.CreateSetupRegistrationOperationRequestFailureDomainsUnion2* | :heavy_minus_sign:                                                   | N/A                                                                  |
