...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackOverrideGcpGrant = {};
```
