...
```typescript
import { PersistImportedDeploymentRequestExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestExtendAzureGrant = {};
```
