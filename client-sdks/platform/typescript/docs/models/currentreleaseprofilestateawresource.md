# CurrentReleaseProfileStateAwResource
...
```typescript
import { CurrentReleaseProfileStateAwResource } from "@alienplatform/platform-api/models";

let value: CurrentReleaseProfileStateAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
