...
```typescript
import { SyncAcquireResponsePreparedStackExtendAw } from "@alienplatform/platform-api/models";
...
| `effect`                                                                                                               | [models.SyncAcquireResponsePreparedStackExtendEffect](../models/syncacquireresponsepreparedstackextendeffect.md)       | :heavy_minus_sign:                                                                                                     | IAM effect. Defaults to Allow.                                                                                         |
