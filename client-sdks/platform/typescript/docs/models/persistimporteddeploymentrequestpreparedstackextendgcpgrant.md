...
```typescript
import { PersistImportedDeploymentRequestPreparedStackExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackExtendGcpGrant = {};
```
