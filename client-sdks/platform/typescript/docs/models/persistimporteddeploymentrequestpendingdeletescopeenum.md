...
```typescript
import { PersistImportedDeploymentRequestPendingDeleteScopeEnum } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingDeleteScopeEnum = "liveOnly";
```
