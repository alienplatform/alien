...
```typescript
import { CloudFormationCallbackRequestCertificateTLSSecretRef1 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestCertificateTLSSecretRef1 = {
  secretName: "<value>",
  mode: "tlsSecretRef",
};
```
