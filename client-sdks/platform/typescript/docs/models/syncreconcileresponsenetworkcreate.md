...
```typescript
import { SyncReconcileResponseNetworkCreate } from "@alienplatform/platform-api/models";
...
| `type`                                                                                                              | [models.TargetTypeCreate](../models/targettypecreate.md)                                                            | :heavy_check_mark:                                                                                                  | N/A                                                                                                                 |