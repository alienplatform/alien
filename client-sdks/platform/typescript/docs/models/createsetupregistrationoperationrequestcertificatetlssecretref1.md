...
```typescript
import { CreateSetupRegistrationOperationRequestCertificateTLSSecretRef1 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestCertificateTLSSecretRef1 = {
  secretName: "<value>",
  mode: "tlsSecretRef",
};
```
