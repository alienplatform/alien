...
```typescript
import { SyncReconcileResponsePendingPreparedStackExtendAwStack } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackExtendAwStack = {
  resources: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
