...
```typescript
import { CreateSetupRegistrationOperationRequestFailureDomains2 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestFailureDomains2 = {
  spread: 990650,
};
```
