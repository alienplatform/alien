...
```typescript
import { PersistImportedDeploymentRequestExtendAwResource } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestExtendAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
