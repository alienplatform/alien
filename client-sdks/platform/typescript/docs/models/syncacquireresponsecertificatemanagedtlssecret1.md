...
```typescript
import { SyncAcquireResponseCertificateManagedTLSSecret1 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseCertificateManagedTLSSecret1 = {
