# CurrentReleaseExtendStateAwResource
...
```typescript
import { CurrentReleaseExtendStateAwResource } from "@alienplatform/platform-api/models";

let value: CurrentReleaseExtendStateAwResource = {
  resources: [],
};
```
