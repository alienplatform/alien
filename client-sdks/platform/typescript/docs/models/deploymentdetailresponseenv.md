...
```typescript
import { DeploymentDetailResponseEnv } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponseEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.DeploymentDetailResponseTypeUnion*                              | :heavy_minus_sign:                                                      | N/A                                                                     |