...
| `inputs`                                                                                                                       | [models.SyncReconcileRequestTargetReleaseInput](../models/syncreconcilerequesttargetreleaseinput.md)[]                         | :heavy_minus_sign:                                                                                                             | Input definitions required before setup or deployment can proceed.                                                             |
...
| `supportedPlatforms`                                                                                                           | [models.SyncReconcileRequestTargetReleaseSupportedPlatform](../models/syncreconcilerequesttargetreleasesupportedplatform.md)[] | :heavy_minus_sign:                                                                                                             | Which platforms this stack supports. When None, all platforms are supported.                                                   |