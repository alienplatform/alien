...
```typescript
import { SyncReconcileResponseCertificateManagedAcmImport2 } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCertificateManagedAcmImport2 = {
