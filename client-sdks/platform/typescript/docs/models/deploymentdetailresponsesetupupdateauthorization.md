...
```typescript
import { DeploymentDetailResponseSetupUpdateAuthorization } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponseSetupUpdateAuthorization = {
  baselineFrozenDigest: "<value>",
  nonce: "<value>",
  releaseId: "<id>",
  setupFingerprint: "<value>",
  setupFingerprintVersion: 846995,
  setupTarget: "<value>",
