...
| `importSource`                                                                                       | [models.DeploymentListItemResponseImportSource](../models/deploymentlistitemresponseimportsource.md) | :heavy_minus_sign:                                                                                   | Distribution source that imported this deployment                                                    |                                                                                                      |
