...
```typescript
import { ListResourceOverviewResource } from "@alienplatform/platform-api/models/operations";

let value: ListResourceOverviewResource = {
  resourceType: "<value>",
  resourceId: "<id>",
  name: "<value>",
  backend: "<value>",
  ...
  currentCount: 475080,
  readyCount: 428381,
  deploymentCount: 14588,
  attentionCount: 164625,
  lastObservedAt: new Date("2025-01-21T06:58:28.143Z"),
};
```
