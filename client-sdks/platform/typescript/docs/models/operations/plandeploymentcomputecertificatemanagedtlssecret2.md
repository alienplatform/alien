...
```typescript
import { PlanDeploymentComputeCertificateManagedTLSSecret2 } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeCertificateManagedTLSSecret2 = {
