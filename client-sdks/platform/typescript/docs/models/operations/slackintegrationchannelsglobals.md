# SlackIntegrationChannelsGlobals

## Example Usage

```typescript
import { SlackIntegrationChannelsGlobals } from "@alienplatform/platform-api/models/operations";

let value: SlackIntegrationChannelsGlobals = {
