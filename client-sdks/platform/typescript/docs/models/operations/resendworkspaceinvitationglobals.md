# ResendWorkspaceInvitationGlobals

## Example Usage

```typescript
import { ResendWorkspaceInvitationGlobals } from "@alienplatform/platform-api/models/operations";

let value: ResendWorkspaceInvitationGlobals = {
