...
```typescript
import { Event9 } from "@alienplatform/platform-api/models/operations";
...
| `involvedObject`                                                                              | *operations.InvolvedObjectUnion7*                                                             | :heavy_minus_sign:                                                                            | N/A                                                                                           |
...
| `source`                                                                                      | *operations.SourceUnion7*                                                                     | :heavy_minus_sign:                                                                            | N/A                                                                                           |
