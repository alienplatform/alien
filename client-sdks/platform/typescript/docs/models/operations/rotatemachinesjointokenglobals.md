# RotateMachinesJoinTokenGlobals

## Example Usage

```typescript
import { RotateMachinesJoinTokenGlobals } from "@alienplatform/platform-api/models/operations";

let value: RotateMachinesJoinTokenGlobals = {
