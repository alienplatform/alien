# GetExternalAIModelCheckGlobals

## Example Usage

```typescript
import { GetExternalAIModelCheckGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetExternalAIModelCheckGlobals = {
