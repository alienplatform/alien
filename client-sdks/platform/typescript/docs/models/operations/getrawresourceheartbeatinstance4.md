...
```typescript
import { GetRawResourceHeartbeatInstance4 } from "@alienplatform/platform-api/models/operations";

let value: GetRawResourceHeartbeatInstance4 = {
  name: "<value>",
  ready: true,
  replicaId: "<id>",
};
...
| --------------------------------- | --------------------------------- | --------------------------------- | --------------------------------- |
| `cpu`                             | *operations.InstanceCpuUnion4*    | :heavy_minus_sign:                | N/A                               |
| `ip`                              | *string*                          | :heavy_minus_sign:                | N/A                               |
| `machineId`                       | *string*                          | :heavy_minus_sign:                | N/A                               |
| `memory`                          | *operations.InstanceMemoryUnion4* | :heavy_minus_sign:                | N/A                               |
