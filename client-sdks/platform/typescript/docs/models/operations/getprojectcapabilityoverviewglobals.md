# GetProjectCapabilityOverviewGlobals

## Example Usage

```typescript
import { GetProjectCapabilityOverviewGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetProjectCapabilityOverviewGlobals = {
