# SetProjectCapabilitiesGlobals

## Example Usage

```typescript
import { SetProjectCapabilitiesGlobals } from "@alienplatform/platform-api/models/operations";

let value: SetProjectCapabilitiesGlobals = {
