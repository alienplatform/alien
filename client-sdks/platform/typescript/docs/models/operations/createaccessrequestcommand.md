...
```typescript
import { CreateAccessRequestCommand } from "@alienplatform/platform-api/models/operations";

let value: CreateAccessRequestCommand = {
...
| `tier`                                                                                   | [operations.CreateAccessRequestTier](../../models/operations/createaccessrequesttier.md) | :heavy_minus_sign:                                                                       | How risky an operation is (declared by the plugin metadata).                             |                                                                                          |