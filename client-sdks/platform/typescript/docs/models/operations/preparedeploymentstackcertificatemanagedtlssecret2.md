...
```typescript
import { PrepareDeploymentStackCertificateManagedTLSSecret2 } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackCertificateManagedTLSSecret2 = {
