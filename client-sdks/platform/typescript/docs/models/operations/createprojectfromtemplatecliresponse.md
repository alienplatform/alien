...
```typescript
import { CreateProjectFromTemplateCliResponse } from "@alienplatform/platform-api/models/operations";

let value: CreateProjectFromTemplateCliResponse = {
  displayName: "Dedrick36",
  name: "<value>",
  enabled: false,
};
```
