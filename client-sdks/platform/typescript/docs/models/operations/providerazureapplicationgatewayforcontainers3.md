...
```typescript
import { ProviderAzureApplicationGatewayForContainers3 } from "@alienplatform/platform-api/models/operations";

let value: ProviderAzureApplicationGatewayForContainers3 = {
  frontend: "<value>",
...
| `provider`                                                                                                                                   | [operations.ProviderAzureApplicationGatewayForContainersEnum3](../../models/operations/providerazureapplicationgatewayforcontainersenum3.md) | :heavy_check_mark:                                                                                                                           | N/A                                                                                                                                          |