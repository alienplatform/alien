# GetProjectSandboxMetricsGlobals

## Example Usage

```typescript
import { GetProjectSandboxMetricsGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetProjectSandboxMetricsGlobals = {
