# ListMachinesInventoryGlobals

## Example Usage

```typescript
import { ListMachinesInventoryGlobals } from "@alienplatform/platform-api/models/operations";

let value: ListMachinesInventoryGlobals = {
