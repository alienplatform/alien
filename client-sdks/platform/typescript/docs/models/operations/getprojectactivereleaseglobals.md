# GetProjectActiveReleaseGlobals

## Example Usage

```typescript
import { GetProjectActiveReleaseGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetProjectActiveReleaseGlobals = {
