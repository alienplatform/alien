...
```typescript
import { DaemonInstance2 } from "@alienplatform/platform-api/models/operations";

let value: DaemonInstance2 = {
  name: "<value>",
  ready: false,
  replicaId: "<id>",
};
...
| --------------------------------------- | --------------------------------------- | --------------------------------------- | --------------------------------------- |
| `cpu`                                   | *operations.DaemonInstanceCpuUnion2*    | :heavy_minus_sign:                      | N/A                                     |
| `ip`                                    | *string*                                | :heavy_minus_sign:                      | N/A                                     |
| `machineId`                             | *string*                                | :heavy_minus_sign:                      | N/A                                     |
| `memory`                                | *operations.DaemonInstanceMemoryUnion2* | :heavy_minus_sign:                      | N/A                                     |
