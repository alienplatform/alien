...
```typescript
import { GetRawResourceHeartbeatEvent4 } from "@alienplatform/platform-api/models/operations";

let value: GetRawResourceHeartbeatEvent4 = {
  message: "<value>",
  reason: "<value>",
};
```
...
| `involvedObject`                                                                              | *operations.InvolvedObjectUnion3*                                                             | :heavy_minus_sign:                                                                            | N/A                                                                                           |
...
| `source`                                                                                      | *operations.SourceUnion3*                                                                     | :heavy_minus_sign:                                                                            | N/A                                                                                           |
