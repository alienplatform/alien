# UpdateProjectGcpOAuthProviderGlobals

## Example Usage

```typescript
import { UpdateProjectGcpOAuthProviderGlobals } from "@alienplatform/platform-api/models/operations";

let value: UpdateProjectGcpOAuthProviderGlobals = {
