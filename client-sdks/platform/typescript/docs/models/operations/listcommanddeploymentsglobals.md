# ListCommandDeploymentsGlobals

## Example Usage

```typescript
import { ListCommandDeploymentsGlobals } from "@alienplatform/platform-api/models/operations";

let value: ListCommandDeploymentsGlobals = {
