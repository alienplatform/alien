...
```typescript
import { DataAzureKeyVault1 } from "@alienplatform/platform-api/models/operations";
...
| `status`                                                                                                                 | [operations.GetResourceDeploymentDetailDataStatus39](../../models/operations/getresourcedeploymentdetaildatastatus39.md) | :heavy_check_mark:                                                                                                       | N/A                                                                                                                      |
