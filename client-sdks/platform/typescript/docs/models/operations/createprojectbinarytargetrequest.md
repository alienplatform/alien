# CreateProjectBinaryTargetRequest
...
```typescript
import { CreateProjectBinaryTargetRequest } from "@alienplatform/platform-api/models/operations";

let value: CreateProjectBinaryTargetRequest = "linux-x64";
```
