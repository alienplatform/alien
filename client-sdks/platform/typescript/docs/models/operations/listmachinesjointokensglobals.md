# ListMachinesJoinTokensGlobals

## Example Usage

```typescript
import { ListMachinesJoinTokensGlobals } from "@alienplatform/platform-api/models/operations";

let value: ListMachinesJoinTokensGlobals = {
