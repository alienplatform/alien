...
```typescript
import { PlanDeploymentComputeNetworkByoVpcAws } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeNetworkByoVpcAws = {
  privateSubnetIds: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
...
| `type`                                                                                                         | [operations.PlanDeploymentComputeTypeByoVpcAws](../../models/operations/plandeploymentcomputetypebyovpcaws.md) | :heavy_check_mark:                                                                                             | N/A                                                                                                            |
