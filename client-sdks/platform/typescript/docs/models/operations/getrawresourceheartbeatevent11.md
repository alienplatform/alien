...
```typescript
import { GetRawResourceHeartbeatEvent11 } from "@alienplatform/platform-api/models/operations";

let value: GetRawResourceHeartbeatEvent11 = {
  message: "<value>",
  reason: "<value>",
};
```
...
| `involvedObject`                                                                              | *operations.InvolvedObjectUnion8*                                                             | :heavy_minus_sign:                                                                            | N/A                                                                                           |
...
| `source`                                                                                      | *operations.SourceUnion8*                                                                     | :heavy_minus_sign:                                                                            | N/A                                                                                           |
