...
```typescript
import { ProviderAwsAlb4 } from "@alienplatform/platform-api/models/operations";

let value: ProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                       | [operations.ProviderAwsAlbEnum4](../../models/operations/providerawsalbenum4.md) | :heavy_check_mark:                                                               | N/A                                                                              |
