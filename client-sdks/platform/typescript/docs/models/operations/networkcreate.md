...
```typescript
import { NetworkCreate } from "@alienplatform/platform-api/models/operations";

let value: NetworkCreate = {
  type: "create",
};
```
...
| `type`                                                                                                              | [operations.TypeCreate](../../models/operations/typecreate.md)                                                      | :heavy_check_mark:                                                                                                  | N/A                                                                                                                 |