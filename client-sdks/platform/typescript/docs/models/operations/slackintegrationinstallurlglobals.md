# SlackIntegrationInstallUrlGlobals

## Example Usage

```typescript
import { SlackIntegrationInstallUrlGlobals } from "@alienplatform/platform-api/models/operations";

let value: SlackIntegrationInstallUrlGlobals = {
