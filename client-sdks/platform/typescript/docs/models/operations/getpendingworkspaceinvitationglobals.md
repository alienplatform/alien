# GetPendingWorkspaceInvitationGlobals

## Example Usage

```typescript
import { GetPendingWorkspaceInvitationGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetPendingWorkspaceInvitationGlobals = {
