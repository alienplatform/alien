# GetProjectDeploymentLinkSetupGlobals

## Example Usage

```typescript
import { GetProjectDeploymentLinkSetupGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetProjectDeploymentLinkSetupGlobals = {
