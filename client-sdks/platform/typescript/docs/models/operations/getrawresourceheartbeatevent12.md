...
```typescript
import { GetRawResourceHeartbeatEvent12 } from "@alienplatform/platform-api/models/operations";

let value: GetRawResourceHeartbeatEvent12 = {
  message: "<value>",
  reason: "<value>",
};
```
...
| `involvedObject`                                                                              | *operations.InvolvedObjectUnion9*                                                             | :heavy_minus_sign:                                                                            | N/A                                                                                           |
...
| `source`                                                                                      | *operations.SourceUnion9*                                                                     | :heavy_minus_sign:                                                                            | N/A                                                                                           |
