...
```typescript
import { DataGcpCloudRun } from "@alienplatform/platform-api/models/operations";
...
| `status`                                                                                                               | [operations.GetResourceDeploymentDetailDataStatus6](../../models/operations/getresourcedeploymentdetaildatastatus6.md) | :heavy_check_mark:                                                                                                     | N/A                                                                                                                    |
