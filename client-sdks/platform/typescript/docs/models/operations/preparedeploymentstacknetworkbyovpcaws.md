...
```typescript
import { PrepareDeploymentStackNetworkByoVpcAws } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackNetworkByoVpcAws = {
  privateSubnetIds: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
...
| `type`                                                                                                           | [operations.PrepareDeploymentStackTypeByoVpcAws](../../models/operations/preparedeploymentstacktypebyovpcaws.md) | :heavy_check_mark:                                                                                               | N/A                                                                                                              |
