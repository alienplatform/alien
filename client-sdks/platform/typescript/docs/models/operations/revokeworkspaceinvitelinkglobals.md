# RevokeWorkspaceInviteLinkGlobals

## Example Usage

```typescript
import { RevokeWorkspaceInviteLinkGlobals } from "@alienplatform/platform-api/models/operations";

let value: RevokeWorkspaceInviteLinkGlobals = {
