# CreateWorkspaceInvitationGlobals

## Example Usage

```typescript
import { CreateWorkspaceInvitationGlobals } from "@alienplatform/platform-api/models/operations";

let value: CreateWorkspaceInvitationGlobals = {
