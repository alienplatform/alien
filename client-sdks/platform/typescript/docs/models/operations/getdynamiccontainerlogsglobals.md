# GetDynamicContainerLogsGlobals

## Example Usage

```typescript
import { GetDynamicContainerLogsGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetDynamicContainerLogsGlobals = {
