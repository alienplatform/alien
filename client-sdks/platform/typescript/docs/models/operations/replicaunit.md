...
```typescript
import { ReplicaUnit } from "@alienplatform/platform-api/models/operations";

let value: ReplicaUnit = {
  name: "<value>",
  ready: false,
  replicaId: "<id>",
};
...
| ----------------------------------- | ----------------------------------- | ----------------------------------- | ----------------------------------- |
| `cpu`                               | *operations.ReplicaUnitCpuUnion*    | :heavy_minus_sign:                  | N/A                                 |
| `ip`                                | *string*                            | :heavy_minus_sign:                  | N/A                                 |
| `machineId`                         | *string*                            | :heavy_minus_sign:                  | N/A                                 |
| `memory`                            | *operations.ReplicaUnitMemoryUnion* | :heavy_minus_sign:                  | N/A                                 |
