...
```typescript
import { PlanDeploymentComputeNetworkByoVnetAzure } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeNetworkByoVnetAzure = {
...
| `type`                                                                                                               | [operations.PlanDeploymentComputeTypeByoVnetAzure](../../models/operations/plandeploymentcomputetypebyovnetazure.md) | :heavy_check_mark:                                                                                                   | N/A                                                                                                                  |
