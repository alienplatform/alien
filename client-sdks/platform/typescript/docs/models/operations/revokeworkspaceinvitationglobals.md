# RevokeWorkspaceInvitationGlobals

## Example Usage

```typescript
import { RevokeWorkspaceInvitationGlobals } from "@alienplatform/platform-api/models/operations";

let value: RevokeWorkspaceInvitationGlobals = {
