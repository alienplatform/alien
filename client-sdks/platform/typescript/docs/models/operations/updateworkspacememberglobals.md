# UpdateWorkspaceMemberGlobals

## Example Usage

```typescript
import { UpdateWorkspaceMemberGlobals } from "@alienplatform/platform-api/models/operations";

let value: UpdateWorkspaceMemberGlobals = {
