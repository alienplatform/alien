# RemoveWorkspaceMemberGlobals

## Example Usage

```typescript
import { RemoveWorkspaceMemberGlobals } from "@alienplatform/platform-api/models/operations";

let value: RemoveWorkspaceMemberGlobals = {
