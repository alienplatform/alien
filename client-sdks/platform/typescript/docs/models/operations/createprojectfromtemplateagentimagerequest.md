# CreateProjectFromTemplateAgentImageRequest
...
```typescript
import { CreateProjectFromTemplateAgentImageRequest } from "@alienplatform/platform-api/models/operations";

let value: CreateProjectFromTemplateAgentImageRequest = {
  displayName: "Jerrod.Kertzmann-Klocko75",
  name: "<value>",
  enabled: true,
};
```
