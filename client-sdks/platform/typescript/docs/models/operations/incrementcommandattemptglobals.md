# IncrementCommandAttemptGlobals

## Example Usage

```typescript
import { IncrementCommandAttemptGlobals } from "@alienplatform/platform-api/models/operations";

let value: IncrementCommandAttemptGlobals = {
