...
```typescript
import { DaemonInstance3 } from "@alienplatform/platform-api/models/operations";

let value: DaemonInstance3 = {
  name: "<value>",
  ready: true,
  replicaId: "<id>",
};
...
| --------------------------------------- | --------------------------------------- | --------------------------------------- | --------------------------------------- |
| `cpu`                                   | *operations.DaemonInstanceCpuUnion3*    | :heavy_minus_sign:                      | N/A                                     |
| `ip`                                    | *string*                                | :heavy_minus_sign:                      | N/A                                     |
| `machineId`                             | *string*                                | :heavy_minus_sign:                      | N/A                                     |
| `memory`                                | *operations.DaemonInstanceMemoryUnion3* | :heavy_minus_sign:                      | N/A                                     |
