...
| `tier`                                                                                 | [operations.QueueAccessRequestTier](../../models/operations/queueaccessrequesttier.md) | :heavy_minus_sign:                                                                     | How risky an operation is (declared by the plugin metadata).                           |                                                                                        |