# ListDynamicContainersGlobals

## Example Usage

```typescript
import { ListDynamicContainersGlobals } from "@alienplatform/platform-api/models/operations";

let value: ListDynamicContainersGlobals = {
