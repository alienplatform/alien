# GetProjectGcpOAuthProviderGlobals

## Example Usage

```typescript
import { GetProjectGcpOAuthProviderGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetProjectGcpOAuthProviderGlobals = {
