...
```typescript
import { DataAzureContainerRegistry } from "@alienplatform/platform-api/models/operations";
...
| `events`                                                                                                 | [operations.GetRawResourceHeartbeatEvent48](../../models/operations/getrawresourceheartbeatevent48.md)[] | :heavy_check_mark:                                                                                       | N/A                                                                                                      |
