# PlanDeploymentComputeGlobals

## Example Usage

```typescript
import { PlanDeploymentComputeGlobals } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeGlobals = {
