# GetProjectEncryptionUsageGlobals

## Example Usage

```typescript
import { GetProjectEncryptionUsageGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetProjectEncryptionUsageGlobals = {
