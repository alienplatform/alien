# GetWorkspaceGatewayOverviewGlobals

## Example Usage

```typescript
import { GetWorkspaceGatewayOverviewGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetWorkspaceGatewayOverviewGlobals = {
