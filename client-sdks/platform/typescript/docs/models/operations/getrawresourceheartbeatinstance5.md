...
```typescript
import { GetRawResourceHeartbeatInstance5 } from "@alienplatform/platform-api/models/operations";

let value: GetRawResourceHeartbeatInstance5 = {
  name: "<value>",
  ready: true,
  replicaId: "<id>",
};
...
| --------------------------------- | --------------------------------- | --------------------------------- | --------------------------------- |
| `cpu`                             | *operations.InstanceCpuUnion5*    | :heavy_minus_sign:                | N/A                               |
| `ip`                              | *string*                          | :heavy_minus_sign:                | N/A                               |
| `machineId`                       | *string*                          | :heavy_minus_sign:                | N/A                               |
| `memory`                          | *operations.InstanceMemoryUnion5* | :heavy_minus_sign:                | N/A                               |
