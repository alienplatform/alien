...
```typescript
import { CreateProjectFromTemplateDeploymentPortalAppearance } from "@alienplatform/platform-api/models/operations";

let value: CreateProjectFromTemplateDeploymentPortalAppearance = {};
```
