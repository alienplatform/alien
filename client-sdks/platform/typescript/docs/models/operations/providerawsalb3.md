...
```typescript
import { ProviderAwsAlb3 } from "@alienplatform/platform-api/models/operations";

let value: ProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                       | [operations.ProviderAwsAlbEnum3](../../models/operations/providerawsalbenum3.md) | :heavy_check_mark:                                                               | N/A                                                                              |
