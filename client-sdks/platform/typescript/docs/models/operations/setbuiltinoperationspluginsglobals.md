# SetBuiltinOperationsPluginsGlobals

## Example Usage

```typescript
import { SetBuiltinOperationsPluginsGlobals } from "@alienplatform/platform-api/models/operations";

let value: SetBuiltinOperationsPluginsGlobals = {
