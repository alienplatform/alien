...
```typescript
import { PlanDeploymentComputeRouteGateway1 } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeRouteGateway1 = {
...
| `provider`                                                           | *operations.PlanDeploymentComputeProviderUnion2*                     | :heavy_minus_sign:                                                   | N/A                                                                  |
