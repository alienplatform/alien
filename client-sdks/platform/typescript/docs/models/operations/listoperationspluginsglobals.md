# ListOperationsPluginsGlobals

## Example Usage

```typescript
import { ListOperationsPluginsGlobals } from "@alienplatform/platform-api/models/operations";

let value: ListOperationsPluginsGlobals = {
