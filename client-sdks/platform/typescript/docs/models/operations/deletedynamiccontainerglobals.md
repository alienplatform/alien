# DeleteDynamicContainerGlobals

## Example Usage

```typescript
import { DeleteDynamicContainerGlobals } from "@alienplatform/platform-api/models/operations";

let value: DeleteDynamicContainerGlobals = {
