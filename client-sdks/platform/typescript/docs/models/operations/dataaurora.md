...
```typescript
import { DataAurora } from "@alienplatform/platform-api/models/operations";
...
| `status`                                                                                                                                                    | [operations.GetResourceDeploymentDetailDataStatus33](../../models/operations/getresourcedeploymentdetaildatastatus33.md)                                    | :heavy_check_mark:                                                                                                                                          | N/A                                                                                                                                                         |
