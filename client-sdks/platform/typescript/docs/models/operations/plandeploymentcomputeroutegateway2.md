...
```typescript
import { PlanDeploymentComputeRouteGateway2 } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeRouteGateway2 = {
...
| `provider`                                                           | *operations.PlanDeploymentComputeProviderUnion4*                     | :heavy_minus_sign:                                                   | N/A                                                                  |
