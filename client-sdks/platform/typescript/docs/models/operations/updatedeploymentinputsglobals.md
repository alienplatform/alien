# UpdateDeploymentInputsGlobals

## Example Usage

```typescript
import { UpdateDeploymentInputsGlobals } from "@alienplatform/platform-api/models/operations";

let value: UpdateDeploymentInputsGlobals = {
