...
```typescript
import { PlanDeploymentComputeCertificateManagedTLSSecret1 } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeCertificateManagedTLSSecret1 = {
