# PublishOperationsPluginGlobals

## Example Usage

```typescript
import { PublishOperationsPluginGlobals } from "@alienplatform/platform-api/models/operations";

let value: PublishOperationsPluginGlobals = {
