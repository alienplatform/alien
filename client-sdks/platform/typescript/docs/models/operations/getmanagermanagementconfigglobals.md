# GetManagerManagementConfigGlobals

## Example Usage

```typescript
import { GetManagerManagementConfigGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetManagerManagementConfigGlobals = {
