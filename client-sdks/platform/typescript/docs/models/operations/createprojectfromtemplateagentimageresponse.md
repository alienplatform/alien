...
```typescript
import { CreateProjectFromTemplateAgentImageResponse } from "@alienplatform/platform-api/models/operations";

let value: CreateProjectFromTemplateAgentImageResponse = {
  displayName: "Nina_Green88",
  name: "<value>",
  enabled: true,
};
```
