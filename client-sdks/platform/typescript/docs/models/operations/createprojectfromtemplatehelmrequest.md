...
```typescript
import { CreateProjectFromTemplateHelmRequest } from "@alienplatform/platform-api/models/operations";

let value: CreateProjectFromTemplateHelmRequest = {
  chartName: "<value>",
  description: "substitution ready alongside impostor pace yet",
  enabled: false,
};
```
