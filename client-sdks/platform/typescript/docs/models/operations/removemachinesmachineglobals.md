# RemoveMachinesMachineGlobals

## Example Usage

```typescript
import { RemoveMachinesMachineGlobals } from "@alienplatform/platform-api/models/operations";

let value: RemoveMachinesMachineGlobals = {
