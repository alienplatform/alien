...
```typescript
import { SyncReconcileResponseCurrentReleaseProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCurrentReleaseProfileAzureGrant = {};
```
