...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseExtendAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseExtendAwGrant = {};
```
