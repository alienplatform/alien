...
```typescript
import { DeploymentSetupStackSettingsPolicyFailureDomains1 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyFailureDomains1 = {
  spread: 834872,
};
```
