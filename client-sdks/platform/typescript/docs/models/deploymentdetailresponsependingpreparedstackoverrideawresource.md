...
```typescript
import { DeploymentDetailResponsePendingPreparedStackOverrideAwResource } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackOverrideAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
