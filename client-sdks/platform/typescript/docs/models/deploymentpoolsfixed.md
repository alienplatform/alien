...
```typescript
import { DeploymentPoolsFixed } from "@alienplatform/platform-api/models";

let value: DeploymentPoolsFixed = {
  machines: 563700,
  mode: "fixed",
};
```
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.DeploymentFailureDomainsUnion1*             | :heavy_minus_sign:                                  | N/A                                                 |
