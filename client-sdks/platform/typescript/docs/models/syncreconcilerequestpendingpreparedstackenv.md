...
```typescript
import { SyncReconcileRequestPendingPreparedStackEnv } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.SyncReconcileRequestPendingPreparedStackTypeUnion*              | :heavy_minus_sign:                                                      | N/A                                                                     |
