...
```typescript
import { Command } from "@aliendotdev/platform-api/models";
...
| `state`                                                                                       | [models.CommandState](../models/commandstate.md)                                              | :heavy_check_mark:                                                                            | Command states in the ARC protocol lifecycle                                                  |                                                                                               |
