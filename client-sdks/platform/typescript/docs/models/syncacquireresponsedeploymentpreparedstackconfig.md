...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackConfig } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackConfig = {
  id: "<id>",
  type: "<value>",
};
```
