...
```typescript
import { DeploymentPendingPreparedStackProfileAwResource } from "@alienplatform/platform-api/models";

let value: DeploymentPendingPreparedStackProfileAwResource = {
  resources: [
    "<value 1>",
  ],
};
