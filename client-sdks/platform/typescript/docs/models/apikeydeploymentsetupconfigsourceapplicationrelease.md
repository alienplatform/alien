...
```typescript
import { APIKeyDeploymentSetupConfigSourceApplicationRelease } from "@alienplatform/platform-api/models";

let value: APIKeyDeploymentSetupConfigSourceApplicationRelease = {
