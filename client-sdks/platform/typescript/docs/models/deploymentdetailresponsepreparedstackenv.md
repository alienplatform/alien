...
```typescript
import { DeploymentDetailResponsePreparedStackEnv } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.DeploymentDetailResponsePreparedStackTypeUnion*                 | :heavy_minus_sign:                                                      | N/A                                                                     |
