...
| `targetOperationsBundleSet`                                                                  | [models.TargetOperationsBundleSet](../models/targetoperationsbundleset.md)                   | :heavy_minus_sign:                                                                           | Target operations-bundle set the Operator should converge its loaded plugin registry toward. |