...
```typescript
import { DeploymentDetailResponsePendingPreparedStackOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackOverrideAzureGrant = {};
```
