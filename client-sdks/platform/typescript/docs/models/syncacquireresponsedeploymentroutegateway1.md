...
```typescript
import { SyncAcquireResponseDeploymentRouteGateway1 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentRouteGateway1 = {
...
| `provider`                                                           | *models.SyncAcquireResponseDeploymentProviderUnion2*                 | :heavy_minus_sign:                                                   | N/A                                                                  |
