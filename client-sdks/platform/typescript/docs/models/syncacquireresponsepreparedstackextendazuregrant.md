...
```typescript
import { SyncAcquireResponsePreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponsePreparedStackExtendAzureGrant = {};
```
