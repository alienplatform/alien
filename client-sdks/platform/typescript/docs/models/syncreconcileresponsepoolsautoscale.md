...
```typescript
import { SyncReconcileResponsePoolsAutoscale } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePoolsAutoscale = {
  max: 152917,
  min: 940970,
  mode: "autoscale",
};
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.SyncReconcileResponseFailureDomainsUnion2*  | :heavy_minus_sign:                                  | N/A                                                 |
