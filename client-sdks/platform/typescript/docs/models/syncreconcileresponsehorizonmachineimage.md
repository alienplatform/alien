...
| `horizondArtifacts`                                                                                                  | Record<string, [models.SyncReconcileResponseHorizondArtifacts](../models/syncreconcileresponsehorizondartifacts.md)> | :heavy_check_mark:                                                                                                   | Per-architecture horizond artifacts by release-platform key.                                                         |
