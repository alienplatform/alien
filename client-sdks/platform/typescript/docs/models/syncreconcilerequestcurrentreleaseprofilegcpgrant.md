...
```typescript
import { SyncReconcileRequestCurrentReleaseProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestCurrentReleaseProfileGcpGrant = {};
```
