...
```typescript
import { SyncAcquireResponseDeploymentPendingPreparedStackProfileAwResource } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPendingPreparedStackProfileAwResource =
  {
    resources: [
      "<value 1>",
      "<value 2>",
