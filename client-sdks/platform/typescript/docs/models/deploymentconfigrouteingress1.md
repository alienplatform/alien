...
```typescript
import { DeploymentConfigRouteIngress1 } from "@alienplatform/platform-api/models";

let value: DeploymentConfigRouteIngress1 = {
...
| `provider`                                                        | *models.DeploymentConfigProviderUnion1*                           | :heavy_minus_sign:                                                | N/A                                                               |
