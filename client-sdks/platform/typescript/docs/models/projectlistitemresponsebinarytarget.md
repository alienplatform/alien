# ProjectListItemResponseBinaryTarget
...
```typescript
import { ProjectListItemResponseBinaryTarget } from "@alienplatform/platform-api/models";

let value: ProjectListItemResponseBinaryTarget = "linux-arm64";
```
