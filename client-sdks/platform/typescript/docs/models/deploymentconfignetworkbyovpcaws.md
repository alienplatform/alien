...
```typescript
import { DeploymentConfigNetworkByoVpcAws } from "@alienplatform/platform-api/models";

let value: DeploymentConfigNetworkByoVpcAws = {
  privateSubnetIds: [
    "<value 1>",
  ],
  publicSubnetIds: [
...
| `type`                                                                             | [models.DeploymentConfigTypeByoVpcAws](../models/deploymentconfigtypebyovpcaws.md) | :heavy_check_mark:                                                                 | N/A                                                                                |
