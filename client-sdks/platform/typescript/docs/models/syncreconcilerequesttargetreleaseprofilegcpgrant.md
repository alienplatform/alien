...
```typescript
import { SyncReconcileRequestTargetReleaseProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestTargetReleaseProfileGcpGrant = {};
```
