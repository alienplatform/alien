...
```typescript
import { SyncAcquireResponseDeploymentTargetReleaseDependency } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentTargetReleaseDependency = {
  id: "<id>",
  type: "<value>",
};
```
