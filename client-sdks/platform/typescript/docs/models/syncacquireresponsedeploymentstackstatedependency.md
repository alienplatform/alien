...
```typescript
import { SyncAcquireResponseDeploymentStackStateDependency } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentStackStateDependency = {
  id: "<id>",
  type: "<value>",
};
```
