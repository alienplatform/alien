# DeploymentDetailResponseDeleteResourceModeEnum
...
```typescript
import { DeploymentDetailResponseDeleteResourceModeEnum } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponseDeleteResourceModeEnum = "live";
```
