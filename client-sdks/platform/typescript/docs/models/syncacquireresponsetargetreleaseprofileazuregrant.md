...
```typescript
import { SyncAcquireResponseTargetReleaseProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseTargetReleaseProfileAzureGrant = {};
```
