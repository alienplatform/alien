...
```typescript
import { RecommendedFixed } from "@alienplatform/platform-api/models";

let value: RecommendedFixed = {
  machines: 33712,
  mode: "fixed",
};
```
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.RecommendedFailureDomainsUnion1*            | :heavy_minus_sign:                                  | N/A                                                 |
