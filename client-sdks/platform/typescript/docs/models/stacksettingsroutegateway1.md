...
```typescript
import { StackSettingsRouteGateway1 } from "@alienplatform/platform-api/models";

let value: StackSettingsRouteGateway1 = {
...
| `provider`                                                           | *models.StackSettingsProviderUnion2*                                 | :heavy_minus_sign:                                                   | N/A                                                                  |
