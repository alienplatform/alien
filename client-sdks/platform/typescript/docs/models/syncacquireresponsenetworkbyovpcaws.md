...
```typescript
import { SyncAcquireResponseNetworkByoVpcAws } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseNetworkByoVpcAws = {
  privateSubnetIds: [],
  publicSubnetIds: [
    "<value 1>",
    "<value 2>",
...
| `type`                                                                                   | [models.SyncAcquireResponseTypeByoVpcAws](../models/syncacquireresponsetypebyovpcaws.md) | :heavy_check_mark:                                                                       | N/A                                                                                      |
