...
```typescript
import { SyncReconcileResponseTargetReleaseExtendAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseTargetReleaseExtendAwGrant = {};
```
