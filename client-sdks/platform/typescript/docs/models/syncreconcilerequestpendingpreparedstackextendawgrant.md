...
```typescript
import { SyncReconcileRequestPendingPreparedStackExtendAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackExtendAwGrant = {};
```
