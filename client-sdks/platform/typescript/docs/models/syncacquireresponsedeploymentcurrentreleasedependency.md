...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseDependency } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseDependency = {
  id: "<id>",
  type: "<value>",
};
```
