...
```typescript
import { SyncReconcileResponseTargetReleaseExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseTargetReleaseExtendAzureGrant = {};
```
