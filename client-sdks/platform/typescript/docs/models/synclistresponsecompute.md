...
```typescript
import { SyncListResponseCompute } from "@alienplatform/platform-api/models";

let value: SyncListResponseCompute = {};
```
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `pools`                                             | Record<string, *models.SyncListResponsePoolsUnion*> | :heavy_minus_sign:                                  | Selected compute choices keyed by pool ID.          |