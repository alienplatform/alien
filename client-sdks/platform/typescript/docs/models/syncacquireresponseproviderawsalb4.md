...
```typescript
import { SyncAcquireResponseProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                           | [models.SyncAcquireResponseProviderAwsAlbEnum4](../models/syncacquireresponseproviderawsalbenum4.md) | :heavy_check_mark:                                                                                   | N/A                                                                                                  |
