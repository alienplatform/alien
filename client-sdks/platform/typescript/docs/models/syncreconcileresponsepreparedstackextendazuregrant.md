...
```typescript
import { SyncReconcileResponsePreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePreparedStackExtendAzureGrant = {};
```
