...
```typescript
import { SyncAcquireResponseDeploymentRouteIngress1 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentRouteIngress1 = {
...
| `provider`                                                        | *models.SyncAcquireResponseDeploymentProviderUnion1*              | :heavy_minus_sign:                                                | N/A                                                               |
