...
```typescript
import { SyncReconcileResponsePreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePreparedStackProfileAwGrant = {};
```
