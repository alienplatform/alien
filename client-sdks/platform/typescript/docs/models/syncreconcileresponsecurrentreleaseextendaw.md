...
```typescript
import { SyncReconcileResponseCurrentReleaseExtendAw } from "@alienplatform/platform-api/models";
...
| `effect`                                                                                                                     | [models.SyncReconcileResponseCurrentReleaseExtendEffect](../models/syncreconcileresponsecurrentreleaseextendeffect.md)       | :heavy_minus_sign:                                                                                                           | IAM effect. Defaults to Allow.                                                                                               |
