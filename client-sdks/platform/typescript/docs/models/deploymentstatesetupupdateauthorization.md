...
```typescript
import { DeploymentStateSetupUpdateAuthorization } from "@alienplatform/platform-api/models";

let value: DeploymentStateSetupUpdateAuthorization = {
  baselineFrozenDigest: "<value>",
  nonce: "<value>",
  releaseId: "<id>",
  setupFingerprint: "<value>",
  setupFingerprintVersion: 54641,
  setupTarget: "<value>",
