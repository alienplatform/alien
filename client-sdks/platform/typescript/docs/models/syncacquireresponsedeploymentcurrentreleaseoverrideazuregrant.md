...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseOverrideAzureGrant = {};
```
