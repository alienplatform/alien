...
```typescript
import { CreateManagerResponseRouteGateway6 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteGateway6 = {
...
| `provider`                                                           | *models.CreateManagerResponseProviderUnion12*                        | :heavy_minus_sign:                                                   | N/A                                                                  |
