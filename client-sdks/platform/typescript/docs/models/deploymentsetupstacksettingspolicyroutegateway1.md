...
```typescript
import { DeploymentSetupStackSettingsPolicyRouteGateway1 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyRouteGateway1 = {
...
| `provider`                                                           | *models.DeploymentSetupStackSettingsPolicyProviderUnion2*            | :heavy_minus_sign:                                                   | N/A                                                                  |
