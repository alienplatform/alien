...
```typescript
import { SyncAcquireResponseDeploymentCertificateManagedAcmImport2 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCertificateManagedAcmImport2 = {
