...
```typescript
import { DeploymentDetailResponsePendingPreparedStackExtendAwGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackExtendAwGrant = {};
```
