...
```typescript
import { SyncReconcileResponsePendingPreparedStackOverrideAwStack } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackOverrideAwStack = {
  resources: [],
};
```
