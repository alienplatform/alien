...
```typescript
import { PersistImportedDeploymentRequestFailureDomains1 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestFailureDomains1 = {
  spread: 294914,
};
```
