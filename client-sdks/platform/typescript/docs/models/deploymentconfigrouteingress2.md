...
```typescript
import { DeploymentConfigRouteIngress2 } from "@alienplatform/platform-api/models";

let value: DeploymentConfigRouteIngress2 = {
...
| `provider`                                                        | *models.DeploymentConfigProviderUnion3*                           | :heavy_minus_sign:                                                | N/A                                                               |
