...
```typescript
import { PersistImportedDeploymentRequestPreparedStackValidation } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackValidation = {};
```
