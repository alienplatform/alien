...
```typescript
import { PersistImportedDeploymentRequestProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                                     | [models.PersistImportedDeploymentRequestProviderAwsAlbEnum2](../models/persistimporteddeploymentrequestproviderawsalbenum2.md) | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |
