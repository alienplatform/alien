...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseExtendAzureGrant = {};
```
