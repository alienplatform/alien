...
```typescript
import { CloudFormationCallbackRequestRouteIngress1 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestRouteIngress1 = {
...
| `provider`                                                        | *models.CloudFormationCallbackRequestProviderUnion1*              | :heavy_minus_sign:                                                | N/A                                                               |
