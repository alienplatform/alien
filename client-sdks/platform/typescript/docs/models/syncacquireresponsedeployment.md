...
| `operationId`                                                                         | *string*                                                                              | :heavy_check_mark:                                                                    | Immutable target claimed for this execution, or null for observation-only work.       | duop_0vtxpb1sw4sbcdwg2xo37q6                                                          |
| `attemptId`                                                                           | *string*                                                                              | :heavy_check_mark:                                                                    | Execution attempt claimed by this manager session, or null for observation-only work. | duat_uve04tou5eoua3q17dar1pz                                                          |
