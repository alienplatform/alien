...
```typescript
import { DeploymentPendingPreparedStackEnv } from "@alienplatform/platform-api/models";

let value: DeploymentPendingPreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.DeploymentPendingPreparedStackTypeUnion*                        | :heavy_minus_sign:                                                      | N/A                                                                     |
