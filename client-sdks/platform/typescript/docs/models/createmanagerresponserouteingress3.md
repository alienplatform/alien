...
```typescript
import { CreateManagerResponseRouteIngress3 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteIngress3 = {
...
| `provider`                                                        | *models.CreateManagerResponseProviderUnion5*                      | :heavy_minus_sign:                                                | N/A                                                               |
