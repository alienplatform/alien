...
```typescript
import { PersistImportedDeploymentRequestCertificateManagedTLSSecret2 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestCertificateManagedTLSSecret2 = {
