...
```typescript
import { SyncReconcileRequestCurrentReleaseOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestCurrentReleaseOverrideAwGrant = {};
```
