...
```typescript
import { DeploymentProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: DeploymentProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                         | [models.DeploymentProviderAwsAlbEnum2](../models/deploymentproviderawsalbenum2.md) | :heavy_check_mark:                                                                 | N/A                                                                                |
