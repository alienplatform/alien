...
```typescript
import { SyncReconcileResponseCertificateManagedTLSSecret2 } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCertificateManagedTLSSecret2 = {
