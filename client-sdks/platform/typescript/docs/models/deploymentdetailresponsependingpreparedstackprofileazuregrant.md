...
```typescript
import { DeploymentDetailResponsePendingPreparedStackProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackProfileAzureGrant = {};
```
