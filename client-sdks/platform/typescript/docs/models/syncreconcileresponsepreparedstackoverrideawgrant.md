...
```typescript
import { SyncReconcileResponsePreparedStackOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePreparedStackOverrideAwGrant = {};
```
