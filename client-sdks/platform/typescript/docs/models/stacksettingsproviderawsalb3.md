...
```typescript
import { StackSettingsProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: StackSettingsProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                               | [models.StackSettingsProviderAwsAlbEnum3](../models/stacksettingsproviderawsalbenum3.md) | :heavy_check_mark:                                                                       | N/A                                                                                      |
