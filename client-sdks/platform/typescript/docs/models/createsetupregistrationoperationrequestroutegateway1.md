...
```typescript
import { CreateSetupRegistrationOperationRequestRouteGateway1 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestRouteGateway1 = {
...
| `provider`                                                           | *models.CreateSetupRegistrationOperationRequestProviderUnion2*       | :heavy_minus_sign:                                                   | N/A                                                                  |
