...
```typescript
import { SyncAcquireResponseCurrentReleaseOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseCurrentReleaseOverrideGcpGrant = {};
```
