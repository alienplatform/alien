...
```typescript
import { CloudFormationCallbackRequestRouteIngress2 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestRouteIngress2 = {
...
| `provider`                                                        | *models.CloudFormationCallbackRequestProviderUnion3*              | :heavy_minus_sign:                                                | N/A                                                               |
