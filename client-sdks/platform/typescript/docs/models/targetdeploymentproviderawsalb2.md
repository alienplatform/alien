...
```typescript
import { TargetDeploymentProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: TargetDeploymentProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                     | [models.TargetDeploymentProviderAwsAlbEnum2](../models/targetdeploymentproviderawsalbenum2.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
