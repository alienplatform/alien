...
```typescript
import { PersistImportedDeploymentRequestOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestOverrideAwGrant = {};
```
