...
```typescript
import { NewDeploymentRequestProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                             | [models.NewDeploymentRequestProviderAwsAlbEnum3](../models/newdeploymentrequestproviderawsalbenum3.md) | :heavy_check_mark:                                                                                     | N/A                                                                                                    |
