...
```typescript
import { SyncReconcileResponsePreparedStackProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePreparedStackProfileGcpGrant = {};
```
