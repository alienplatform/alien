...
```typescript
import { ManagerRetryResponseProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                             | [models.ManagerRetryResponseProviderAwsAlbEnum2](../models/managerretryresponseproviderawsalbenum2.md) | :heavy_check_mark:                                                                                     | N/A                                                                                                    |
