...
```typescript
import { ImportSourceProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: ImportSourceProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                             | [models.ImportSourceProviderAwsAlbEnum3](../models/importsourceproviderawsalbenum3.md) | :heavy_check_mark:                                                                     | N/A                                                                                    |
