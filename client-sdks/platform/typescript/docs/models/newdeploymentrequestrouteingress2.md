...
```typescript
import { NewDeploymentRequestRouteIngress2 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestRouteIngress2 = {
...
| `provider`                                                        | *models.NewDeploymentRequestProviderUnion3*                       | :heavy_minus_sign:                                                | N/A                                                               |
