...
```typescript
import { CreateAccessRequestCommand } from "@alienplatform/platform-api/models";
...
| `tier`                                                                 | [models.CreateAccessRequestTier](../models/createaccessrequesttier.md) | :heavy_minus_sign:                                                     | How risky an operation is (declared by the plugin metadata).           |                                                                        |