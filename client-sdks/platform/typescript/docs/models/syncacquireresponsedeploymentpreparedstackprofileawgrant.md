...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackProfileAwGrant = {};
```
