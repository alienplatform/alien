...
```typescript
import { PersistImportedDeploymentRequestOverrideAwResource } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestOverrideAwResource = {
  resources: [
    "<value 1>",
  ],
};
