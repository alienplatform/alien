...
```typescript
import { SyncListResponseRouteGateway1 } from "@alienplatform/platform-api/models";

let value: SyncListResponseRouteGateway1 = {
...
| `provider`                                                           | *models.SyncListResponseProviderUnion2*                              | :heavy_minus_sign:                                                   | N/A                                                                  |
