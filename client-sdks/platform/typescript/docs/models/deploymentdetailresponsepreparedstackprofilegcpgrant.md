...
```typescript
import { DeploymentDetailResponsePreparedStackProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePreparedStackProfileGcpGrant = {};
```
