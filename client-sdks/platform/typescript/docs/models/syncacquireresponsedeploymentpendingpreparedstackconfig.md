...
```typescript
import { SyncAcquireResponseDeploymentPendingPreparedStackConfig } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPendingPreparedStackConfig = {
  id: "<id>",
  type: "<value>",
};
```
