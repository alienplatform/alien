...
```typescript
import { SyncListResponsePendingPreparedStackExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackExtendGcpGrant = {};
```
