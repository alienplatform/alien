...
```typescript
import { SyncAcquireResponsePendingDeleteResourceModeEnum } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponsePendingDeleteResourceModeEnum = "live";
```
