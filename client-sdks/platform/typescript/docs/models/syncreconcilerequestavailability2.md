...
| `source`                                                                                                                                  | [models.SyncReconcileRequestAvailabilitySource2](../models/syncreconcilerequestavailabilitysource2.md)                                    | :heavy_check_mark:                                                                                                                        | Provider control plane used to observe model availability without invoking<br/>a model, spending customer quota, or accepting provider terms. |