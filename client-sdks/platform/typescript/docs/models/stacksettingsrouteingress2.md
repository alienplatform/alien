...
```typescript
import { StackSettingsRouteIngress2 } from "@alienplatform/platform-api/models";

let value: StackSettingsRouteIngress2 = {
...
| `provider`                                                        | *models.StackSettingsProviderUnion3*                              | :heavy_minus_sign:                                                | N/A                                                               |
