...
```typescript
import { CreateManagerResponseRouteGateway4 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteGateway4 = {
...
| `provider`                                                           | *models.CreateManagerResponseProviderUnion8*                         | :heavy_minus_sign:                                                   | N/A                                                                  |
