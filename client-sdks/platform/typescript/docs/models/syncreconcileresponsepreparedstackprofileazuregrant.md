...
```typescript
import { SyncReconcileResponsePreparedStackProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePreparedStackProfileAzureGrant = {};
```
