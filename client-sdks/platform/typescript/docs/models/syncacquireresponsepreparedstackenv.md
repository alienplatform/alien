...
```typescript
import { SyncAcquireResponsePreparedStackEnv } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponsePreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.SyncAcquireResponsePreparedStackTypeUnion*                      | :heavy_minus_sign:                                                      | N/A                                                                     |