...
```typescript
import { DeploymentStatePendingPreparedStackOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackOverrideGcpGrant = {};
```
