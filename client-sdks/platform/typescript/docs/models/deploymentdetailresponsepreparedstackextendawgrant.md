...
```typescript
import { DeploymentDetailResponsePreparedStackExtendAwGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePreparedStackExtendAwGrant = {};
```
