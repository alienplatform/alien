...
```typescript
import { CloudFormationCallbackRequestProviderAwsAlb1 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestProviderAwsAlb1 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                               | [models.CloudFormationCallbackRequestProviderAwsAlbEnum1](../models/cloudformationcallbackrequestproviderawsalbenum1.md) | :heavy_check_mark:                                                                                                       | N/A                                                                                                                      |
