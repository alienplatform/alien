...
```typescript
import { SyncAcquireResponseTargetReleaseProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseTargetReleaseProfileGcpGrant = {};
```
