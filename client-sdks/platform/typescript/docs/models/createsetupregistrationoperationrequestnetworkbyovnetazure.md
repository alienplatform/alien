...
```typescript
import { CreateSetupRegistrationOperationRequestNetworkByoVnetAzure } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestNetworkByoVnetAzure = {
...
| `type`                                                                                                                                 | [models.CreateSetupRegistrationOperationRequestTypeByoVnetAzure](../models/createsetupregistrationoperationrequesttypebyovnetazure.md) | :heavy_check_mark:                                                                                                                     | N/A                                                                                                                                    |
