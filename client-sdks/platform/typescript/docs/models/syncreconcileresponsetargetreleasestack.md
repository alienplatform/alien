...
| `inputs`                                                                                                                         | [models.SyncReconcileResponseTargetReleaseInput](../models/syncreconcileresponsetargetreleaseinput.md)[]                         | :heavy_minus_sign:                                                                                                               | Input definitions required before setup or deployment can proceed.                                                               |
...
| `supportedPlatforms`                                                                                                             | [models.SyncReconcileResponseTargetReleaseSupportedPlatform](../models/syncreconcileresponsetargetreleasesupportedplatform.md)[] | :heavy_minus_sign:                                                                                                               | Which platforms this stack supports. When None, all platforms are supported.                                                     |