...
```typescript
import { SyncListResponsePendingPreparedStackExtendAwGrant } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackExtendAwGrant = {};
```
