...
```typescript
import { SyncReconcileResponsePreparedStackExtendAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePreparedStackExtendAwGrant = {};
```
