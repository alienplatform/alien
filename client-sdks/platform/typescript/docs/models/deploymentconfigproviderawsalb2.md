...
```typescript
import { DeploymentConfigProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: DeploymentConfigProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                     | [models.DeploymentConfigProviderAwsAlbEnum2](../models/deploymentconfigproviderawsalbenum2.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
