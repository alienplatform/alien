...
```typescript
import { DeploymentSetupStackSettingsPolicyNetworkByoVnetAzure } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyNetworkByoVnetAzure = {
...
| `type`                                                                                                                       | [models.DeploymentSetupStackSettingsPolicyTypeByoVnetAzure](../models/deploymentsetupstacksettingspolicytypebyovnetazure.md) | :heavy_check_mark:                                                                                                           | N/A                                                                                                                          |
