...
```typescript
import { PersistImportedDeploymentRequestPreparedStackOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackOverrideGcpGrant = {};
```
