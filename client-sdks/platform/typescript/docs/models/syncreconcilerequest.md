...
| `operatorImage`                                                                           | [models.RemoteOperatorImageIdentity](../models/remoteoperatorimageidentity.md)            | :heavy_minus_sign:                                                                        | Exact immutable image identity reported by a running Remote Operator.                     |                                                                                           |
| `operationsReport`                                                                        | [models.OperationsReport](../models/operationsreport.md)                                  | :heavy_minus_sign:                                                                        | Operations bundle set the Operator currently has loaded, for plugin-sync status tracking. |                                                                                           |