...
```typescript
import { SyncAcquireResponseRouteGateway1 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseRouteGateway1 = {
...
| `provider`                                                           | *models.SyncAcquireResponseProviderUnion2*                           | :heavy_minus_sign:                                                   | N/A                                                                  |
