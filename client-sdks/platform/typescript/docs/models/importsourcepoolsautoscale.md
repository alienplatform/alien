...
```typescript
import { ImportSourcePoolsAutoscale } from "@alienplatform/platform-api/models";

let value: ImportSourcePoolsAutoscale = {
  max: 222655,
  min: 556865,
  mode: "autoscale",
};
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.ImportSourceFailureDomainsUnion2*           | :heavy_minus_sign:                                  | N/A                                                 |
