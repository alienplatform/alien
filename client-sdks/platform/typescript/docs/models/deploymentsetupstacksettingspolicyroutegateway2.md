...
```typescript
import { DeploymentSetupStackSettingsPolicyRouteGateway2 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyRouteGateway2 = {
...
| `provider`                                                           | *models.DeploymentSetupStackSettingsPolicyProviderUnion4*            | :heavy_minus_sign:                                                   | N/A                                                                  |
