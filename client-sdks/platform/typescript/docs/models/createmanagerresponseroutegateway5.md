...
```typescript
import { CreateManagerResponseRouteGateway5 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteGateway5 = {
...
| `provider`                                                           | *models.CreateManagerResponseProviderUnion10*                        | :heavy_minus_sign:                                                   | N/A                                                                  |
