...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackConfig } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackConfig = {
  id: "<id>",
  type: "<value>",
};
```
