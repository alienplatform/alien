...
```typescript
import { SyncListResponseProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: SyncListResponseProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                     | [models.SyncListResponseProviderAwsAlbEnum3](../models/synclistresponseproviderawsalbenum3.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
