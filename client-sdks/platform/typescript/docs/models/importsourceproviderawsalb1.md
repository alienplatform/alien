...
```typescript
import { ImportSourceProviderAwsAlb1 } from "@alienplatform/platform-api/models";

let value: ImportSourceProviderAwsAlb1 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                             | [models.ImportSourceProviderAwsAlbEnum1](../models/importsourceproviderawsalbenum1.md) | :heavy_check_mark:                                                                     | N/A                                                                                    |
