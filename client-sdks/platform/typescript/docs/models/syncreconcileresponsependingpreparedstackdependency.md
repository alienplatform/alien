...
```typescript
import { SyncReconcileResponsePendingPreparedStackDependency } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackDependency = {
  id: "<id>",
  type: "<value>",
};
```
