...
```typescript
import { DeploymentDetailResponsePendingPreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackExtendAzureGrant = {};
```
