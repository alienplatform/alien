...
```typescript
import { PersistImportedDeploymentRequestEnv } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.PersistImportedDeploymentRequestTypeUnion*                      | :heavy_minus_sign:                                                      | N/A                                                                     |