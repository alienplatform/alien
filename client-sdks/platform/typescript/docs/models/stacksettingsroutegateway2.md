...
```typescript
import { StackSettingsRouteGateway2 } from "@alienplatform/platform-api/models";

let value: StackSettingsRouteGateway2 = {
...
| `provider`                                                           | *models.StackSettingsProviderUnion4*                                 | :heavy_minus_sign:                                                   | N/A                                                                  |
