...
```typescript
import { SyncReconcileResponseTargetRelease } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseTargetRelease = {
  releaseId: "<id>",
  stack: {
    id: "<id>",
    resources: {
...
| `stack`                                                                                                | [models.SyncReconcileResponseTargetReleaseStack](../models/syncreconcileresponsetargetreleasestack.md) | :heavy_check_mark:                                                                                     | A bag of resources, unaware of any cloud.                                                              |
