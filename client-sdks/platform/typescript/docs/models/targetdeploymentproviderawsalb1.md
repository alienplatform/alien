...
```typescript
import { TargetDeploymentProviderAwsAlb1 } from "@alienplatform/platform-api/models";

let value: TargetDeploymentProviderAwsAlb1 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                     | [models.TargetDeploymentProviderAwsAlbEnum1](../models/targetdeploymentproviderawsalbenum1.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
