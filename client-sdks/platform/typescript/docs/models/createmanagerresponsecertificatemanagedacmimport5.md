...
```typescript
import { CreateManagerResponseCertificateManagedAcmImport5 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseCertificateManagedAcmImport5 = {
