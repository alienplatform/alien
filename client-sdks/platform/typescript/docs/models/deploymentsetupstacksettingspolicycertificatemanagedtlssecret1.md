...
```typescript
import { DeploymentSetupStackSettingsPolicyCertificateManagedTLSSecret1 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyCertificateManagedTLSSecret1 = {
