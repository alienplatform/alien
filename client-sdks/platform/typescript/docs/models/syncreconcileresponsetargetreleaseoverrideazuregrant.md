...
```typescript
import { SyncReconcileResponseTargetReleaseOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseTargetReleaseOverrideAzureGrant = {};
```
