...
```typescript
import { SyncReconcileResponseRouteIngress2 } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseRouteIngress2 = {
...
| `provider`                                                        | *models.SyncReconcileResponseProviderUnion3*                      | :heavy_minus_sign:                                                | N/A                                                               |
