...
```typescript
import { CreateManagerResponseRouteGateway2 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteGateway2 = {
...
| `provider`                                                           | *models.CreateManagerResponseProviderUnion4*                         | :heavy_minus_sign:                                                   | N/A                                                                  |
