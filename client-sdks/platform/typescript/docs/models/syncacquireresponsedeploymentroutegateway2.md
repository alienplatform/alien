...
```typescript
import { SyncAcquireResponseDeploymentRouteGateway2 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentRouteGateway2 = {
...
| `provider`                                                           | *models.SyncAcquireResponseDeploymentProviderUnion4*                 | :heavy_minus_sign:                                                   | N/A                                                                  |
