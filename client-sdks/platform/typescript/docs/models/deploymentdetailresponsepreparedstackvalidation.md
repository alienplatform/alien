...
```typescript
import { DeploymentDetailResponsePreparedStackValidation } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePreparedStackValidation = {};
```
