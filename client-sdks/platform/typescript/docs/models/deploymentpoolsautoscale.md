...
```typescript
import { DeploymentPoolsAutoscale } from "@alienplatform/platform-api/models";

let value: DeploymentPoolsAutoscale = {
  max: 164752,
  min: 220429,
  mode: "autoscale",
};
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.DeploymentFailureDomainsUnion2*             | :heavy_minus_sign:                                  | N/A                                                 |
