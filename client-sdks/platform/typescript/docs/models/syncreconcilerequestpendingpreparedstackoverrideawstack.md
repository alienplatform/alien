...
```typescript
import { SyncReconcileRequestPendingPreparedStackOverrideAwStack } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackOverrideAwStack = {
  resources: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
