...
```typescript
import { Instance4 } from "@alienplatform/platform-api/models";
...
| ----------------------------- | ----------------------------- | ----------------------------- | ----------------------------- |
| `cpu`                         | *models.InstanceCpuUnion4*    | :heavy_minus_sign:            | N/A                           |
| `ip`                          | *string*                      | :heavy_minus_sign:            | N/A                           |
| `machineId`                   | *string*                      | :heavy_minus_sign:            | N/A                           |
| `memory`                      | *models.InstanceMemoryUnion4* | :heavy_minus_sign:            | N/A                           |
