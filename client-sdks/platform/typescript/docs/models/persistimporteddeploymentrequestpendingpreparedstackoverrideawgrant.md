...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackOverrideAwGrant =
  {};
```
