...
| `inputs`                                                                                                             | [models.SyncListResponseInput](../models/synclistresponseinput.md)[]                                                 | :heavy_minus_sign:                                                                                                   | Input definitions required before setup or deployment can proceed.                                                   |
