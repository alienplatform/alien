...
```typescript
import { EventListItemResponseDataDeploymentDeletionRequested } from "@alienplatform/platform-api/models";

let value: EventListItemResponseDataDeploymentDeletionRequested = {
  deploymentId: "<id>",
