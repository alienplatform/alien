...
```typescript
import { SyncReconcileRequestPendingPreparedStackOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackOverrideAwGrant = {};
```
