...
| `setupMethods`                                                                                                       | [models.SyncReconcileRequestCurrentReleaseSetupMethod](../models/syncreconcilerequestcurrentreleasesetupmethod.md)[] | :heavy_minus_sign:                                                                                                   | Setup methods where this input applies.                                                                              |
