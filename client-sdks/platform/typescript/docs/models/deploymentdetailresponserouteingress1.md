...
```typescript
import { DeploymentDetailResponseRouteIngress1 } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponseRouteIngress1 = {
...
| `provider`                                                        | *models.DeploymentDetailResponseProviderUnion1*                   | :heavy_minus_sign:                                                | N/A                                                               |
