...
```typescript
import { DeploymentPreparedStackEnv } from "@alienplatform/platform-api/models";

let value: DeploymentPreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.DeploymentPreparedStackTypeUnion*                               | :heavy_minus_sign:                                                      | N/A                                                                     |
