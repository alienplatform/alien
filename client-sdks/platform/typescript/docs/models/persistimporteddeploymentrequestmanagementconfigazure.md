...
```typescript
import { PersistImportedDeploymentRequestManagementConfigAzure } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestManagementConfigAzure = {
  managingTenantId: "<id>",
  platform: "azure",
};
```
