...
```typescript
import { SyncReconcileRequestPendingPreparedStackOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackOverrideAzureGrant = {};
```
