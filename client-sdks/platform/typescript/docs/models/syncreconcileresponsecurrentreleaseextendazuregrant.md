...
```typescript
import { SyncReconcileResponseCurrentReleaseExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCurrentReleaseExtendAzureGrant = {};
```
