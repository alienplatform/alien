...
```typescript
import { SyncReconcileRequestPendingPreparedStackValidation } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackValidation = {};
```
