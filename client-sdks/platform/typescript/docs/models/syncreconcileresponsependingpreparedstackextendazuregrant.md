...
```typescript
import { SyncReconcileResponsePendingPreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackExtendAzureGrant = {};
```
