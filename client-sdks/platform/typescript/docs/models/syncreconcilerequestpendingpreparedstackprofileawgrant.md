...
```typescript
import { SyncReconcileRequestPendingPreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackProfileAwGrant = {};
```
