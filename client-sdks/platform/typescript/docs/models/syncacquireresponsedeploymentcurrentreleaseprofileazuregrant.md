...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseProfileAzureGrant = {};
```
