...
```typescript
import { PersistImportedDeploymentRequestSetupUpdateAuthorization } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestSetupUpdateAuthorization = {
  baselineFrozenDigest: "<value>",
  nonce: "<value>",
  releaseId: "<id>",
  setupFingerprint: "<value>",
  setupFingerprintVersion: 956709,
  setupTarget: "<value>",
