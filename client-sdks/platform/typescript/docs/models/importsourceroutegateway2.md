...
```typescript
import { ImportSourceRouteGateway2 } from "@alienplatform/platform-api/models";

let value: ImportSourceRouteGateway2 = {
...
| `provider`                                                           | *models.ImportSourceProviderUnion4*                                  | :heavy_minus_sign:                                                   | N/A                                                                  |
