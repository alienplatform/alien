...
```typescript
import { ManagerRetryResponseRouteGateway2 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteGateway2 = {
...
| `provider`                                                           | *models.ManagerRetryResponseProviderUnion4*                          | :heavy_minus_sign:                                                   | N/A                                                                  |
