...
```typescript
import { ComputePoolSelectionAutoscale } from "@alienplatform/platform-api/models";
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.ComputePoolSelectionFailureDomainsUnion2*   | :heavy_minus_sign:                                  | N/A                                                 |
