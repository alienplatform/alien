# TargetReleaseProfileStateAwResource
...
```typescript
import { TargetReleaseProfileStateAwResource } from "@alienplatform/platform-api/models";

let value: TargetReleaseProfileStateAwResource = {
  resources: [],
};
```
