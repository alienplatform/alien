...
| `effect`                                                                                                                     | [models.SyncReconcileResponsePreparedStackProfileEffect](../models/syncreconcileresponsepreparedstackprofileeffect.md)       | :heavy_minus_sign:                                                                                                           | IAM effect. Defaults to Allow.                                                                                               |
