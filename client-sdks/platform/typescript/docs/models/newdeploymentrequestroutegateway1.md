...
```typescript
import { NewDeploymentRequestRouteGateway1 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestRouteGateway1 = {
...
| `provider`                                                           | *models.NewDeploymentRequestProviderUnion2*                          | :heavy_minus_sign:                                                   | N/A                                                                  |
