...
```typescript
import { DeploymentSetupStackSettingsPolicyCompute } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyCompute = {};
```
...
| --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `pools`                                                               | Record<string, *models.DeploymentSetupStackSettingsPolicyPoolsUnion*> | :heavy_minus_sign:                                                    | Selected compute choices keyed by pool ID.                            |