...
```typescript
import { CloudFormationCallbackRequestCertificateTLSSecretRef2 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestCertificateTLSSecretRef2 = {
  secretName: "<value>",
  mode: "tlsSecretRef",
};
```
