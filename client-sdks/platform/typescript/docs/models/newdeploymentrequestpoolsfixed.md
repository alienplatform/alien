...
```typescript
import { NewDeploymentRequestPoolsFixed } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestPoolsFixed = {
  machines: 442557,
  mode: "fixed",
};
```
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.NewDeploymentRequestFailureDomainsUnion1*   | :heavy_minus_sign:                                  | N/A                                                 |
