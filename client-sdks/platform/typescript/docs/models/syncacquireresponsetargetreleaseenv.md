...
```typescript
import { SyncAcquireResponseTargetReleaseEnv } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseTargetReleaseEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.SyncAcquireResponseTargetReleaseTypeUnion*                      | :heavy_minus_sign:                                                      | N/A                                                                     |