...
```typescript
import { DeploymentSetupStackSettingsPolicyCertificateTLSSecretRef2 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyCertificateTLSSecretRef2 = {
  secretName: "<value>",
  mode: "tlsSecretRef",
};
```
