...
```typescript
import { SyncListResponsePendingPreparedStackOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackOverrideAzureGrant = {};
```
