...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackExtendGcpGrant = {};
```
