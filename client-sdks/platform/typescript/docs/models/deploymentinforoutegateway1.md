...
```typescript
import { DeploymentInfoRouteGateway1 } from "@alienplatform/platform-api/models";

let value: DeploymentInfoRouteGateway1 = {
...
| `provider`                                                           | *models.SetupUpdateProviderUnion2*                                   | :heavy_minus_sign:                                                   | N/A                                                                  |
