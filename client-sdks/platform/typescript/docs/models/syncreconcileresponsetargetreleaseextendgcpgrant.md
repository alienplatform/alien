...
```typescript
import { SyncReconcileResponseTargetReleaseExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseTargetReleaseExtendGcpGrant = {};
```
