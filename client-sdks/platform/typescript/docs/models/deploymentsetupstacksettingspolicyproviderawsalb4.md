...
```typescript
import { DeploymentSetupStackSettingsPolicyProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                                         | [models.DeploymentSetupStackSettingsPolicyProviderAwsAlbEnum4](../models/deploymentsetupstacksettingspolicyproviderawsalbenum4.md) | :heavy_check_mark:                                                                                                                 | N/A                                                                                                                                |
