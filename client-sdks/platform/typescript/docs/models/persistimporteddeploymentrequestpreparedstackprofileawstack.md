...
```typescript
import { PersistImportedDeploymentRequestPreparedStackProfileAwStack } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackProfileAwStack = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
