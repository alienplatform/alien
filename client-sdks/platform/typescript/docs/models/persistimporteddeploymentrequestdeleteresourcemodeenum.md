...
```typescript
import { PersistImportedDeploymentRequestDeleteResourceModeEnum } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestDeleteResourceModeEnum = "live";
```
