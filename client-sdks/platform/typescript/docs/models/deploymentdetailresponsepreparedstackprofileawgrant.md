...
```typescript
import { DeploymentDetailResponsePreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePreparedStackProfileAwGrant = {};
```
