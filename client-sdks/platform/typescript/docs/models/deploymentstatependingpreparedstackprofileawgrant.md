...
```typescript
import { DeploymentStatePendingPreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackProfileAwGrant = {};
```
