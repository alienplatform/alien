...
```typescript
import { CloudFormationCallbackRequestRouteGateway2 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestRouteGateway2 = {
...
| `provider`                                                           | *models.CloudFormationCallbackRequestProviderUnion4*                 | :heavy_minus_sign:                                                   | N/A                                                                  |
