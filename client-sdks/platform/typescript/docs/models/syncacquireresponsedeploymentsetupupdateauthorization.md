...
```typescript
import { SyncAcquireResponseDeploymentSetupUpdateAuthorization } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentSetupUpdateAuthorization = {
  baselineFrozenDigest: "<value>",
  nonce: "<value>",
  releaseId: "<id>",
  setupFingerprint: "<value>",
  setupFingerprintVersion: 21546,
  setupTarget: "<value>",
