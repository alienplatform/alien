...
```typescript
import { SyncAcquireResponseRouteIngress2 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseRouteIngress2 = {
...
| `provider`                                                        | *models.SyncAcquireResponseProviderUnion3*                        | :heavy_minus_sign:                                                | N/A                                                               |
