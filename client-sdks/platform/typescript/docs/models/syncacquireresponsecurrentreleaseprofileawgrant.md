...
```typescript
import { SyncAcquireResponseCurrentReleaseProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseCurrentReleaseProfileAwGrant = {};
```
