...
```typescript
import { CloudFormationCallbackRequestNetworkByoVnetAzure } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestNetworkByoVnetAzure = {
...
| `type`                                                                                                             | [models.CloudFormationCallbackRequestTypeByoVnetAzure](../models/cloudformationcallbackrequesttypebyovnetazure.md) | :heavy_check_mark:                                                                                                 | N/A                                                                                                                |
