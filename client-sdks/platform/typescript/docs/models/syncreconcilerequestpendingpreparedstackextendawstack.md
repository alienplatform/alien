...
```typescript
import { SyncReconcileRequestPendingPreparedStackExtendAwStack } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackExtendAwStack = {
  resources: [],
};
```
