...
```typescript
import { CloudFormationCallbackRequestProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                               | [models.CloudFormationCallbackRequestProviderAwsAlbEnum2](../models/cloudformationcallbackrequestproviderawsalbenum2.md) | :heavy_check_mark:                                                                                                       | N/A                                                                                                                      |
