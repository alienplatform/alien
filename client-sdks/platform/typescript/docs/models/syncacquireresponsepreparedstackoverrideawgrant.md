...
```typescript
import { SyncAcquireResponsePreparedStackOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponsePreparedStackOverrideAwGrant = {};
```
