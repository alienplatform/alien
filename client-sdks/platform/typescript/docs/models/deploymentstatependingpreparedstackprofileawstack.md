...
```typescript
import { DeploymentStatePendingPreparedStackProfileAwStack } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackProfileAwStack = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
