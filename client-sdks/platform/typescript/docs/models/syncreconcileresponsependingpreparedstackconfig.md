...
```typescript
import { SyncReconcileResponsePendingPreparedStackConfig } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackConfig = {
  id: "<id>",
  type: "<value>",
};
```
