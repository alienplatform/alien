...
```typescript
import { SyncReconcileResponsePreparedStackExtendAw } from "@alienplatform/platform-api/models";
...
| `effect`                                                                                                                   | [models.SyncReconcileResponsePreparedStackExtendEffect](../models/syncreconcileresponsepreparedstackextendeffect.md)       | :heavy_minus_sign:                                                                                                         | IAM effect. Defaults to Allow.                                                                                             |
