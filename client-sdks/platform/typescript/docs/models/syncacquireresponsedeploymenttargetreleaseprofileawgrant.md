...
```typescript
import { SyncAcquireResponseDeploymentTargetReleaseProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentTargetReleaseProfileAwGrant = {};
```
