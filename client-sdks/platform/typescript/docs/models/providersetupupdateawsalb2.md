...
```typescript
import { ProviderSetupUpdateAwsAlb2 } from "@alienplatform/platform-api/models";

let value: ProviderSetupUpdateAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                           | [models.SetupUpdateProviderAwsAlbEnum2](../models/setupupdateproviderawsalbenum2.md) | :heavy_check_mark:                                                                   | N/A                                                                                  |
