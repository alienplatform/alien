...
```typescript
import { SyncReconcileRequestPendingDeleteResourceModeEnum } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingDeleteResourceModeEnum = "all";
```
