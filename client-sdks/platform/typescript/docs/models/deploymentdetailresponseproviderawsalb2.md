...
```typescript
import { DeploymentDetailResponseProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponseProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                     | [models.DeploymentDetailResponseProviderAwsAlbEnum2](../models/deploymentdetailresponseproviderawsalbenum2.md) | :heavy_check_mark:                                                                                             | N/A                                                                                                            |
