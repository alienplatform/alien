...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackProfileGcpGrant =
  {};
```
