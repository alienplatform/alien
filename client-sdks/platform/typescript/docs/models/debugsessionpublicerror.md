...
```typescript
import { DebugSessionPublicError } from "@alienplatform/platform-api/models";

let value: DebugSessionPublicError = {
  code: "<value>",
  internal: false,
  message: "<value>",
  retryable: false,
...
| `source`                                                                         | [models.DebugSessionPublicErrorCause](../models/debugsessionpublicerrorcause.md) | :heavy_minus_sign:                                                               | N/A                                                                              |
