...
```typescript
import { SyncReconcileResponseTargetReleaseOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseTargetReleaseOverrideGcpGrant = {};
```
