...
```typescript
import { CreateManagerResponseRouteGateway3 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteGateway3 = {
...
| `provider`                                                           | *models.CreateManagerResponseProviderUnion6*                         | :heavy_minus_sign:                                                   | N/A                                                                  |
