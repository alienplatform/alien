...
```typescript
import { SyncAcquireResponseCurrentReleaseExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseCurrentReleaseExtendGcpGrant = {};
```
