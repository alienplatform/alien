...
| `inputs`                                                                                                                     | [models.PersistImportedDeploymentRequestInput](../models/persistimporteddeploymentrequestinput.md)[]                         | :heavy_minus_sign:                                                                                                           | Input definitions required before setup or deployment can proceed.                                                           |
