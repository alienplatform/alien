...
```typescript
import { SyncAcquireResponseDeploymentPendingPreparedStackOverrideAwStack } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPendingPreparedStackOverrideAwStack = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
