...
```typescript
import { DeploymentStatePendingPreparedStackOverrideAwStack } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackOverrideAwStack = {
  resources: [],
};
```
