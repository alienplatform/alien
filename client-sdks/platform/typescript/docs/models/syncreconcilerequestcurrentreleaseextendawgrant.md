...
```typescript
import { SyncReconcileRequestCurrentReleaseExtendAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestCurrentReleaseExtendAwGrant = {};
```
