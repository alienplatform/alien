...
```typescript
import { DeploymentDetailResponsePendingPreparedStackEnv } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.DeploymentDetailResponsePendingPreparedStackTypeUnion*          | :heavy_minus_sign:                                                      | N/A                                                                     |
