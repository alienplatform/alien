...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackValidation } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackValidation = {};
```
