...
```typescript
import { PersistImportedDeploymentRequestNetworkByoVnetAzure } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestNetworkByoVnetAzure = {
...
| `type`                                                                                                                   | [models.PersistImportedDeploymentRequestTypeByoVnetAzure](../models/persistimporteddeploymentrequesttypebyovnetazure.md) | :heavy_check_mark:                                                                                                       | N/A                                                                                                                      |
