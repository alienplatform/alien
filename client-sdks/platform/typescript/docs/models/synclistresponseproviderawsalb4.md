...
```typescript
import { SyncListResponseProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: SyncListResponseProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                     | [models.SyncListResponseProviderAwsAlbEnum4](../models/synclistresponseproviderawsalbenum4.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
