...
```typescript
import { PersistImportedDeploymentRequestPreparedStackConfig } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackConfig = {
  id: "<id>",
  type: "<value>",
};
```
