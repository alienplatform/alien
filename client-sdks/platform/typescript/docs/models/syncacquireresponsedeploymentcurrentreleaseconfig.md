...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseConfig } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseConfig = {
  id: "<id>",
  type: "<value>",
};
```
