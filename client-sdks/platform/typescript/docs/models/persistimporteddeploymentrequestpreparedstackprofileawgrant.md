...
```typescript
import { PersistImportedDeploymentRequestPreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackProfileAwGrant = {};
```
