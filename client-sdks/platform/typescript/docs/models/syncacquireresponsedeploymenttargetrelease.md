...
```typescript
import { SyncAcquireResponseDeploymentTargetRelease } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentTargetRelease = {
  stack: {
    id: "<id>",
    resources: {
      "key": {
...
| `stack`                                                                                                                                             | [models.SyncAcquireResponseDeploymentTargetReleaseStack](../models/syncacquireresponsedeploymenttargetreleasestack.md)                              | :heavy_check_mark:                                                                                                                                  | A bag of resources, unaware of any cloud.                                                                                                           |
