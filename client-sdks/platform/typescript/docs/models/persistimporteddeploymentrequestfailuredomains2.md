...
```typescript
import { PersistImportedDeploymentRequestFailureDomains2 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestFailureDomains2 = {
  spread: 666091,
};
```
