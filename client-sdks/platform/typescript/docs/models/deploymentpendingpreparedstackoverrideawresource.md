...
```typescript
import { DeploymentPendingPreparedStackOverrideAwResource } from "@alienplatform/platform-api/models";

let value: DeploymentPendingPreparedStackOverrideAwResource = {
  resources: [],
};
```
