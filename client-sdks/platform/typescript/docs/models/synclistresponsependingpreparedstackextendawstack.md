...
```typescript
import { SyncListResponsePendingPreparedStackExtendAwStack } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackExtendAwStack = {
  resources: [
    "<value 1>",
  ],
};
