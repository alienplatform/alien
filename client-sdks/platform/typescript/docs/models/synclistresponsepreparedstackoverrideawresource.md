...
```typescript
import { SyncListResponsePreparedStackOverrideAwResource } from "@alienplatform/platform-api/models";

let value: SyncListResponsePreparedStackOverrideAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
