...
```typescript
const value: models.EventDataReleaseChannelUpdated = {
  channel: "<value>",
  releaseId: "<id>",
...
### `models.EventDataDeploymentReleaseChannelChanged`

```typescript
const value: models.EventDataDeploymentReleaseChannelChanged = {
  channel: "<value>",
  deploymentId: "<id>",
