...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackExtendAwStack } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackExtendAwStack = {
  resources: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
