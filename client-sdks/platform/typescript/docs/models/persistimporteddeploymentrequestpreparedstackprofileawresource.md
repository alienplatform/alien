...
```typescript
import { PersistImportedDeploymentRequestPreparedStackProfileAwResource } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackProfileAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
