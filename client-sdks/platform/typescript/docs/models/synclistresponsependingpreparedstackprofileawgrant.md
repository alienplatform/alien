...
```typescript
import { SyncListResponsePendingPreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackProfileAwGrant = {};
```
