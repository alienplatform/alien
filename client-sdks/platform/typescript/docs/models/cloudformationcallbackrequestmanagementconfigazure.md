...
```typescript
import { CloudFormationCallbackRequestManagementConfigAzure } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestManagementConfigAzure = {
  managingTenantId: "<id>",
  oidcIssuer: "<value>",
  oidcSubject: "<value>",
  platform: "azure",
...
| `platform`                                                                                                   | [models.CloudFormationCallbackRequestPlatformAzure](../models/cloudformationcallbackrequestplatformazure.md) | :heavy_check_mark:                                                                                           | N/A                                                                                                          |