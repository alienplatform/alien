...
```typescript
import { DeploymentRouteGateway2 } from "@alienplatform/platform-api/models";

let value: DeploymentRouteGateway2 = {
...
| `provider`                                                           | *models.DeploymentProviderUnion4*                                    | :heavy_minus_sign:                                                   | N/A                                                                  |
