...
```typescript
import { DeploymentSetupStackSettingsPolicyCertificateManagedAcmImport1 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyCertificateManagedAcmImport1 = {
