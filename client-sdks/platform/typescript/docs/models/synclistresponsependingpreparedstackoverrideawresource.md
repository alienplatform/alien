...
```typescript
import { SyncListResponsePendingPreparedStackOverrideAwResource } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackOverrideAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
