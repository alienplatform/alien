...
```typescript
import { DeploymentDetailResponsePreparedStackProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePreparedStackProfileAzureGrant = {};
```
