...
```typescript
import { PersistImportedDeploymentRequestPreparedStackOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackOverrideAzureGrant = {};
```
