...
```typescript
import { ProjectReleaseInfo } from "@alienplatform/platform-api/models";

let value: ProjectReleaseInfo = {
  ...
  createdAt: new Date("2026-07-24T18:21:20.294Z"),
};
```
...
| `title`                                                                                       | *string*                                                                                      | :heavy_minus_sign:                                                                            | Human-readable release title                                                                  |                                                                                               |
| `gitMetadata`                                                                                 | [models.GitMetadata](../models/gitmetadata.md)                                                | :heavy_check_mark:                                                                            | N/A                                                                                           |                                                                                               |
