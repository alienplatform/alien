...
```typescript
import { SyncReconcileResponseRouteGateway1 } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseRouteGateway1 = {
...
| `provider`                                                           | *models.SyncReconcileResponseProviderUnion2*                         | :heavy_minus_sign:                                                   | N/A                                                                  |
