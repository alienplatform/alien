...
```typescript
import { PersistImportedDeploymentRequestProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestProfileAzureGrant = {};
```
