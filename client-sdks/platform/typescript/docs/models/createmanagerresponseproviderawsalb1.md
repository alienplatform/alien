...
```typescript
import { CreateManagerResponseProviderAwsAlb1 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseProviderAwsAlb1 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                               | [models.CreateManagerResponseProviderAwsAlbEnum1](../models/createmanagerresponseproviderawsalbenum1.md) | :heavy_check_mark:                                                                                       | N/A                                                                                                      |
