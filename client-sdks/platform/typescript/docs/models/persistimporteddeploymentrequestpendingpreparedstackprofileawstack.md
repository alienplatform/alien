...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackProfileAwStack } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackProfileAwStack =
  {
    resources: [
      "<value 1>",
      "<value 2>",
