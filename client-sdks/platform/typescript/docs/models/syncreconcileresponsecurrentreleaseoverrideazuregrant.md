...
```typescript
import { SyncReconcileResponseCurrentReleaseOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCurrentReleaseOverrideAzureGrant = {};
```
