...
```typescript
import { SyncReconcileResponseCertificateManagedAcmImport1 } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCertificateManagedAcmImport1 = {
