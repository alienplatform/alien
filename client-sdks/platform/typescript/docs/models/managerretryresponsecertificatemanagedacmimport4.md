...
```typescript
import { ManagerRetryResponseCertificateManagedAcmImport4 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseCertificateManagedAcmImport4 = {
