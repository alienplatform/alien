# PreparedStackExtendStateAwResource
...
```typescript
import { PreparedStackExtendStateAwResource } from "@alienplatform/platform-api/models";

let value: PreparedStackExtendStateAwResource = {
  resources: [
    "<value 1>",
  ],
};
