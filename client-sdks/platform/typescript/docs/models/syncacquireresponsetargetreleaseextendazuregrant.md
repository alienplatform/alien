...
```typescript
import { SyncAcquireResponseTargetReleaseExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseTargetReleaseExtendAzureGrant = {};
```
