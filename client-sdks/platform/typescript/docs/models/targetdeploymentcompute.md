...
```typescript
import { TargetDeploymentCompute } from "@alienplatform/platform-api/models";

let value: TargetDeploymentCompute = {};
```
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `pools`                                             | Record<string, *models.TargetDeploymentPoolsUnion*> | :heavy_minus_sign:                                  | Selected compute choices keyed by pool ID.          |