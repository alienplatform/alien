...
```typescript
import { SyncListResponsePendingPreparedStackEnv } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.SyncListResponsePendingPreparedStackTypeUnion*                  | :heavy_minus_sign:                                                      | N/A                                                                     |
