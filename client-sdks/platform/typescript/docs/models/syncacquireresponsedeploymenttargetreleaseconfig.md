...
```typescript
import { SyncAcquireResponseDeploymentTargetReleaseConfig } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentTargetReleaseConfig = {
  id: "<id>",
  type: "<value>",
};
```
