...
```typescript
import { ManagerRetryResponseRouteIngress6 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteIngress6 = {
...
| `provider`                                                        | *models.ManagerRetryResponseProviderUnion11*                      | :heavy_minus_sign:                                                | N/A                                                               |
