...
```typescript
import { CloudFormationCallbackRequestCertificateManagedAcmImport2 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestCertificateManagedAcmImport2 = {
