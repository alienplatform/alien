...
```typescript
import { PersistImportedDeploymentRequestPreparedStackOverrideAwResource } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackOverrideAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
