...
```typescript
import { DeploymentPendingPreparedStackProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: DeploymentPendingPreparedStackProfileAzureGrant = {};
```
