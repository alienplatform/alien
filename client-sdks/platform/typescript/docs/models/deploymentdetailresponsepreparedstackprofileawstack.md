...
```typescript
import { DeploymentDetailResponsePreparedStackProfileAwStack } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePreparedStackProfileAwStack = {
  resources: [
    "<value 1>",
  ],
};
