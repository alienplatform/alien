...
```typescript
import { SyncReconcileRequestCurrentReleaseProfileAwResource } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestCurrentReleaseProfileAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
