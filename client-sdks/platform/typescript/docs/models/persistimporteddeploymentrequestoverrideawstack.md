...
```typescript
import { PersistImportedDeploymentRequestOverrideAwStack } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestOverrideAwStack = {
  resources: [],
};
```
