...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackProfileAzureGrant = {};
```
