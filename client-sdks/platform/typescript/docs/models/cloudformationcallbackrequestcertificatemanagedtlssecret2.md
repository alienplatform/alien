...
```typescript
import { CloudFormationCallbackRequestCertificateManagedTLSSecret2 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestCertificateManagedTLSSecret2 = {
