...
```typescript
import { SyncAcquireResponseRouteIngress1 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseRouteIngress1 = {
...
| `provider`                                                        | *models.SyncAcquireResponseProviderUnion1*                        | :heavy_minus_sign:                                                | N/A                                                               |
