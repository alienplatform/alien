...
```typescript
import { PersistImportedDeploymentRequestProfileAwResource } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestProfileAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
