...
```typescript
import { DeploymentInfoRouteIngress1 } from "@alienplatform/platform-api/models";

let value: DeploymentInfoRouteIngress1 = {
...
| `provider`                                                        | *models.SetupUpdateProviderUnion1*                                | :heavy_minus_sign:                                                | N/A                                                               |
