# SyncAcquireResponseDeleteScope
...
```typescript
import { SyncAcquireResponseDeleteScope } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeleteScope = "liveOnly";
```
