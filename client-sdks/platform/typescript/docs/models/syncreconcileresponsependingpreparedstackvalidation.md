...
```typescript
import { SyncReconcileResponsePendingPreparedStackValidation } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackValidation = {};
```
