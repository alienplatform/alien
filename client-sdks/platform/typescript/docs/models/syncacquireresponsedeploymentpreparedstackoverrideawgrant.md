...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackOverrideAwGrant = {};
```
