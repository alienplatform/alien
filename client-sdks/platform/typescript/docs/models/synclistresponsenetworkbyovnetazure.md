...
```typescript
import { SyncListResponseNetworkByoVnetAzure } from "@alienplatform/platform-api/models";

let value: SyncListResponseNetworkByoVnetAzure = {
...
| `type`                                                                                   | [models.SyncListResponseTypeByoVnetAzure](../models/synclistresponsetypebyovnetazure.md) | :heavy_check_mark:                                                                       | N/A                                                                                      |
