...
```typescript
import { ManagerRetryResponseProviderAwsAlb7 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseProviderAwsAlb7 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                             | [models.ManagerRetryResponseProviderAwsAlbEnum7](../models/managerretryresponseproviderawsalbenum7.md) | :heavy_check_mark:                                                                                     | N/A                                                                                                    |
