...
```typescript
import { SyncAcquireResponseCurrentReleaseExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseCurrentReleaseExtendAzureGrant = {};
```
