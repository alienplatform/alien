...
```typescript
import { CreateSetupRegistrationOperationRequestFailureDomains1 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestFailureDomains1 = {
  spread: 750494,
};
```
