...
```typescript
import { TargetDeploymentVariable } from "@alienplatform/platform-api/models";

let value: TargetDeploymentVariable = {
  name: "<value>",
  type: "plain",
  value: "<value>",
};
...
| `type`                                                                                                   | [models.TargetDeploymentEnvironmentVariablesType](../models/targetdeploymentenvironmentvariablestype.md) | :heavy_check_mark:                                                                                       | Type of environment variable                                                                             |
