...
```typescript
import { SyncReconcileRequestTargetReleaseOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestTargetReleaseOverrideAzureGrant = {};
```
