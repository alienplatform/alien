...
```typescript
import { SyncReconcileResponseRouteGateway2 } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseRouteGateway2 = {
...
| `provider`                                                           | *models.SyncReconcileResponseProviderUnion4*                         | :heavy_minus_sign:                                                   | N/A                                                                  |
