...
```typescript
import { DeploymentSetupStackSettingsPolicyNetworkByoVpcAws } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyNetworkByoVpcAws = {
  privateSubnetIds: [],
  publicSubnetIds: [
    "<value 1>",
  ],
...
| `type`                                                                                                                 | [models.DeploymentSetupStackSettingsPolicyTypeByoVpcAws](../models/deploymentsetupstacksettingspolicytypebyovpcaws.md) | :heavy_check_mark:                                                                                                     | N/A                                                                                                                    |
