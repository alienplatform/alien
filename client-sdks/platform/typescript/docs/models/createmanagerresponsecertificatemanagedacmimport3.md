...
```typescript
import { CreateManagerResponseCertificateManagedAcmImport3 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseCertificateManagedAcmImport3 = {
