...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackOverrideAzureGrant = {};
```
