...
```typescript
import { DeploymentDetailResponseRouteIngress2 } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponseRouteIngress2 = {
...
| `provider`                                                        | *models.DeploymentDetailResponseProviderUnion3*                   | :heavy_minus_sign:                                                | N/A                                                               |
