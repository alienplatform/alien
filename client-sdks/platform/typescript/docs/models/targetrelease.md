...
```typescript
import { TargetRelease } from "@alienplatform/platform-api/models";

let value: TargetRelease = {
  stack: {
    id: "<id>",
    resources: {},
  },
...
| `stack`                                                                                                                                             | [models.TargetReleaseStack](../models/targetreleasestack.md)                                                                                        | :heavy_check_mark:                                                                                                                                  | A bag of resources, unaware of any cloud.                                                                                                           |
