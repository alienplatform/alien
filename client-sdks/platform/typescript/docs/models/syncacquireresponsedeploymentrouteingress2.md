...
```typescript
import { SyncAcquireResponseDeploymentRouteIngress2 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentRouteIngress2 = {
...
| `provider`                                                        | *models.SyncAcquireResponseDeploymentProviderUnion3*              | :heavy_minus_sign:                                                | N/A                                                               |
