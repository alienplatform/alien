...
```typescript
import { PersistImportedDeploymentRequestPreparedStackDependency } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackDependency = {
  id: "<id>",
  type: "<value>",
};
```
