...
```typescript
import { PersistImportedDeploymentRequestOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestOverrideGcpGrant = {};
```
