...
```typescript
import { DeploymentDetailResponsePendingPreparedStackDependency } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackDependency = {
  id: "<id>",
  type: "<value>",
};
```
