...
```typescript
import { SyncReconcileRequestPreparedStackEnv } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.SyncReconcileRequestPreparedStackTypeUnion*                     | :heavy_minus_sign:                                                      | N/A                                                                     |