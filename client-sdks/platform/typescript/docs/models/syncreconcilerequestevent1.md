...
```typescript
import { SyncReconcileRequestEvent1 } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestEvent1 = {
  message: "<value>",
  reason: "<value>",
};
```
...
| `involvedObject`                                                                              | *models.InvolvedObjectUnion1*                                                                 | :heavy_minus_sign:                                                                            | N/A                                                                                           |
...
| `source`                                                                                      | *models.EventSourceUnion1*                                                                    | :heavy_minus_sign:                                                                            | N/A                                                                                           |
