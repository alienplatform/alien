...
```typescript
import { SyncAcquireResponseCurrentReleaseOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseCurrentReleaseOverrideAwGrant = {};
```
