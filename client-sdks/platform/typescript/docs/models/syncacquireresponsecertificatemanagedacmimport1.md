...
```typescript
import { SyncAcquireResponseCertificateManagedAcmImport1 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseCertificateManagedAcmImport1 = {
