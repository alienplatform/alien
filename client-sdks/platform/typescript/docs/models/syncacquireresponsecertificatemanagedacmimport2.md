...
```typescript
import { SyncAcquireResponseCertificateManagedAcmImport2 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseCertificateManagedAcmImport2 = {
