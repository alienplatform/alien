...
```typescript
import { SyncListResponseRouteIngress1 } from "@alienplatform/platform-api/models";

let value: SyncListResponseRouteIngress1 = {
...
| `provider`                                                        | *models.SyncListResponseProviderUnion1*                           | :heavy_minus_sign:                                                | N/A                                                               |
