...
```typescript
import { SyncReconcileRequestPreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPreparedStackExtendAzureGrant = {};
```
