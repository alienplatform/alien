...
```typescript
import { DeploymentDetailResponsePendingPreparedStackConfig } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackConfig = {
  id: "<id>",
  type: "<value>",
};
```
