...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseValidation } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseValidation = {};
```
