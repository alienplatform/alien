...
```typescript
import { DeploymentStatePendingPreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackExtendAzureGrant = {};
```
