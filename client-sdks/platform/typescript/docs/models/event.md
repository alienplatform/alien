...
```typescript
import { Event } from "@aliendotdev/platform-api/models";
...
| `deploymentId`                                                                                | *string*                                                                                      | :heavy_minus_sign:                                                                            | Unique identifier for the deployment.                                                         | ag_pnj2da55wi5sxbdcav9t273je                                                                  |
