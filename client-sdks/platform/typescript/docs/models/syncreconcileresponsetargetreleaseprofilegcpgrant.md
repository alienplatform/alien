...
```typescript
import { SyncReconcileResponseTargetReleaseProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseTargetReleaseProfileGcpGrant = {};
```
