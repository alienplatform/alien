...
```typescript
import { SyncReconcileResponseCurrentReleaseOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCurrentReleaseOverrideGcpGrant = {};
```
