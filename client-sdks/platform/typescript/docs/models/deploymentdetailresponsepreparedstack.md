...
| `inputs`                                                                                                                             | [models.DeploymentDetailResponseInput](../models/deploymentdetailresponseinput.md)[]                                                 | :heavy_minus_sign:                                                                                                                   | Input definitions required before setup or deployment can proceed.                                                                   |
...
| `supportedPlatforms`                                                                                                                 | [models.DeploymentDetailResponseSupportedPlatform](../models/deploymentdetailresponsesupportedplatform.md)[]                         | :heavy_minus_sign:                                                                                                                   | Which platforms this stack supports. When None, all platforms are supported.                                                         |