...
```typescript
import { SyncReconcileRequestCurrentReleaseStack } from "@alienplatform/platform-api/models";
...
| `inputs`                                                                                                                         | [models.SyncReconcileRequestCurrentReleaseInput](../models/syncreconcilerequestcurrentreleaseinput.md)[]                         | :heavy_minus_sign:                                                                                                               | Input definitions required before setup or deployment can proceed.                                                               |
...
| `supportedPlatforms`                                                                                                             | [models.SyncReconcileRequestCurrentReleaseSupportedPlatform](../models/syncreconcilerequestcurrentreleasesupportedplatform.md)[] | :heavy_minus_sign:                                                                                                               | Which platforms this stack supports. When None, all platforms are supported.                                                     |