...
```typescript
import { CloudFormationCallbackRequestRouteGateway1 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestRouteGateway1 = {
...
| `provider`                                                           | *models.CloudFormationCallbackRequestProviderUnion2*                 | :heavy_minus_sign:                                                   | N/A                                                                  |
