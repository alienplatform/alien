...
```typescript
import { PersistImportedDeploymentRequestPreparedStackProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackProfileAzureGrant = {};
```
