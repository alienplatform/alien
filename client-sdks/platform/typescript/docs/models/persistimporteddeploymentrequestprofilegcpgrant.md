...
```typescript
import { PersistImportedDeploymentRequestProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestProfileGcpGrant = {};
```
