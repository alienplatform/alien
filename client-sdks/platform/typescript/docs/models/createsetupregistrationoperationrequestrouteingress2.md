...
```typescript
import { CreateSetupRegistrationOperationRequestRouteIngress2 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestRouteIngress2 = {
...
| `provider`                                                        | *models.CreateSetupRegistrationOperationRequestProviderUnion3*    | :heavy_minus_sign:                                                | N/A                                                               |
