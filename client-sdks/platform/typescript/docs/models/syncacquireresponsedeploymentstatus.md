# SyncAcquireResponseDeploymentStatus
...
```typescript
import { SyncAcquireResponseDeploymentStatus } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentStatus = "error";
```
