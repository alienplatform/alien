...
```typescript
import { TargetDeploymentRouteIngress2 } from "@alienplatform/platform-api/models";

let value: TargetDeploymentRouteIngress2 = {
...
| `provider`                                                        | *models.TargetDeploymentProviderUnion3*                           | :heavy_minus_sign:                                                | N/A                                                               |
