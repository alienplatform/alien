...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackDependency } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackDependency = {
  id: "<id>",
  type: "<value>",
};
```
