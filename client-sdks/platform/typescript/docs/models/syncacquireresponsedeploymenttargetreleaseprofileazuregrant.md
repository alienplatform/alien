...
```typescript
import { SyncAcquireResponseDeploymentTargetReleaseProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentTargetReleaseProfileAzureGrant = {};
```
