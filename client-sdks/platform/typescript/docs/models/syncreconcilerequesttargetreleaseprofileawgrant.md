...
```typescript
import { SyncReconcileRequestTargetReleaseProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestTargetReleaseProfileAwGrant = {};
```
