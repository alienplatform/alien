...
```typescript
import { PersistImportedDeploymentRequestPreparedStackExtendAwResource } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackExtendAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
