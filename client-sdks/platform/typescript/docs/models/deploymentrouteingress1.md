...
```typescript
import { DeploymentRouteIngress1 } from "@alienplatform/platform-api/models";

let value: DeploymentRouteIngress1 = {
...
| `provider`                                                        | *models.DeploymentProviderUnion1*                                 | :heavy_minus_sign:                                                | N/A                                                               |
