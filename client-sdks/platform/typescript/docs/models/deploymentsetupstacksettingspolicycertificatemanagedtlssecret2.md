...
```typescript
import { DeploymentSetupStackSettingsPolicyCertificateManagedTLSSecret2 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyCertificateManagedTLSSecret2 = {
