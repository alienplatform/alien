...
```typescript
import { DeploymentDetailResponseCompute } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponseCompute = {};
```
...
| ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| `pools`                                                     | Record<string, *models.DeploymentDetailResponsePoolsUnion*> | :heavy_minus_sign:                                          | Selected compute choices keyed by pool ID.                  |