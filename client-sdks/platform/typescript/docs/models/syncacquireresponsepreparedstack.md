...
| `inputs`                                                                                                                     | [models.SyncAcquireResponsePreparedStackInput](../models/syncacquireresponsepreparedstackinput.md)[]                         | :heavy_minus_sign:                                                                                                           | Input definitions required before setup or deployment can proceed.                                                           |
...
| `supportedPlatforms`                                                                                                         | [models.SyncAcquireResponsePreparedStackSupportedPlatform](../models/syncacquireresponsepreparedstacksupportedplatform.md)[] | :heavy_minus_sign:                                                                                                           | Which platforms this stack supports. When None, all platforms are supported.                                                 |