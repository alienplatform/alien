...
```typescript
import { ManagerRetryResponseRouteGateway1 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteGateway1 = {
...
| `provider`                                                           | *models.ManagerRetryResponseProviderUnion2*                          | :heavy_minus_sign:                                                   | N/A                                                                  |
