...
```typescript
import { DataGcpAgentPlatform } from "@alienplatform/platform-api/models";
...
| `status`                                                                                | [models.SyncReconcileRequestStatus75](../models/syncreconcilerequeststatus75.md)        | :heavy_check_mark:                                                                      | N/A                                                                                     |
| `templateId`                                                                            | *string*                                                                                | :heavy_check_mark:                                                                      | The template sandboxes are currently cut from.                                          |
