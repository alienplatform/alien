...
```typescript
import { NewDeploymentRequestPoolsAutoscale } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestPoolsAutoscale = {
  max: 942657,
  min: 617035,
  mode: "autoscale",
};
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.NewDeploymentRequestFailureDomainsUnion2*   | :heavy_minus_sign:                                  | N/A                                                 |
