...
```typescript
import { CreateManagerResponseProviderAwsAlb6 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseProviderAwsAlb6 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                               | [models.CreateManagerResponseProviderAwsAlbEnum6](../models/createmanagerresponseproviderawsalbenum6.md) | :heavy_check_mark:                                                                                       | N/A                                                                                                      |
