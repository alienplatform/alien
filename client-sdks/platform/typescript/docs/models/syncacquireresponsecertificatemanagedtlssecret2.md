...
```typescript
import { SyncAcquireResponseCertificateManagedTLSSecret2 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseCertificateManagedTLSSecret2 = {
