...
```typescript
import { DeploymentDetailResponsePreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePreparedStackExtendAzureGrant = {};
```
