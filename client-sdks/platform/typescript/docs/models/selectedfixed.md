...
```typescript
import { SelectedFixed } from "@alienplatform/platform-api/models";

let value: SelectedFixed = {
  machines: 460135,
  mode: "fixed",
};
```
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.SelectedFailureDomainsUnion1*               | :heavy_minus_sign:                                  | N/A                                                 |
