...
```typescript
import { SyncReconcileRequestPendingPreparedStackProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackProfileGcpGrant = {};
```
