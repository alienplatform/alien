...
```typescript
import { SyncReconcileResponsePendingPreparedStackExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackExtendGcpGrant = {};
```
