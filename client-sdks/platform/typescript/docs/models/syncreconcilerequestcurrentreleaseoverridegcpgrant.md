...
```typescript
import { SyncReconcileRequestCurrentReleaseOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestCurrentReleaseOverrideGcpGrant = {};
```
