...
| `kubernetesPermissions`                                                                                                 | [models.OperationsCatalogKubernetesPermissions](../models/operationscatalogkubernetespermissions.md)                    | :heavy_minus_sign:                                                                                                      | Kubernetes RBAC required to execute this operation. Omitted by older servers and null when the operation declares none. |