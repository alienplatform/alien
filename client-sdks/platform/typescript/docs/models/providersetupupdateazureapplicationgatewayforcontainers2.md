...
```typescript
import { ProviderSetupUpdateAzureApplicationGatewayForContainers2 } from "@alienplatform/platform-api/models";

let value: ProviderSetupUpdateAzureApplicationGatewayForContainers2 = {
  frontend: "<value>",
...
| `provider`                                                                                                                                       | [models.SetupUpdateProviderAzureApplicationGatewayForContainersEnum2](../models/setupupdateproviderazureapplicationgatewayforcontainersenum2.md) | :heavy_check_mark:                                                                                                                               | N/A                                                                                                                                              |