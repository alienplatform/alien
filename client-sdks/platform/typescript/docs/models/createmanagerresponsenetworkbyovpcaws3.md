...
```typescript
import { CreateManagerResponseNetworkByoVpcAws3 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseNetworkByoVpcAws3 = {
  privateSubnetIds: [
    "<value 1>",
    "<value 2>",
  ],
...
| `type`                                                                                         | [models.CreateManagerResponseTypeByoVpcAws3](../models/createmanagerresponsetypebyovpcaws3.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
