...
```typescript
import { SyncReconcileRequestPendingPreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackExtendAzureGrant = {};
```
