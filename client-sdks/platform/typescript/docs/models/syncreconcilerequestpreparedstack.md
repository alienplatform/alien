...
```typescript
import { SyncReconcileRequestPreparedStack } from "@alienplatform/platform-api/models";
...
| `inputs`                                                                                                                       | [models.SyncReconcileRequestPreparedStackInput](../models/syncreconcilerequestpreparedstackinput.md)[]                         | :heavy_minus_sign:                                                                                                             | Input definitions required before setup or deployment can proceed.                                                             |
...
| `supportedPlatforms`                                                                                                           | [models.SyncReconcileRequestPreparedStackSupportedPlatform](../models/syncreconcilerequestpreparedstacksupportedplatform.md)[] | :heavy_minus_sign:                                                                                                             | Which platforms this stack supports. When None, all platforms are supported.                                                   |