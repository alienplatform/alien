...
```typescript
import { SyncAcquireResponsePreparedStackOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponsePreparedStackOverrideAzureGrant = {};
```
