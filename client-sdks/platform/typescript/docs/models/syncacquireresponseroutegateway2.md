...
```typescript
import { SyncAcquireResponseRouteGateway2 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseRouteGateway2 = {
...
| `provider`                                                           | *models.SyncAcquireResponseProviderUnion4*                           | :heavy_minus_sign:                                                   | N/A                                                                  |
