...
```typescript
import { SyncListResponsePendingPreparedStackOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackOverrideGcpGrant = {};
```
