...
```typescript
import { SyncReconcileResponseProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                               | [models.SyncReconcileResponseProviderAwsAlbEnum3](../models/syncreconcileresponseproviderawsalbenum3.md) | :heavy_check_mark:                                                                                       | N/A                                                                                                      |
