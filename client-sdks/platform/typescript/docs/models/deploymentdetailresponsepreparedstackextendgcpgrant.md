...
```typescript
import { DeploymentDetailResponsePreparedStackExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePreparedStackExtendGcpGrant = {};
```
