...
```typescript
import { SyncReconcileResponsePendingPreparedStackProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackProfileGcpGrant = {};
```
