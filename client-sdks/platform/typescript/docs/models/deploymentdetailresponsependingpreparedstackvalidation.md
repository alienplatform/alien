...
```typescript
import { DeploymentDetailResponsePendingPreparedStackValidation } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackValidation = {};
```
