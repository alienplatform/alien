...
```typescript
import { SyncReconcileRequestTargetReleaseOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestTargetReleaseOverrideAwGrant = {};
```
