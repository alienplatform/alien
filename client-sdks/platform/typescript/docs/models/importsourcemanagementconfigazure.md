...
```typescript
import { ImportSourceManagementConfigAzure } from "@alienplatform/platform-api/models";

let value: ImportSourceManagementConfigAzure = {
  managingTenantId: "<id>",
  oidcIssuer: "<value>",
  oidcSubject: "<value>",
  platform: "azure",
...
| `platform`                                                                 | [models.ImportSourcePlatformAzure](../models/importsourceplatformazure.md) | :heavy_check_mark:                                                         | N/A                                                                        |