...
```typescript
import { SyncReconcileRequestTargetReleaseExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestTargetReleaseExtendAzureGrant = {};
```
