...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseExtendGcpGrant = {};
```
