...
```typescript
import { SyncReconcileRequestCurrentReleaseOverrideAwResource } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestCurrentReleaseOverrideAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
