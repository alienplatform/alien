...
```typescript
import { SyncReconcileRequestPreparedStackOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPreparedStackOverrideAwGrant = {};
```
