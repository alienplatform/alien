...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackProfileAwGrant =
  {};
```
