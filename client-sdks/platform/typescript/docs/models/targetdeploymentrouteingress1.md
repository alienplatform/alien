...
```typescript
import { TargetDeploymentRouteIngress1 } from "@alienplatform/platform-api/models";

let value: TargetDeploymentRouteIngress1 = {
...
| `provider`                                                        | *models.TargetDeploymentProviderUnion1*                           | :heavy_minus_sign:                                                | N/A                                                               |
