...
```typescript
import { CloudFormationCallbackRequestProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                               | [models.CloudFormationCallbackRequestProviderAwsAlbEnum3](../models/cloudformationcallbackrequestproviderawsalbenum3.md) | :heavy_check_mark:                                                                                                       | N/A                                                                                                                      |
