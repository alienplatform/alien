...
```typescript
import { SyncReconcileResponsePendingPreparedStackOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackOverrideAwGrant = {};
```
