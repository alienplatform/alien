...
```typescript
import { SyncReconcileRequestCurrentReleaseExtendAwResource } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestCurrentReleaseExtendAwResource = {
  resources: [
    "<value 1>",
  ],
};
