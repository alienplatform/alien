...
```typescript
import { SyncReconcileRequestPendingPreparedStackProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackProfileAzureGrant = {};
```
