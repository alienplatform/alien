...
```typescript
import { SyncReconcileResponseRouteIngress1 } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseRouteIngress1 = {
...
| `provider`                                                        | *models.SyncReconcileResponseProviderUnion1*                      | :heavy_minus_sign:                                                | N/A                                                               |
