...
```typescript
import { SyncReconcileResponsePreparedStackExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePreparedStackExtendGcpGrant = {};
```
