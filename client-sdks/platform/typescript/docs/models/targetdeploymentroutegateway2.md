...
```typescript
import { TargetDeploymentRouteGateway2 } from "@alienplatform/platform-api/models";

let value: TargetDeploymentRouteGateway2 = {
...
| `provider`                                                           | *models.TargetDeploymentProviderUnion4*                              | :heavy_minus_sign:                                                   | N/A                                                                  |
