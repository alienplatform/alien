...
```typescript
import { SyncReconcileResponseCurrentReleaseOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCurrentReleaseOverrideAwGrant = {};
```
