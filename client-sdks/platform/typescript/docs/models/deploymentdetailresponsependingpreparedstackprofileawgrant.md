...
```typescript
import { DeploymentDetailResponsePendingPreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponsePendingPreparedStackProfileAwGrant = {};
```
