...
```typescript
import { SyncAcquireResponseProviderAwsAlb1 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseProviderAwsAlb1 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                           | [models.SyncAcquireResponseProviderAwsAlbEnum1](../models/syncacquireresponseproviderawsalbenum1.md) | :heavy_check_mark:                                                                                   | N/A                                                                                                  |
