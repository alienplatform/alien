...
```typescript
import { DeploymentInfoRouteIngress2 } from "@alienplatform/platform-api/models";

let value: DeploymentInfoRouteIngress2 = {
...
| `provider`                                                        | *models.SetupUpdateProviderUnion3*                                | :heavy_minus_sign:                                                | N/A                                                               |
