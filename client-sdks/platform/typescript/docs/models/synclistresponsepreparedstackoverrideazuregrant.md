...
```typescript
import { SyncListResponsePreparedStackOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncListResponsePreparedStackOverrideAzureGrant = {};
```
