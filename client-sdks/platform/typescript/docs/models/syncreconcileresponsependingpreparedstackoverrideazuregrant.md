...
```typescript
import { SyncReconcileResponsePendingPreparedStackOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackOverrideAzureGrant = {};
```
