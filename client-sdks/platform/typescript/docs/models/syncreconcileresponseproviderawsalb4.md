...
```typescript
import { SyncReconcileResponseProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                               | [models.SyncReconcileResponseProviderAwsAlbEnum4](../models/syncreconcileresponseproviderawsalbenum4.md) | :heavy_check_mark:                                                                                       | N/A                                                                                                      |
