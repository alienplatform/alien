# TargetReleaseOverrideStateAwResource
...
```typescript
import { TargetReleaseOverrideStateAwResource } from "@alienplatform/platform-api/models";

let value: TargetReleaseOverrideStateAwResource = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
