...
```typescript
import { SyncReconcileResponsePendingPreparedStackProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingPreparedStackProfileAwGrant = {};
```
