...
```typescript
import { PersistImportedDeploymentRequestOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestOverrideAzureGrant = {};
```
