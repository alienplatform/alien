# SyncReconcileResponsePendingDeleteResourceModeEnum
...
```typescript
import { SyncReconcileResponsePendingDeleteResourceModeEnum } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePendingDeleteResourceModeEnum = "all";
```
