...
```typescript
import { CloudFormationCallbackRequestProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: CloudFormationCallbackRequestProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                               | [models.CloudFormationCallbackRequestProviderAwsAlbEnum4](../models/cloudformationcallbackrequestproviderawsalbenum4.md) | :heavy_check_mark:                                                                                                       | N/A                                                                                                                      |
