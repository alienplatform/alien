...
```typescript
import { NewDeploymentRequestCertificateManagedAcmImport2 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestCertificateManagedAcmImport2 = {
