...
```typescript
import { SyncAcquireResponseDeploymentTargetReleaseOverrideGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentTargetReleaseOverrideGcpGrant = {};
```
