...
```typescript
import { SyncReconcileResponseCurrentReleaseProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCurrentReleaseProfileAwGrant = {};
```
