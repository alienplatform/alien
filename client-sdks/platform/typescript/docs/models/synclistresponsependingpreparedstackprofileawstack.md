...
```typescript
import { SyncListResponsePendingPreparedStackProfileAwStack } from "@alienplatform/platform-api/models";

let value: SyncListResponsePendingPreparedStackProfileAwStack = {
  resources: [],
};
```
