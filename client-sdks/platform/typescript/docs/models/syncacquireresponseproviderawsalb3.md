...
```typescript
import { SyncAcquireResponseProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                           | [models.SyncAcquireResponseProviderAwsAlbEnum3](../models/syncacquireresponseproviderawsalbenum3.md) | :heavy_check_mark:                                                                                   | N/A                                                                                                  |
