...
```typescript
import { ReleaseInfoStack } from "@alienplatform/platform-api/models";
...
| `inputs`                                                                           | [models.ReleaseInfoInput](../models/releaseinfoinput.md)[]                         | :heavy_minus_sign:                                                                 | Input definitions required before setup or deployment can proceed.                 |
...
| `supportedPlatforms`                                                               | [models.ReleaseInfoSupportedPlatform](../models/releaseinfosupportedplatform.md)[] | :heavy_minus_sign:                                                                 | Which platforms this stack supports. When None, all platforms are supported.       |