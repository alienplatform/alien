...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackExtendGcpGrant =
  {};
```
