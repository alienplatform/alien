...
| `setupMethods`                                                                                                   | [models.SyncAcquireResponsePreparedStackSetupMethod](../models/syncacquireresponsepreparedstacksetupmethod.md)[] | :heavy_minus_sign:                                                                                               | Setup methods where this input applies.                                                                          |
