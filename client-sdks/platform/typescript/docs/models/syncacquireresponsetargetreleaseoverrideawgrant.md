...
```typescript
import { SyncAcquireResponseTargetReleaseOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseTargetReleaseOverrideAwGrant = {};
```
