...
```typescript
import { ManagerRetryResponseCertificateManagedAcmImport5 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseCertificateManagedAcmImport5 = {
