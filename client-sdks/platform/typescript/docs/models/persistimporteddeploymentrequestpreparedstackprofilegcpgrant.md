...
```typescript
import { PersistImportedDeploymentRequestPreparedStackProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPreparedStackProfileGcpGrant = {};
```
