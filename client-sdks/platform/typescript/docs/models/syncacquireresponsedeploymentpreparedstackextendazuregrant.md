...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackExtendAzureGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackExtendAzureGrant = {};
```
