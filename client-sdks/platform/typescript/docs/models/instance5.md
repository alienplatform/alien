...
```typescript
import { Instance5 } from "@alienplatform/platform-api/models";
...
| ----------------------------- | ----------------------------- | ----------------------------- | ----------------------------- |
| `cpu`                         | *models.InstanceCpuUnion5*    | :heavy_minus_sign:            | N/A                           |
| `ip`                          | *string*                      | :heavy_minus_sign:            | N/A                           |
| `machineId`                   | *string*                      | :heavy_minus_sign:            | N/A                           |
| `memory`                      | *models.InstanceMemoryUnion5* | :heavy_minus_sign:            | N/A                           |
