...
```typescript
import { SyncListResponseEnv } from "@alienplatform/platform-api/models";

let value: SyncListResponseEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.SyncListResponseTypeUnion*                                      | :heavy_minus_sign:                                                      | N/A                                                                     |