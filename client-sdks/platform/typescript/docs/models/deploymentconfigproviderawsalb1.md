...
```typescript
import { DeploymentConfigProviderAwsAlb1 } from "@alienplatform/platform-api/models";

let value: DeploymentConfigProviderAwsAlb1 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                     | [models.DeploymentConfigProviderAwsAlbEnum1](../models/deploymentconfigproviderawsalbenum1.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
