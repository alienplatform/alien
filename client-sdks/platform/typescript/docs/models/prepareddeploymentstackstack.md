...
| `inputs`                                                                                                                                | [models.PreparedDeploymentStackInput](../models/prepareddeploymentstackinput.md)[]                                                      | :heavy_minus_sign:                                                                                                                      | Input definitions required before setup or deployment can proceed.                                                                      |
