...
```typescript
import { ImportSourceRouteIngress2 } from "@alienplatform/platform-api/models";

let value: ImportSourceRouteIngress2 = {
...
| `provider`                                                        | *models.ImportSourceProviderUnion3*                               | :heavy_minus_sign:                                                | N/A                                                               |
