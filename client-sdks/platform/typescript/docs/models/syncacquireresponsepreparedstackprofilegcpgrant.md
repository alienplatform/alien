...
```typescript
import { SyncAcquireResponsePreparedStackProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponsePreparedStackProfileGcpGrant = {};
```
