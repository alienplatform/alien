...
```typescript
import { SyncReconcileResponseSetupUpdateAuthorization } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseSetupUpdateAuthorization = {
  baselineFrozenDigest: "<value>",
  nonce: "<value>",
  releaseId: "<id>",
  setupFingerprint: "<value>",
  setupFingerprintVersion: 91270,
  setupTarget: "<value>",
