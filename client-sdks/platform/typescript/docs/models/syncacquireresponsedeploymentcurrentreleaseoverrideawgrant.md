...
```typescript
import { SyncAcquireResponseDeploymentCurrentReleaseOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentCurrentReleaseOverrideAwGrant = {};
```
