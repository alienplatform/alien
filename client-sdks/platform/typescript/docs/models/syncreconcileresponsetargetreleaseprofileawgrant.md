...
```typescript
import { SyncReconcileResponseTargetReleaseProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseTargetReleaseProfileAwGrant = {};
```
