...
```typescript
import { DeploymentConfigVariable } from "@alienplatform/platform-api/models";

let value: DeploymentConfigVariable = {
  name: "<value>",
  type: "secret",
  value: "<value>",
};
...
| `type`                                                                                                   | [models.DeploymentConfigEnvironmentVariablesType](../models/deploymentconfigenvironmentvariablestype.md) | :heavy_check_mark:                                                                                       | Type of environment variable                                                                             |
