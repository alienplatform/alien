...
| `agentImage`                                                                                                                 | [models.UpdateProjectAgentImage](../models/updateprojectagentimage.md)                                                       | :heavy_minus_sign:                                                                                                           | Operator image package configuration. Required when Helm is enabled. If null, Operator image packages will not be generated. |
