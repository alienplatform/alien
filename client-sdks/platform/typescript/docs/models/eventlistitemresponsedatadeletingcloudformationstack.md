...
```typescript
import { EventListItemResponseDataDeletingCloudFormationStack } from "@alienplatform/platform-api/models";

let value: EventListItemResponseDataDeletingCloudFormationStack = {
  cfnStackName: "<value>",
  currentStatus: "<value>",
