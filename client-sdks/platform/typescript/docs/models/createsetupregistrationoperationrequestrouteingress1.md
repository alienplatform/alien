...
```typescript
import { CreateSetupRegistrationOperationRequestRouteIngress1 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestRouteIngress1 = {
...
| `provider`                                                        | *models.CreateSetupRegistrationOperationRequestProviderUnion1*    | :heavy_minus_sign:                                                | N/A                                                               |
