...
```typescript
import { DeploymentStatePendingPreparedStackProfileGcpGrant } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackProfileGcpGrant = {};
```
