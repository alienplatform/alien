...
```typescript
import { PersistImportedDeploymentRequestPendingPreparedStackOverrideAwStack } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestPendingPreparedStackOverrideAwStack =
  {
    resources: [
      "<value 1>",
      "<value 2>",
