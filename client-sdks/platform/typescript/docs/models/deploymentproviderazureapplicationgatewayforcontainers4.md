...
```typescript
import { DeploymentProviderAzureApplicationGatewayForContainers4 } from "@alienplatform/platform-api/models";

let value: DeploymentProviderAzureApplicationGatewayForContainers4 = {
  frontend: "<value>",
...
| `provider`                                                                                                                                     | [models.DeploymentProviderAzureApplicationGatewayForContainersEnum4](../models/deploymentproviderazureapplicationgatewayforcontainersenum4.md) | :heavy_check_mark:                                                                                                                             | N/A                                                                                                                                            |