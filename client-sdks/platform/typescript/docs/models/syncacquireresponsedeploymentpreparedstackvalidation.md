...
```typescript
import { SyncAcquireResponseDeploymentPreparedStackValidation } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentPreparedStackValidation = {};
```
