...
```typescript
import { SyncReconcileRequestPendingPreparedStackProfileAwStack } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestPendingPreparedStackProfileAwStack = {
  resources: [
    "<value 1>",
    "<value 2>",
  ],
