...
```typescript
import { SyncReconcileResponseCompute } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponseCompute = {};
```
...
| -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- |
| `pools`                                                  | Record<string, *models.SyncReconcileResponsePoolsUnion*> | :heavy_minus_sign:                                       | Selected compute choices keyed by pool ID.               |