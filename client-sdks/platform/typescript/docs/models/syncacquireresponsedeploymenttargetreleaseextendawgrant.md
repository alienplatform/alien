...
```typescript
import { SyncAcquireResponseDeploymentTargetReleaseExtendAwGrant } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseDeploymentTargetReleaseExtendAwGrant = {};
```
