...
```typescript
import { SyncReconcileRequestCurrentReleaseProfileAwGrant } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestCurrentReleaseProfileAwGrant = {};
```
