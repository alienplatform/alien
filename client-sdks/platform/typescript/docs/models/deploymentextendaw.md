...
```typescript
import { DeploymentExtendAw } from "@alienplatform/platform-api/models";
...
| `effect`                                                                   | [models.DeploymentExtendEffect](../models/deploymentextendeffect.md)       | :heavy_minus_sign:                                                         | IAM effect. Defaults to Allow.                                             |
