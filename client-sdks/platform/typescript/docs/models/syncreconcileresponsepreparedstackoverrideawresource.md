...
```typescript
import { SyncReconcileResponsePreparedStackOverrideAwResource } from "@alienplatform/platform-api/models";

let value: SyncReconcileResponsePreparedStackOverrideAwResource = {
  resources: [],
};
```
