...
```typescript
import { SyncAcquireResponseProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: SyncAcquireResponseProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                           | [models.SyncAcquireResponseProviderAwsAlbEnum2](../models/syncacquireresponseproviderawsalbenum2.md) | :heavy_check_mark:                                                                                   | N/A                                                                                                  |
