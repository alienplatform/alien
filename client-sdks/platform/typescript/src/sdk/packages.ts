...
export class Packages extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(packagesList(this, request, options))
  }
  ...
  async get(
    ...
    return unwrapAsync(packagesGet(this, request, options))
  }
  ...
  async rebuild(
    ...
    return unwrapAsync(packagesRebuild(this, request, options))
  }
