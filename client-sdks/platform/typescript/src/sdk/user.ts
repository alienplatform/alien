 ...
 * @generated-id: c1714d4b0b0e
 */

import { userCompleteProfileSetup } from "../funcs/userCompleteProfileSetup.js";
...
export class User extends ClientSDK {
  ...
  async completeProfileSetup(
    request?: models.UserProfileSetupRequest | undefined,
    options?: RequestOptions,
  ): Promise<models.UserProfile> {
  ...
  async createWorkspace(
    ...
    return unwrapAsync(userCreateWorkspace(
      this,
      request,
      options,
    ));
  ...
  async listGitNamespaces(
    ...
    return unwrapAsync(userListGitNamespaces(
      this,
      request,
      options,
    ));
  ...
  async syncGitNamespaces(
    ...
    return unwrapAsync(userSyncGitNamespaces(
      this,
      request,
      options,
    ));
  ...
  async listGitNamespaceRepositories(
    ...
    return unwrapAsync(userListGitNamespaceRepositories(
      this,
      request,
      options,
    ));
