...
import { projectsGetAiUsage } from "../funcs/projectsGetAiUsage.js";
...
import { projectsPreviewModelsImpact } from "../funcs/projectsPreviewModelsImpact.js";
import { projectsSetCapabilities } from "../funcs/projectsSetCapabilities.js";
...
export class Projects extends ClientSDK {
   ...
   */
  async getAiProviderHeaders(
    request: operations.GetProjectAiProviderHeadersRequest,
    options?: RequestOptions,
  ): Promise<models.AIProviderHeaders> {
    return unwrapAsync(projectsGetAiProviderHeaders(
      this,
      request,
      options,
    ));
  ...
  async getCapabilityOverview(
    request: operations.GetProjectCapabilityOverviewRequest,
    options?: RequestOptions,
  ...
  async getAiUsage(
    request: operations.GetProjectAiUsageRequest,
    options?: RequestOptions,
  ...
  async getSandboxMetrics(
    request: operations.GetProjectSandboxMetricsRequest,
    options?: RequestOptions,
  ): Promise<operations.GetProjectSandboxMetricsResponse> {
    return unwrapAsync(projectsGetSandboxMetrics(
      this,
      request,
      options,
    ));
