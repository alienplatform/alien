...
/** @internal */
export const CreateAPIKeyResponseType$inboundSchema: z.ZodEnum<typeof CreateAPIKeyResponseType> =
...
export function keyInfoFromJSON(jsonString: string): SafeParseResult<KeyInfo, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const CreateAPIKeyResponse$inboundSchema: z.ZodType<CreateAPIKeyResponse, unknown> =
  z.object({
    apiKey: z.string(),
