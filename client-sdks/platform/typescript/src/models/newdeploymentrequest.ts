...
import {
  ...
  type EnvironmentVariableConfig$Outbound,
 ...
 * Target platform for the deployment
 */
export type NewDeploymentRequestPlatform = ClosedEnum<typeof NewDeploymentRequestPlatform>

export const NewDeploymentRequestPlatformTest = {
  Test: "test",
} as const
export type NewDeploymentRequestPlatformTest = ClosedEnum<typeof NewDeploymentRequestPlatformTest>
...
export type NewDeploymentRequestPlatformLocal = ClosedEnum<typeof NewDeploymentRequestPlatformLocal>
...
export type NewDeploymentRequestPlatformAzure = ClosedEnum<typeof NewDeploymentRequestPlatformAzure>
...
export type NewDeploymentRequestPlatformGcp = ClosedEnum<typeof NewDeploymentRequestPlatformGcp>
...
export type NewDeploymentRequestPlatformAws = ClosedEnum<typeof NewDeploymentRequestPlatformAws>
...
export type NewDeploymentRequestDomains = {
   ...
   */
  customDomains?: { [k: string]: NewDeploymentRequestCustomDomains } | null | undefined
}
 ...
 * How heartbeat health checks are handled.
 */
export type NewDeploymentRequestHeartbeats = ClosedEnum<typeof NewDeploymentRequestHeartbeats>
...
export type NewDeploymentRequestTypeByoVpcGcp = ClosedEnum<typeof NewDeploymentRequestTypeByoVpcGcp>
...
export type NewDeploymentRequestTypeByoVpcAws = ClosedEnum<typeof NewDeploymentRequestTypeByoVpcAws>
...
export type NewDeploymentRequestTypeCreate = ClosedEnum<typeof NewDeploymentRequestTypeCreate>
 ...
 * How telemetry (logs, metrics, traces) is handled.
 */
export type NewDeploymentRequestTelemetry = ClosedEnum<typeof NewDeploymentRequestTelemetry>
 ...
 * How updates are delivered to the agent.
 */
export type NewDeploymentRequestUpdates = ClosedEnum<typeof NewDeploymentRequestUpdates>
...
export function newDeploymentRequestEnvironmentInfoTestToJSON(
  newDeploymentRequestEnvironmentInfoTest: NewDeploymentRequestEnvironmentInfoTest,
): string {
...
export function newDeploymentRequestEnvironmentInfoAzureToJSON(
  newDeploymentRequestEnvironmentInfoAzure: NewDeploymentRequestEnvironmentInfoAzure,
): string {
  return JSON.stringify(
...
export function newDeploymentRequestEnvironmentInfoGcpToJSON(
  newDeploymentRequestEnvironmentInfoGcp: NewDeploymentRequestEnvironmentInfoGcp,
): string {
  return JSON.stringify(
...
export function newDeploymentRequestEnvironmentInfoAwsToJSON(
  newDeploymentRequestEnvironmentInfoAws: NewDeploymentRequestEnvironmentInfoAws,
): string {
  return JSON.stringify(
...
export function newDeploymentRequestEnvironmentInfoUnionToJSON(
  newDeploymentRequestEnvironmentInfoUnion: NewDeploymentRequestEnvironmentInfoUnion,
): string {
  return JSON.stringify(
...
export function newDeploymentRequestAwsToJSON(
  ...
  return JSON.stringify(NewDeploymentRequestAws$outboundSchema.parse(newDeploymentRequestAws))
}
...
export function newDeploymentRequestAzureToJSON(
  ...
  return JSON.stringify(NewDeploymentRequestAzure$outboundSchema.parse(newDeploymentRequestAzure))
}
...
export function newDeploymentRequestGcpToJSON(
  ...
  return JSON.stringify(NewDeploymentRequestGcp$outboundSchema.parse(newDeploymentRequestGcp))
}
...
export function newDeploymentRequestCertificateToJSON(
  ...
  return JSON.stringify(
    NewDeploymentRequestCertificate$outboundSchema.parse(newDeploymentRequestCertificate),
  )
}
...
export function newDeploymentRequestCustomDomainsToJSON(
  ...
  return JSON.stringify(
    NewDeploymentRequestCustomDomains$outboundSchema.parse(newDeploymentRequestCustomDomains),
  )
}

/** @internal */
export type NewDeploymentRequestDomains$Outbound = {
  customDomains?: { [k: string]: NewDeploymentRequestCustomDomains$Outbound } | null | undefined
}
...
export function newDeploymentRequestDomainsToJSON(
  ...
  return JSON.stringify(
    NewDeploymentRequestDomains$outboundSchema.parse(newDeploymentRequestDomains),
  )
}
...
export function newDeploymentRequestNetworkByoVnetAzureToJSON(
  newDeploymentRequestNetworkByoVnetAzure: NewDeploymentRequestNetworkByoVnetAzure,
): string {
  return JSON.stringify(
...
export function newDeploymentRequestNetworkByoVpcGcpToJSON(
  ...
  return JSON.stringify(
    NewDeploymentRequestNetworkByoVpcGcp$outboundSchema.parse(newDeploymentRequestNetworkByoVpcGcp),
  )
}
...
export function newDeploymentRequestNetworkByoVpcAwsToJSON(
  ...
  return JSON.stringify(
    NewDeploymentRequestNetworkByoVpcAws$outboundSchema.parse(newDeploymentRequestNetworkByoVpcAws),
  )
}
...
export function newDeploymentRequestNetworkCreateToJSON(
  ...
  return JSON.stringify(
    NewDeploymentRequestNetworkCreate$outboundSchema.parse(newDeploymentRequestNetworkCreate),
  )
}
...
> = z.object({
  deploymentModel: NewDeploymentRequestDeploymentModel$outboundSchema.optional(),
...
export function newDeploymentRequestStackSettingsToJSON(
  ...
  return JSON.stringify(
    NewDeploymentRequestStackSettings$outboundSchema.parse(newDeploymentRequestStackSettings),
  )
}
...
export type NewDeploymentRequest$Outbound = {
  ...
  managerId?: string | null | undefined
  pinnedReleaseId?: string | null | undefined
  environmentVariables?: Array<EnvironmentVariableConfig$Outbound> | null | undefined
  environmentInfo?:
    | NewDeploymentRequestEnvironmentInfoGcp$Outbound
    | NewDeploymentRequestEnvironmentInfoAzure$Outbound
    | NewDeploymentRequestEnvironmentInfoLocal$Outbound
...
> = z.object({
  ...
  environmentVariables: z.nullable(z.array(EnvironmentVariableConfig$outboundSchema)).optional(),
  environmentInfo: z
    .nullable(
      z.union([
        z.lazy(() => NewDeploymentRequestEnvironmentInfoGcp$outboundSchema),
    ...
    .optional(),
  project: z.string(),
  stackSettings: z.lazy(() => NewDeploymentRequestStackSettings$outboundSchema).optional(),
})

export function newDeploymentRequestToJSON(newDeploymentRequest: NewDeploymentRequest): string {
  return JSON.stringify(NewDeploymentRequest$outboundSchema.parse(newDeploymentRequest))
}
