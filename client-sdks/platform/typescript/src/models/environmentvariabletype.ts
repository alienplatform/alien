...
/** @internal */
export const EnvironmentVariableType$inboundSchema: z.ZodEnum<typeof EnvironmentVariableType> =
  z.enum(EnvironmentVariableType)
/** @internal */
export const EnvironmentVariableType$outboundSchema: z.ZodEnum<typeof EnvironmentVariableType> =
