...
/** @internal */
export const DomainStatus$inboundSchema: z.ZodEnum<typeof DomainStatus> = z.enum(DomainStatus)
...
export const Domain$inboundSchema: z.ZodType<Domain, unknown> = z.object({
  ...
  verifiedAt: z.nullable(z.iso.datetime({ offset: true }).transform(v => new Date(v))).optional(),
})
