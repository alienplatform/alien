...
/** @internal */
export const CommandState$inboundSchema: z.ZodEnum<typeof CommandState> = z.enum(CommandState)

/** @internal */
export const CommandDeploymentModel$inboundSchema: z.ZodEnum<typeof CommandDeploymentModel> =
...
export function commandFromJSON(jsonString: string): SafeParseResult<Command, SDKValidationError> {
  return safeParse(
    jsonString,
