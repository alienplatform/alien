...
export type Pool = {
   ...
   */
  selected: ComputePoolSelection;
  /**
   * User-selected deployment settings for one compute pool.
   */
  recommended: ComputePoolSelection;
...
export const Pool$inboundSchema: z.ZodType<Pool, unknown> = z.object({
  ...
  selected: ComputePoolSelection$inboundSchema,
  recommended: ComputePoolSelection$inboundSchema,
