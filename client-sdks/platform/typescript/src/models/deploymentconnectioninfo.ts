...
export type Arc = {
  /**
   * Manager URL for commands
   */
  url: string;
  /**
   * Deployment ID to use in command requests
   */
  deploymentId: string;
};
...
export function arcFromJSON(
  jsonString: string,
): SafeParseResult<Arc, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const DeploymentConnectionInfo$inboundSchema: z.ZodType<
