 ...
 */
export const SyncListResponseInitialSetupAuthority = {
 ...
 * Actor that owns structural work during the initial setup phase.
 */
export type SyncListResponseInitialSetupAuthority = ClosedEnum<
  typeof SyncListResponseInitialSetupAuthority
>;
...
export type SyncListResponseDeployment = {
  ...
  /**
   * Operations the Operator reports as currently loaded
   */
  observedOperations?: Array<ReportedOperation> | null | undefined;
  /**
...
/** @internal */
export const SyncListResponseInitialSetupAuthority$inboundSchema: z.ZodEnum<
  typeof SyncListResponseInitialSetupAuthority
> = z.enum(SyncListResponseInitialSetupAuthority);
...
> = z.object({
  ...
  capabilities: z.nullable(z.array(OperatorCapabilityReport$inboundSchema))
    .optional(),
  observedOperationsBundleHash: z.nullable(z.string()).optional(),
  observedOperations: z.nullable(z.array(ReportedOperation$inboundSchema))
    .optional(),
