...
export type OutputsTypeCloudformation = ClosedEnum<typeof OutputsTypeCloudformation>
...
export type OutputsTypeOperatorImage = ClosedEnum<typeof OutputsTypeOperatorImage>
...
export type Package = {
   ...
   * Type-specific configuration
   */
  config: ConfigCli | ConfigCloudformation | ConfigHelm | ConfigOperatorImage | ConfigTerraform
  /**
   * Package outputs (only when status is 'ready')
   */
  outputs?:
...
/** @internal */
export const PackageStatus$inboundSchema: z.ZodEnum<typeof PackageStatus> = z.enum(PackageStatus)

/** @internal */
export const ConfigTerraform$inboundSchema: z.ZodType<ConfigTerraform, unknown> = z.object({
...
/** @internal */
export const ConfigOperatorImage$inboundSchema: z.ZodType<ConfigOperatorImage, unknown> = z.object({
...
/** @internal */
export const ConfigHelm$inboundSchema: z.ZodType<ConfigHelm, unknown> = z.object({
  chartName: z.string(),
...
/** @internal */
export const ConfigCloudformation$inboundSchema: z.ZodType<ConfigCloudformation, unknown> =
  z.object({
...
export function configFromJSON(jsonString: string): SafeParseResult<Config, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const PackageGpgPublicKey$inboundSchema: z.ZodType<PackageGpgPublicKey, unknown> = z.object({
  asciiArmor: z.string(),
  keyId: z.string(),
})
...
/** @internal */
export const PackagePlatforms$inboundSchema: z.ZodType<PackagePlatforms, unknown> = z.object({
...
/** @internal */
export const OutputsTypeTerraform$inboundSchema: z.ZodEnum<typeof OutputsTypeTerraform> =
  z.enum(OutputsTypeTerraform)

/** @internal */
export const OutputsTerraform$inboundSchema: z.ZodType<OutputsTerraform, unknown> = z.object({
  gpgPublicKey: z.lazy(() => PackageGpgPublicKey$inboundSchema),
  platforms: z.record(
    z.string(),
    z.lazy(() => PackagePlatforms$inboundSchema),
  ),
...
/** @internal */
export const OutputsTypeCloudformation$inboundSchema: z.ZodEnum<typeof OutputsTypeCloudformation> =
  z.enum(OutputsTypeCloudformation)

/** @internal */
export const OutputsCloudformation$inboundSchema: z.ZodType<OutputsCloudformation, unknown> =
  z.object({
...
/** @internal */
export const OutputsHelm$inboundSchema: z.ZodType<OutputsHelm, unknown> = z.object({
  chart: z.string(),
  version: z.string(),
...
/** @internal */
export const OutputsTypeOperatorImage$inboundSchema: z.ZodEnum<typeof OutputsTypeOperatorImage> =
  z.enum(OutputsTypeOperatorImage)

/** @internal */
export const OutputsOperatorImage$inboundSchema: z.ZodType<OutputsOperatorImage, unknown> =
  z.object({
    digest: z.string(),
    image: z.string(),
...
/** @internal */
export const PackageBinaries$inboundSchema: z.ZodType<PackageBinaries, unknown> = z.object({
  sha256: z.string(),
  size: z.int(),
  url: z.string(),
})
...
/** @internal */
export const OutputsTypeCli$inboundSchema: z.ZodEnum<typeof OutputsTypeCli> = z.enum(OutputsTypeCli)

/** @internal */
export const OutputsCli$inboundSchema: z.ZodType<OutputsCli, unknown> = z.object({
  binaries: z.record(
    z.string(),
    z.lazy(() => PackageBinaries$inboundSchema),
  ),
...
/** @internal */
export const Outputs$inboundSchema: z.ZodType<Outputs, unknown> = z.union([
...
export function outputsFromJSON(jsonString: string): SafeParseResult<Outputs, SDKValidationError> {
  return safeParse(
    jsonString,
...
export const Package$inboundSchema: z.ZodType<Package, unknown> = z.object({
  ...
  retries: z.int(),
  lockedAt: z.nullable(z.iso.datetime({ offset: true }).transform(v => new Date(v))).optional(),
  ...
  completedAt: z.nullable(z.iso.datetime({ offset: true }).transform(v => new Date(v))).optional(),
})

export function packageFromJSON(jsonString: string): SafeParseResult<Package, SDKValidationError> {
  return safeParse(
    jsonString,
