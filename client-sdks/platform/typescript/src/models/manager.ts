...
import { type ManagerStatus, ManagerStatus$inboundSchema } from "./managerstatus.js"
...
export type ManagerPlatformKubernetes = ClosedEnum<typeof ManagerPlatformKubernetes>
...
/** @internal */
export const ManagerTarget$inboundSchema: z.ZodEnum<typeof ManagerTarget> = z.enum(ManagerTarget)

/** @internal */
export const ManagerPlatformKubernetes$inboundSchema: z.ZodEnum<typeof ManagerPlatformKubernetes> =
...
/** @internal */
export const ManagerPlatformAzure$inboundSchema: z.ZodEnum<typeof ManagerPlatformAzure> =
...
/** @internal */
export const ManagerPlatformGcp$inboundSchema: z.ZodEnum<typeof ManagerPlatformGcp> =
...
/** @internal */
export const ManagerPlatformAws$inboundSchema: z.ZodEnum<typeof ManagerPlatformAws> =
...
export function managerFromJSON(jsonString: string): SafeParseResult<Manager, SDKValidationError> {
  return safeParse(
    jsonString,
