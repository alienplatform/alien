...
export function createDomainRequestToJSON(createDomainRequest: CreateDomainRequest): string {
  return JSON.stringify(CreateDomainRequest$outboundSchema.parse(createDomainRequest))
}
