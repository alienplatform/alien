...
export const CreateProjectMethod = {
  Framework: "framework",
...
/** @internal */
export const CreateProjectMethod$inboundSchema: z.ZodEnum<
  typeof CreateProjectMethod
> = z.enum(CreateProjectMethod);
...
/** @internal */
export const CreateProjectAzure$inboundSchema: z.ZodType<
  CreateProjectAzure,
  unknown
> = z.object({
...
export function createProjectAzureFromJSON(
  jsonString: string,
): SafeParseResult<CreateProjectAzure, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateProjectAzure$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateProjectAzure' from JSON`,
  );
}
