...
/** @internal */
export const CreateProjectTypeRequest$outboundSchema: z.ZodEnum<typeof CreateProjectTypeRequest> =
...
export function createProjectGitRepositoryRequestToJSON(
  ...
  return JSON.stringify(
    CreateProjectGitRepositoryRequest$outboundSchema.parse(createProjectGitRepositoryRequest),
  )
}
...
export function createProjectCliRequestToJSON(
  ...
  return JSON.stringify(CreateProjectCliRequest$outboundSchema.parse(createProjectCliRequest))
}
...
export function createProjectCloudformationRequestToJSON(
  ...
  return JSON.stringify(
    CreateProjectCloudformationRequest$outboundSchema.parse(createProjectCloudformationRequest),
  )
}
...
export function createProjectOperatorImageRequestToJSON(
  ...
  return JSON.stringify(
    CreateProjectOperatorImageRequest$outboundSchema.parse(createProjectOperatorImageRequest),
  )
}
...
export function createProjectHelmRequestToJSON(
  ...
  return JSON.stringify(CreateProjectHelmRequest$outboundSchema.parse(createProjectHelmRequest))
}
...
export function createProjectTerraformRequestToJSON(
  ...
  return JSON.stringify(
    CreateProjectTerraformRequest$outboundSchema.parse(createProjectTerraformRequest),
  )
}
...
> = z.object({
  cli: z.nullable(z.lazy(() => CreateProjectCliRequest$outboundSchema)).optional(),
  cloudformation: z
    .nullable(z.lazy(() => CreateProjectCloudformationRequest$outboundSchema))
    .optional(),
  operatorImage: z
    .nullable(z.lazy(() => CreateProjectOperatorImageRequest$outboundSchema))
    .optional(),
  helm: z.nullable(z.lazy(() => CreateProjectHelmRequest$outboundSchema)).optional(),
  terraform: z.nullable(z.lazy(() => CreateProjectTerraformRequest$outboundSchema)).optional(),
})
...
export function createProjectPackagesConfigRequestToJSON(
  ...
  return JSON.stringify(
    CreateProjectPackagesConfigRequest$outboundSchema.parse(createProjectPackagesConfigRequest),
  )
}
...
> = z.object({
  name: z.string(),
  gitRepository: z
    .nullable(z.lazy(() => CreateProjectGitRepositoryRequest$outboundSchema))
    .optional(),
  rootDirectory: z.nullable(z.string()).optional(),
  packagesConfig: z
    .nullable(z.lazy(() => CreateProjectPackagesConfigRequest$outboundSchema))
    .optional(),
})
...
export function createProjectRequestToJSON(createProjectRequest: CreateProjectRequest): string {
...
export function createProjectGitRepositoryResponseFromJSON(
  ...
  return safeParse(
    jsonString,
    x => CreateProjectGitRepositoryResponse$inboundSchema.parse(JSON.parse(x)),
...
/** @internal */
export const CreateProjectMode$inboundSchema: z.ZodEnum<typeof CreateProjectMode> =
  z.enum(CreateProjectMode)

/** @internal */
export const CreateProjectColorScheme$inboundSchema: z.ZodEnum<typeof CreateProjectColorScheme> =
...
export function createProjectDeploymentPageBackgroundFromJSON(
  ...
  return safeParse(
    jsonString,
    x => CreateProjectDeploymentPageBackground$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateProjectDeploymentPageBackground' from JSON`,
  )
}

/** @internal */
export const CreateProjectCliResponse$inboundSchema: z.ZodType<CreateProjectCliResponse, unknown> =
  z.object({
    displayName: z.string(),
    name: z.string(),
    enabled: z.boolean(),
...
export function createProjectCloudformationResponseFromJSON(
  ...
  return safeParse(
    jsonString,
    x => CreateProjectCloudformationResponse$inboundSchema.parse(JSON.parse(x)),
...
export function createProjectOperatorImageResponseFromJSON(
  ...
  return safeParse(
    jsonString,
    x => CreateProjectOperatorImageResponse$inboundSchema.parse(JSON.parse(x)),
...
export const CreateProjectPackagesConfigResponse$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  cli: z.nullable(z.lazy(() => CreateProjectCliResponse$inboundSchema)).optional(),
  cloudformation: z
    .nullable(z.lazy(() => CreateProjectCloudformationResponse$inboundSchema))
    .optional(),
  operatorImage: z
    .nullable(z.lazy(() => CreateProjectOperatorImageResponse$inboundSchema))
    .optional(),
  helm: z.nullable(z.lazy(() => CreateProjectHelmResponse$inboundSchema)).optional(),
  terraform: z.nullable(z.lazy(() => CreateProjectTerraformResponse$inboundSchema)).optional(),
})
...
export function createProjectPackagesConfigResponseFromJSON(
  ...
  return safeParse(
    jsonString,
    x => CreateProjectPackagesConfigResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateProjectPackagesConfigResponse' from JSON`,
  )
}

/** @internal */
export const CreateProjectGithubSetup$inboundSchema: z.ZodType<CreateProjectGithubSetup, unknown> =
  z.object({
...
/** @internal */
export const CreateProjectResponse$inboundSchema: z.ZodType<CreateProjectResponse, unknown> =
  z.object({
    id: z.string(),
    name: z.string(),
    gitRepository: z
      .nullable(z.lazy(() => CreateProjectGitRepositoryResponse$inboundSchema))
      .optional(),
    rootDirectory: z.nullable(z.string()).optional(),
    deploymentPageBackground: z
      .nullable(z.lazy(() => CreateProjectDeploymentPageBackground$inboundSchema))
      .optional(),
    packagesConfig: z
      .nullable(z.lazy(() => CreateProjectPackagesConfigResponse$inboundSchema))
      .optional(),
