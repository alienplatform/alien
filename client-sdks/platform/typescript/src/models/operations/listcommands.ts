...
/** @internal */
export const ListCommandsInclude$outboundSchema: z.ZodEnum<typeof ListCommandsInclude> =
...
export function listCommandsRequestToJSON(listCommandsRequest: ListCommandsRequest): string {
  return JSON.stringify(ListCommandsRequest$outboundSchema.parse(listCommandsRequest))
}

/** @internal */
export const ListCommandsResponse$inboundSchema: z.ZodType<ListCommandsResponse, unknown> =
  z.object({
