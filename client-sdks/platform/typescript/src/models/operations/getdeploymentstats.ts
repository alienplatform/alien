 ...
 * Represents the target cloud platform.
 */
export type GetDeploymentStatsPlatform = ClosedEnum<typeof GetDeploymentStatsPlatform>
 ...
 * Deployment status in the deployment lifecycle
 */
export type GetDeploymentStatsStatus = ClosedEnum<typeof GetDeploymentStatsStatus>
...
/** @internal */
export const GetDeploymentStatsStatus$outboundSchema: z.ZodEnum<typeof GetDeploymentStatsStatus> =
...
export function getDeploymentStatsRequestToJSON(
  ...
  return JSON.stringify(GetDeploymentStatsRequest$outboundSchema.parse(getDeploymentStatsRequest))
}
