...
export const GetRawResourceHeartbeatArea = {
  Container: "container",
  Worker: "worker",
  Daemon: "daemon",
  Machine: "machine",
} as const;
export type GetRawResourceHeartbeatArea = ClosedEnum<
  typeof GetRawResourceHeartbeatArea
>;

export type GetRawResourceHeartbeatRequest = {
  area: GetRawResourceHeartbeatArea;
  deploymentId: string;
  resourceId: string;
  /**
 ...
 */
export type GetRawResourceHeartbeatResponse = Available | Missing;

/** @internal */
export const GetRawResourceHeartbeatArea$outboundSchema: z.ZodEnum<
  typeof GetRawResourceHeartbeatArea
> = z.enum(GetRawResourceHeartbeatArea);

/** @internal */
export type GetRawResourceHeartbeatRequest$Outbound = {
  area: string;
  deploymentId: string;
  resourceId: string;
  workspace?: string | undefined;
...
/** @internal */
export const GetRawResourceHeartbeatRequest$outboundSchema: z.ZodType<
  GetRawResourceHeartbeatRequest$Outbound,
  GetRawResourceHeartbeatRequest
> = z.object({
  area: GetRawResourceHeartbeatArea$outboundSchema,
...
export function getRawResourceHeartbeatRequestToJSON(
  getRawResourceHeartbeatRequest: GetRawResourceHeartbeatRequest,
): string {
  return JSON.stringify(
    GetRawResourceHeartbeatRequest$outboundSchema.parse(
      getRawResourceHeartbeatRequest,
    ),
  );
}
...
/** @internal */
export const Missing$inboundSchema: z.ZodType<Missing, unknown> = z.object({
...
/** @internal */
export const GetRawResourceHeartbeatResponse$inboundSchema: z.ZodType<
  GetRawResourceHeartbeatResponse,
  unknown
> = z.union([
  z.lazy(() => Available$inboundSchema),
  z.lazy(() => Missing$inboundSchema),
]);

export function getRawResourceHeartbeatResponseFromJSON(
  jsonString: string,
): SafeParseResult<GetRawResourceHeartbeatResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetRawResourceHeartbeatResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetRawResourceHeartbeatResponse' from JSON`,
  );
}
