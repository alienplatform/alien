...
/** @internal */
export const ListPackagesType$outboundSchema: z.ZodEnum<typeof ListPackagesType> =
  z.enum(ListPackagesType)

/** @internal */
export const ListPackagesStatus$outboundSchema: z.ZodEnum<typeof ListPackagesStatus> =
...
export function listPackagesRequestToJSON(listPackagesRequest: ListPackagesRequest): string {
  return JSON.stringify(ListPackagesRequest$outboundSchema.parse(listPackagesRequest))
}

/** @internal */
export const ListPackagesResponse$inboundSchema: z.ZodType<ListPackagesResponse, unknown> =
  z.object({
