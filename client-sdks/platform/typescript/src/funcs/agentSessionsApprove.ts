 ...
 */
export function agentSessionsApprove(
  client: AlienCore,
  request: operations.ApproveAgentSessionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.AgentSessionApproveResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ApproveAgentSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/agent-sessions/{id}/approve")(pathParams);
  ...
  const context = {
    ...
    operationID: "approveAgentSession",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json([200, 202], models.AgentSessionApproveResponse$inboundSchema),
