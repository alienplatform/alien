 ...
 */
export function deploymentsCreateSetupRegistrationOperation(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateSetupRegistrationOperationRequest$outboundSchema
  ...
  const body = encodeJSON(
    "body",
    payload?.CreateSetupRegistrationOperationRequest,
    { explode: true },
  );

  const path = pathToFunc("/v1/deployments/setup-registration-operations")();
  ...
  const context = {
    ...
    operationID: "createSetupRegistrationOperation",
    oAuth2Scopes: null,
