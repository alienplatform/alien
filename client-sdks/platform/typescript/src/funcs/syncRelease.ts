...
export function syncRelease(
  ...
  Result<
    operations.SyncReleaseResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.SyncReleaseRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SyncReleaseResponse$inboundSchema),
