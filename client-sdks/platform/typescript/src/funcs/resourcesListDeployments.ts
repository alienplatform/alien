...
export function resourcesListDeployments(
  ...
  Result<
    operations.ListResourceDeploymentsResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListResourceDeploymentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListResourceDeploymentsResponse$inboundSchema),
