 ...
 */
export function commandsCreate(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    value => operations.CreateCommandRequest$outboundSchema.optional().parse(value),
  ...
  const body = encodeJSON("body", payload?.CreateCommandRequest, {
    explode: true,
  })
