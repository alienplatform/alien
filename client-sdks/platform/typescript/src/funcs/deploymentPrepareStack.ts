 ...
 */
export function deploymentPrepareStack(
  client: AlienCore,
  request?: operations.PrepareDeploymentStackRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.PreparedDeploymentStack,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PrepareDeploymentStackRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/deployment-info/prepare-stack")();
  ...
  const context = {
    ...
    operationID: "prepareDeploymentStack",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PreparedDeploymentStack$inboundSchema),
