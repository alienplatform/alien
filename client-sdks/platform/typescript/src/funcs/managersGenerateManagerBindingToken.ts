...
> {
  ...
  const body = encodeJSON("body", payload.GenerateManagerBindingTokenRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/managers/{id}/binding-token")(pathParams);
  ...
  const context = {
    ...
    operationID: "generateManagerBindingToken",
    oAuth2Scopes: null,
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["403", "404", "4XX", "503", "5XX"],
