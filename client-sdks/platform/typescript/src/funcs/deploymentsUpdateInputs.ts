 ...
 */
export function deploymentsUpdateInputs(
  client: AlienCore,
  request: operations.UpdateDeploymentInputsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.UpdateDeploymentInputsResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateDeploymentInputsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateDeploymentInputsRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/deployments/{id}/inputs")(pathParams);
  ...
  const context = {
    ...
    operationID: "updateDeploymentInputs",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateDeploymentInputsResponse$inboundSchema),
