...
> {
  const parsed = safeParse(
    request,
    value => operations.CreateAPIKeyRequest$outboundSchema.optional().parse(value),
  ...
  const body = encodeJSON("body", payload?.CreateAPIKeyRequest, {
    explode: true,
  })

  const path = pathToFunc("/v1/api-keys")()
