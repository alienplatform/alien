 ...
 */
export function deploymentGroupsGetExternalAIModelCheck(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetExternalAIModelCheckRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getExternalAIModelCheck",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ExternalAIModelCheck$inboundSchema),
