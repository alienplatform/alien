...
export function packagesList(
  ...
  Result<
    operations.ListPackagesResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.ListPackagesRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/v1/packages")()
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPackagesResponse$inboundSchema),
