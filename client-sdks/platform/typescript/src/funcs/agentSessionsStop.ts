...
export function agentSessionsStop(
  ...
  Result<
    models.AgentSessionStopResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StopAgentSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/agent-sessions/{id}/stop")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json([200, 202], models.AgentSessionStopResponse$inboundSchema),
