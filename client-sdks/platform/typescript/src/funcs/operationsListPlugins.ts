 ...
 */
export function operationsListPlugins(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListOperationsPluginsRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "listOperationsPlugins",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListOperationsPluginsResponse$inboundSchema),
