...
export function deploymentsUpdateCompute(
  ...
  Result<
    operations.UpdateDeploymentComputeResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const body = encodeJSON("body", payload.UpdateDeploymentComputeRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/deployments/{id}/compute")(pathParams);
  ...
  const context = {
    ...
    operationID: "updateDeploymentCompute",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateDeploymentComputeResponse$inboundSchema),
