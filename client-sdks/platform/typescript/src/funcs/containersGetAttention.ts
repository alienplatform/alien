...
export function containersGetAttention(
  ...
  Result<
    operations.GetContainerAttentionResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.GetContainerAttentionRequest$outboundSchema.optional().parse(value),
  ...
  const context = {
    ...
    operationID: "getContainerAttention",
    oAuth2Scopes: null,
