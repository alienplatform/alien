...
export function deploymentsRetry(
  ...
  Result<
    operations.RetryDeploymentResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.RetryDeploymentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/deployments/{id}/retry")(pathParams)
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.RetryDeploymentResponse$inboundSchema),
