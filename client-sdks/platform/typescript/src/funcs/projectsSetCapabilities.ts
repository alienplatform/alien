 ...
 */
export function projectsSetCapabilities(
  client: AlienCore,
  request: operations.SetProjectCapabilitiesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ProjectCapabilities,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SetProjectCapabilitiesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/project-capabilities")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "setProjectCapabilities",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProjectCapabilities$inboundSchema),
