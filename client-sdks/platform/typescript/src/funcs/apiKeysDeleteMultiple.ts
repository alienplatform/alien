...
export function apiKeysDeleteMultiple(
  ...
  Result<
    operations.DeleteAPIKeysResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.DeleteAPIKeysRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteAPIKeysResponse$inboundSchema),
