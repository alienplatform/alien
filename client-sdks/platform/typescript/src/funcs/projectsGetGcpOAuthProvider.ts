 ...
 */
export function projectsGetGcpOAuthProvider(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetProjectGcpOAuthProviderRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getProjectGcpOAuthProvider",
    oAuth2Scopes: null,
