...
export function deploymentsPinRelease(
  ...
  Result<
    operations.PinDeploymentReleaseResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.PinDeploymentReleaseRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.PinReleaseRequest, { explode: true })
  ...
  const path = pathToFunc("/v1/deployments/{id}/pin-release")(pathParams)
  ...
  const context = {
    ...
    operationID: "pinDeploymentRelease",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.PinDeploymentReleaseResponse$inboundSchema),
