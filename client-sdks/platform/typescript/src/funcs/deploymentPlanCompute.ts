 ...
 */
export function deploymentPlanCompute(
  client: AlienCore,
  request?: operations.PlanDeploymentComputeRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.DeploymentComputePlan,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PlanDeploymentComputeRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/deployment-info/compute-plan")();
  ...
  const context = {
    ...
    operationID: "planDeploymentCompute",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeploymentComputePlan$inboundSchema),
