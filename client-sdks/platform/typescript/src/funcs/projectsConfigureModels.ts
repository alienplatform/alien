 ...
 */
export function projectsConfigureModels(
  client: AlienCore,
  request: operations.ConfigureProjectModelsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.CapabilityMaterialization,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConfigureProjectModelsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ConfigureModelsRequest, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "configureProjectModels",
    oAuth2Scopes: null,
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["403", "404", "409", "4XX", "500", "503", "5XX"],
