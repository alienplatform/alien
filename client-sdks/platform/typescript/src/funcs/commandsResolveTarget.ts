 ...
 */
export function commandsResolveTarget(
  client: AlienCore,
  request: operations.ResolveCommandTargetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ResolvedCommandTarget,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ResolveCommandTargetRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "resolveCommandTarget",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ResolvedCommandTarget$inboundSchema),
