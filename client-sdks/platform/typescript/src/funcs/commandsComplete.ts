...
export function commandsComplete(
  ...
  Result<
    models.CompleteCommandResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const body = encodeJSON("body", payload.CompleteCommandRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/commands/{id}/complete")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CompleteCommandResponse$inboundSchema),
