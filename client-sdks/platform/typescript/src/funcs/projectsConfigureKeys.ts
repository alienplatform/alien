 ...
 */
export function projectsConfigureKeys(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConfigureProjectKeysRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/project-capabilities/keys")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "configureProjectKeys",
    oAuth2Scopes: null,
