 ...
 */
export function deploymentsRedeploy(
  client: AlienCore,
  request: operations.RedeployDeploymentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RedeployDeploymentResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const path = pathToFunc("/v1/deployments/{id}/redeploy")(pathParams)
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.RedeployDeploymentResponse$inboundSchema),
