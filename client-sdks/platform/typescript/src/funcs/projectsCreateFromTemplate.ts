...
export function projectsCreateFromTemplate(
  ...
  Result<
    operations.CreateProjectFromTemplateResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.CreateProjectFromTemplateRequest$outboundSchema.optional().parse(value),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "409", "4XX", "500", "503", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateProjectFromTemplateResponse$inboundSchema),
    M.jsonErr([400, 409], errors.APIError$inboundSchema),
