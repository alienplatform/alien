...
export function managersResolveGcpOAuthProvider(
  ...
  Result<
    models.ResolveManagerGcpOAuthProviderResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.ResolveManagerGcpOAuthProviderRequest,
    { explode: true },
  );
  ...
  const path = pathToFunc("/v1/managers/{id}/gcp-oauth-provider/resolve")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "resolveManagerGcpOAuthProvider",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ResolveManagerGcpOAuthProviderResponse$inboundSchema),
