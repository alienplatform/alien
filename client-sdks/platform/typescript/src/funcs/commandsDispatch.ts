 ...
 */
export function commandsDispatch(
  client: AlienCore,
  request: operations.DispatchCommandRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.DispatchCommandResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DispatchCommandRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.DispatchCommandRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/commands/{id}/dispatch")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DispatchCommandResponse$inboundSchema),
