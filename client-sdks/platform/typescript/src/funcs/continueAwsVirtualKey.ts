...
> {
  ...
  const path = pathToFunc("/v1/aws-virtual-keys/{id}/continue")(pathParams);
  ...
  const context = {
    ...
    operationID: "continueAwsVirtualKey",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ContinueAwsVirtualKeyResponse$inboundSchema),
