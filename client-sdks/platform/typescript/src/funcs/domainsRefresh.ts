 ...
 */
export function domainsRefresh(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RefreshDomainRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/domains/{id}/refresh")(pathParams);
