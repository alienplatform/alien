...
> {
  const parsed = safeParse(
    request,
    value => operations.ImportDeploymentRequest$outboundSchema.optional().parse(value),
  ...
  const body = encodeJSON("body", payload?.ImportDeploymentRequest, {
    explode: true,
  })

  const path = pathToFunc("/v1/deployments/import")()
