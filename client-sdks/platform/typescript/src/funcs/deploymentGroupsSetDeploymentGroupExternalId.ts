...
> {
  ...
  const body = encodeJSON("body", payload.SetDeploymentGroupExternalIdRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/deployment-groups/{id}/external-id")(pathParams);
  ...
  const context = {
    ...
    operationID: "setDeploymentGroupExternalId",
    oAuth2Scopes: null,
