 ...
 */
export function managersRetry(
  client: AlienCore,
  request: operations.RetryManagerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ManagerRetryResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RetryManagerRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/managers/{id}/retry")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ManagerRetryResponse$inboundSchema),
