...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWorkspaceInviteLinkRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WorkspaceInviteLink$inboundSchema),
