 ...
 */
export function operationsQueueAccessRequest(
  client: AlienCore,
  request: operations.QueueAccessRequestRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.QueueAccessRequestResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.QueueAccessRequestRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "queueAccessRequest",
    oAuth2Scopes: null,
