 ...
 */
export function projectsConfigureCustomerStorage(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConfigureProjectCustomerStorageRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc(
    "/v1/projects/{idOrName}/customer-connections/storage",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "configureProjectCustomerStorage",
    oAuth2Scopes: null,
