...
export function slackIntegrationSetNotificationChannel(
  ...
  Result<
    models.SlackNotificationChannelResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const context = {
    ...
    operationID: "slackIntegrationSetNotificationChannel",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SlackNotificationChannelResponse$inboundSchema),
