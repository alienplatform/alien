...
export function projectsPreviewModelsImpact(
  ...
  Result<
    operations.PreviewProjectModelsImpactResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const context = {
    ...
    operationID: "previewProjectModelsImpact",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PreviewProjectModelsImpactResponse$inboundSchema),
