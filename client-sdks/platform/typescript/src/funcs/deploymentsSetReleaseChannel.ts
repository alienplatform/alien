...
> {
  ...
  const path = pathToFunc("/v1/deployments/{id}/release-channel")(pathParams);
  ...
  const context = {
    ...
    operationID: "setDeploymentReleaseChannel",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Deployment$inboundSchema),
