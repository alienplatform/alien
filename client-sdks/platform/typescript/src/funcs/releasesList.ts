...
export function releasesList(
  ...
  Result<
    operations.ListReleasesResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.ListReleasesRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListReleasesResponse$inboundSchema),
