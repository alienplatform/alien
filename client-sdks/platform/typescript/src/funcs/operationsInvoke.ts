...
export function operationsInvoke(
  ...
  Result<
    models.InvokeOperationResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const body = encodeJSON("body", payload.InvokeOperationRequest, {
    explode: true,
  });

  const path = pathToFunc("/v1/operations/invoke")();
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["402", "403", "404", "4XX", "500", "5XX"],
  ...
  >(
    ...
    M.jsonErr([402, 403, 404], errors.APIError$inboundSchema),
