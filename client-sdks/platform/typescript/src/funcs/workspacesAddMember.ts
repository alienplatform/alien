 ...
 */
export function workspacesAddMember(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    value => operations.AddWorkspaceMemberRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/workspaces/{id}/members")(pathParams)
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.WorkspaceMember$inboundSchema),
