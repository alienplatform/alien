...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateDeploymentEnvironmentVariablesRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.UpdateDeploymentEnvironmentVariablesRequest,
    { explode: true },
  );
  ...
  const path = pathToFunc("/v1/deployments/{id}/environment-variables")(
    pathParams,
  );
