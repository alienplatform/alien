...
export function projectsConfigureSource(
  ...
  Result<
    operations.ConfigureProjectSourceResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const context = {
    ...
    operationID: "configureProjectSource",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConfigureProjectSourceResponse$inboundSchema),
