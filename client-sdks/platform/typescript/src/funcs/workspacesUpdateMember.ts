 ...
 */
export function workspacesUpdateMember(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    value => operations.UpdateWorkspaceMemberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WorkspaceMember$inboundSchema),
