...
export function containersGetMachines(
  ...
  Result<
    operations.GetContainerMachinesResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.GetContainerMachinesRequest$outboundSchema.optional().parse(value),
  ...
  const context = {
    ...
    operationID: "getContainerMachines",
    oAuth2Scopes: null,
