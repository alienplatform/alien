 ...
 */
export function managersGenerateManagerCommandToken(
  client: AlienCore,
  request: operations.GenerateManagerCommandTokenRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GenerateManagerTokenResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GenerateManagerCommandTokenRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.GenerateManagerCommandTokenRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/managers/{id}/command-token")(pathParams);
  ...
  const context = {
    ...
    operationID: "generateManagerCommandToken",
    oAuth2Scopes: null,
