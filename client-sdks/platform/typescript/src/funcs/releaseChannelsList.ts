...
export function releaseChannelsList(
  ...
  Result<
    operations.ListReleaseChannelsResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListReleaseChannelsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/release-channels")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListReleaseChannelsResponse$inboundSchema),
