 ...
 */
export function deploymentsRejoin(
  client: AlienCore,
  request?: operations.RejoinDeploymentRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.RejoinDeploymentResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RejoinDeploymentRequest$outboundSchema.optional().parse(value),
  ...
  const body = encodeJSON("body", payload?.RejoinDeploymentRequest, {
    explode: true,
  });

  const path = pathToFunc("/v1/deployments/rejoin")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RejoinDeploymentResponse$inboundSchema),
