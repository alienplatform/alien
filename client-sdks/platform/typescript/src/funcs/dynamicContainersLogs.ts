 ...
 */
export function dynamicContainersLogs(
  client: AlienCore,
  request: operations.GetDynamicContainerLogsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetDynamicContainerLogsResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDynamicContainerLogsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/v1/deployments/{id}/dynamic-containers/{name}/logs",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "getDynamicContainerLogs",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDynamicContainerLogsResponse$inboundSchema),
