 ...
 */
export function dynamicContainersGet(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDynamicContainerRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getDynamicContainer",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DynamicContainerResponse$inboundSchema),
