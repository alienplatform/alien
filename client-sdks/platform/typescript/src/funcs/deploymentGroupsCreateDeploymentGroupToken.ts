...
> {
  const parsed = safeParse(
    request,
    value => operations.CreateDeploymentGroupTokenRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateDeploymentGroupTokenRequest, {
    explode: true,
  })
  ...
  const context = {
    ...
    operationID: "createDeploymentGroupToken",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateDeploymentGroupTokenResponse$inboundSchema),
