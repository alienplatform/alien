 ...
 */
export function deploymentGroupsCreateExternalAIModelCheck(
  client: AlienCore,
  request: operations.CreateExternalAIModelCheckRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ExternalAIModelCheck,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateExternalAIModelCheckRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    publicModelId: encodeSimple("publicModelId", payload.publicModelId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const context = {
    ...
    operationID: "createExternalAIModelCheck",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, models.ExternalAIModelCheck$inboundSchema),
