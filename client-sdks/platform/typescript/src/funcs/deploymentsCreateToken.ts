...
export function deploymentsCreateToken(
  ...
  Result<
    models.CreateDeploymentTokenResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    value => operations.CreateDeploymentTokenRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateDeploymentTokenRequest, {
    explode: true,
  })
  ...
  const path = pathToFunc("/v1/deployments/{id}/token")(pathParams)
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateDeploymentTokenResponse$inboundSchema),
