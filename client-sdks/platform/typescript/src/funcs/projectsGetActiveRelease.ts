...
> {
  const parsed = safeParse(
    request,
    value => operations.GetProjectActiveReleaseRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/active-release")(pathParams)
  ...
  const context = {
    ...
    operationID: "getProjectActiveRelease",
    oAuth2Scopes: null,
