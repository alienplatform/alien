...
export function remoteBindingsCreateExternalAccess(
  ...
  Result<
    models.RemoteBindingsExternalAccessResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const body = encodeJSON("body", payload.RemoteBindingsExternalAccessRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/remote-bindings/access")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "createRemoteBindingsExternalAccess",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RemoteBindingsExternalAccessResponse$inboundSchema),
    M.jsonErr([401, 403, 404, 409], errors.APIError$inboundSchema),
