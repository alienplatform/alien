 ...
 */
export function agentManagersUpdate(
  client: AlienCore,
  request: operations.UpdateManagerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateManagerResponse,
    | errors.APIError
    | AlienError
...
> {
  ...
  const body = encodeJSON("body", payload.UpdateManagerRequest, {
    explode: true,
  })
  ...
  const path = pathToFunc("/v1/managers/{id}/update")(pathParams)
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.UpdateManagerResponse$inboundSchema),
