 ...
 */
export function operatorManifestsRenderOperatorEcsCloudFormation(
  client: AlienCore,
  request?: models.RenderOperatorEcsCloudFormationRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.RenderOperatorEcsCloudFormationResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.RenderOperatorEcsCloudFormationRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/v1/operator-manifests/ecs-cloudformation/render")();
  ...
  const context = {
    ...
    operationID: "renderOperatorEcsCloudFormation",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RenderOperatorEcsCloudFormationResponse$inboundSchema),
