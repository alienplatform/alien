 ...
 */
export function workspacesDismissOnboarding(
  client: AlienCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DismissWorkspaceOnboardingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/workspaces/{id}/dismiss-onboarding")(pathParams);
  ...
  const context = {
    ...
    operationID: "dismissWorkspaceOnboarding",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Workspace$inboundSchema),
