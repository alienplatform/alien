...
> {
  const parsed = safeParse(
    request,
    value => operations.CreateDeploymentRequest$outboundSchema.optional().parse(value),
  ...
  const body = encodeJSON("body", payload?.NewDeploymentRequest, {
    explode: true,
  })

  const path = pathToFunc("/v1/deployments")()
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateDeploymentResponse$inboundSchema),
