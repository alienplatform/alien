 ...
 */
export function projectsGetDeploymentLinkSetup(
  client: AlienCore,
  request: operations.GetProjectDeploymentLinkSetupRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.DeploymentLinkSetupResponse,
    | errors.APIError
    | AlienError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetProjectDeploymentLinkSetupRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/deployment-link-setup")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "getProjectDeploymentLinkSetup",
    oAuth2Scopes: null,
