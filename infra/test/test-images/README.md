...
Minimal container images used by **cloud unit tests** (`alien-gcp-clients`, `alien-azure-clients`, etc.) to verify that infra controllers can deploy, invoke, and tear down cloud resources.
