...
Minimal container images used by **cloud unit tests** to verify that infra controllers can deploy, invoke, and tear down cloud resources through the official cloud SDK integrations.
