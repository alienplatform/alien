  ...
  return (
    <HoverCard openDelay={100} closeDelay={200}>
      <HoverCardTrigger asChild>
        <button type="button" className="relative overflow-hidden cursor-pointer rounded-md bg-white dark:bg-background/60 backdrop-blur-sm border shadow-sm hover:shadow-md transition-shadow">
          <ShineBorder
            borderWidth={1.5}
          ...
          <div className="rounded-md bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:from-green-500/10 dark:via-blue-500/10 dark:to-purple-500/10 p-4 border border-green-200 dark:border-green-500/20">
                 <div className="flex items-center justify-between mb-3">
                   <div className="flex items-center gap-2">
                     ...
                     <h4 className="font-semibold text-gray-900 dark:text-foreground">Private & Secure Data</h4>
                   </div>
                 </div>
                 ...
                 <div className="bg-white/80 dark:bg-background/40 px-3 py-2.5 rounded-md border border-gray-200 dark:border-border/50 shadow-sm">
                   <div className="flex items-center gap-2 mb-1">
                     ...
                     <p className="text-xs font-semibold text-gray-900 dark:text-foreground">Direct connection to:</p>
                   </div>
                   <p className="text-xs text-gray-600 dark:text-muted-foreground font-mono truncate">{agentEnvironment}</p>
                 </div>
