...
AWS_KEYS=(
  ...
  ALIEN_TEST_K8S_NAMESPACE_PREFIX
  ALIEN_TEST_K8S_INGRESS_CLASS
  ALIEN_TEST_K8S_INGRESS_ANNOTATIONS
  ALIEN_TEST_K8S_PUBLIC_HOST_SUFFIX
  ALIEN_TEST_K8S_TLS_SECRET_NAME
  ALIEN_TEST_EKS_CLUSTER_NAME
  ALIEN_TEST_EKS_KUBE_CONTEXT
  ALIEN_TEST_EKS_INGRESS_CLASS
  ALIEN_TEST_EKS_INGRESS_ANNOTATIONS
  ALIEN_TEST_EKS_PUBLIC_HOST_SUFFIX
)
...
GCP_KEYS=(
  ...
  ALIEN_TEST_K8S_PUBLIC_HOST_SUFFIX
  ALIEN_TEST_K8S_TLS_SECRET_NAME
  ALIEN_TEST_GKE_KUBECONFIG
  ALIEN_TEST_GKE_INGRESS_CLASS
  ALIEN_TEST_GKE_INGRESS_ANNOTATIONS
  ALIEN_TEST_GKE_PUBLIC_HOST_SUFFIX
  ALIEN_TEST_GKE_TLS_SECRET_NAME
  ALIEN_TEST_GKE_CLUSTER_NAME
  ALIEN_TEST_GKE_CLUSTER_LOCATION
  ALIEN_TEST_GKE_KUBE_CONTEXT
)
...
AZURE_KEYS=(
  ...
  ALIEN_TEST_K8S_PUBLIC_HOST_SUFFIX
  ALIEN_TEST_K8S_TLS_SECRET_NAME
  ALIEN_TEST_AKS_CLUSTER_NAME
  ALIEN_TEST_AKS_CLUSTER_RESOURCE_GROUP
  ALIEN_TEST_AKS_KUBE_CONTEXT
  ALIEN_TEST_AKS_INGRESS_CLASS
  ALIEN_TEST_AKS_INGRESS_ANNOTATIONS
  ALIEN_TEST_AKS_PUBLIC_HOST_SUFFIX
)
