...
OPENAI_TEST_API_KEY='${OPENAI_TEST_API_KEY:?OPENAI_TEST_API_KEY environment variable must be set}'
ANTHROPIC_TEST_API_KEY='${ANTHROPIC_TEST_API_KEY:?ANTHROPIC_TEST_API_KEY environment variable must be set}'
DATABRICKS_TEST_WORKSPACE_URL='${DATABRICKS_TEST_WORKSPACE_URL:?DATABRICKS_TEST_WORKSPACE_URL environment variable must be set}'
DATABRICKS_TEST_CLIENT_ID='${DATABRICKS_TEST_CLIENT_ID:?DATABRICKS_TEST_CLIENT_ID environment variable must be set}'
DATABRICKS_TEST_CLIENT_SECRET='${DATABRICKS_TEST_CLIENT_SECRET:?DATABRICKS_TEST_CLIENT_SECRET environment variable must be set}'
EOF
