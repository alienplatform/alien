...
This document outlines our Rust coding standards, preferred libraries, error handling patterns, and testing practices.
...
This is critical: **when a required condition cannot be met, return an error immediately**.
