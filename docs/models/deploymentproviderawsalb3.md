...
```typescript
import { DeploymentProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: DeploymentProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                         | [models.DeploymentProviderAwsAlbEnum3](../models/deploymentproviderawsalbenum3.md) | :heavy_check_mark:                                                                 | N/A                                                                                |
