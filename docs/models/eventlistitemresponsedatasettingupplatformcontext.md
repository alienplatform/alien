...
```typescript
import { EventListItemResponseDataSettingUpPlatformContext } from "@alienplatform/platform-api/models";

let value: EventListItemResponseDataSettingUpPlatformContext = {
  platformName: "<value>",
