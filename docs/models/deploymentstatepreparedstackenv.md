...
```typescript
import { DeploymentStatePreparedStackEnv } from "@alienplatform/platform-api/models";

let value: DeploymentStatePreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.DeploymentStatePreparedStackTypeUnion*                          | :heavy_minus_sign:                                                      | N/A                                                                     |