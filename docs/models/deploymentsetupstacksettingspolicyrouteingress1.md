...
```typescript
import { DeploymentSetupStackSettingsPolicyRouteIngress1 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyRouteIngress1 = {
...
| `provider`                                                        | *models.DeploymentSetupStackSettingsPolicyProviderUnion1*         | :heavy_minus_sign:                                                | N/A                                                               |
