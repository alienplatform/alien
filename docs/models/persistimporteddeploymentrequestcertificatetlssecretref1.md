...
```typescript
import { PersistImportedDeploymentRequestCertificateTLSSecretRef1 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestCertificateTLSSecretRef1 = {
  secretName: "<value>",
  mode: "tlsSecretRef",
};
```
