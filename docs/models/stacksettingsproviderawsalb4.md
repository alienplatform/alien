...
```typescript
import { StackSettingsProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: StackSettingsProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                               | [models.StackSettingsProviderAwsAlbEnum4](../models/stacksettingsproviderawsalbenum4.md) | :heavy_check_mark:                                                                       | N/A                                                                                      |
