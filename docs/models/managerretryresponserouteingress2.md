...
```typescript
import { ManagerRetryResponseRouteIngress2 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteIngress2 = {
...
| `provider`                                                        | *models.ManagerRetryResponseProviderUnion3*                       | :heavy_minus_sign:                                                | N/A                                                               |
