...
```typescript
import { NewDeploymentRequestCertificateManagedAcmImport1 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestCertificateManagedAcmImport1 = {
