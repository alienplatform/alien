...
```typescript
import { DeploymentConfigProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: DeploymentConfigProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                     | [models.DeploymentConfigProviderAwsAlbEnum4](../models/deploymentconfigproviderawsalbenum4.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
