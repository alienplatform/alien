...
```typescript
import { CreateSetupRegistrationOperationRequestCertificateManagedAcmImport1 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestCertificateManagedAcmImport1 =
  {
