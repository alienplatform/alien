...
```typescript
import { ProviderSetupUpdateAzureApplicationGatewayForContainers3 } from "@alienplatform/platform-api/models";

let value: ProviderSetupUpdateAzureApplicationGatewayForContainers3 = {
  frontend: "<value>",
...
| `provider`                                                                                                                                       | [models.SetupUpdateProviderAzureApplicationGatewayForContainersEnum3](../models/setupupdateproviderazureapplicationgatewayforcontainersenum3.md) | :heavy_check_mark:                                                                                                                               | N/A                                                                                                                                              |