...
```typescript
import { DeploymentStatePendingPreparedStackEnv } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.DeploymentStatePendingPreparedStackTypeUnion*                   | :heavy_minus_sign:                                                      | N/A                                                                     |