...
```typescript
import { DeploymentStatePendingPreparedStackOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackOverrideAzureGrant = {};
```
