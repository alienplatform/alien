...
```typescript
import { ManagerRetryResponseCertificateManagedAcmImport6 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseCertificateManagedAcmImport6 = {
