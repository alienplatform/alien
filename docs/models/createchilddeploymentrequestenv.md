...
```typescript
import { CreateChildDeploymentRequestEnv } from "@alienplatform/platform-api/models";

let value: CreateChildDeploymentRequestEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.CreateChildDeploymentRequestTypeUnion*                          | :heavy_minus_sign:                                                      | N/A                                                                     |