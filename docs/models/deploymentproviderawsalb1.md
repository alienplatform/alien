...
```typescript
import { DeploymentProviderAwsAlb1 } from "@alienplatform/platform-api/models";

let value: DeploymentProviderAwsAlb1 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                         | [models.DeploymentProviderAwsAlbEnum1](../models/deploymentproviderawsalbenum1.md) | :heavy_check_mark:                                                                 | N/A                                                                                |
