...
```typescript
import { CreateManagerResponseProviderAwsAlb9 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseProviderAwsAlb9 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                               | [models.CreateManagerResponseProviderAwsAlbEnum9](../models/createmanagerresponseproviderawsalbenum9.md) | :heavy_check_mark:                                                                                       | N/A                                                                                                      |
