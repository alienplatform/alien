...
```typescript
import { CreateManagerResponseProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                               | [models.CreateManagerResponseProviderAwsAlbEnum2](../models/createmanagerresponseproviderawsalbenum2.md) | :heavy_check_mark:                                                                                       | N/A                                                                                                      |
