...
```typescript
import { ManagerRetryResponseNetworkCreate2 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseNetworkCreate2 = {
  type: "create",
};
```
...
| `type`                                                                                                              | [models.ManagerRetryResponseTypeCreate2](../models/managerretryresponsetypecreate2.md)                              | :heavy_check_mark:                                                                                                  | N/A                                                                                                                 |