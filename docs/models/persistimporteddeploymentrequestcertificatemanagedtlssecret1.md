...
```typescript
import { PersistImportedDeploymentRequestCertificateManagedTLSSecret1 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestCertificateManagedTLSSecret1 = {
