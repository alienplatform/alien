...
```typescript
import { PersistImportedDeploymentRequestProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                                     | [models.PersistImportedDeploymentRequestProviderAwsAlbEnum4](../models/persistimporteddeploymentrequestproviderawsalbenum4.md) | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |
