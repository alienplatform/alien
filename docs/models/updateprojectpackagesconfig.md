...
| `operatorImage`                                                                                                              | [models.UpdateProjectOperatorImage](../models/updateprojectoperatorimage.md)                                                 | :heavy_minus_sign:                                                                                                           | Operator image package configuration. Required when Helm is enabled. If null, Operator image packages will not be generated. |
