...
```typescript
import { ManagerRetryResponseRouteIngress4 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteIngress4 = {
...
| `provider`                                                        | *models.ManagerRetryResponseProviderUnion7*                       | :heavy_minus_sign:                                                | N/A                                                               |
