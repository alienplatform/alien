...
```typescript
import { SyncListResponsePoolsFixed } from "@alienplatform/platform-api/models";

let value: SyncListResponsePoolsFixed = {
  machines: 537247,
  mode: "fixed",
};
```
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `failureDomains`                                    | *models.SyncListResponseFailureDomainsUnion1*       | :heavy_minus_sign:                                  | N/A                                                 |
