...
```typescript
import { DeploymentProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: DeploymentProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                         | [models.DeploymentProviderAwsAlbEnum4](../models/deploymentproviderawsalbenum4.md) | :heavy_check_mark:                                                                 | N/A                                                                                |
