...
```typescript
import { DeploymentDetailResponseRouteGateway1 } from "@alienplatform/platform-api/models";

let value: DeploymentDetailResponseRouteGateway1 = {
...
| `provider`                                                           | *models.DeploymentDetailResponseProviderUnion2*                      | :heavy_minus_sign:                                                   | N/A                                                                  |
