...
```typescript
import { DeploymentStatePendingPreparedStackProfileAzureGrant } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackProfileAzureGrant = {};
```
