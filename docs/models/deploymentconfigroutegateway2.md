...
```typescript
import { DeploymentConfigRouteGateway2 } from "@alienplatform/platform-api/models";

let value: DeploymentConfigRouteGateway2 = {
...
| `provider`                                                           | *models.DeploymentConfigProviderUnion4*                              | :heavy_minus_sign:                                                   | N/A                                                                  |
