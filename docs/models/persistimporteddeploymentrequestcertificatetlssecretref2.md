...
```typescript
import { PersistImportedDeploymentRequestCertificateTLSSecretRef2 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestCertificateTLSSecretRef2 = {
  secretName: "<value>",
  mode: "tlsSecretRef",
};
```
