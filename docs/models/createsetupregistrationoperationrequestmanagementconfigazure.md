...
```typescript
import { CreateSetupRegistrationOperationRequestManagementConfigAzure } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestManagementConfigAzure = {
  managingTenantId: "<id>",
  oidcIssuer: "<value>",
  oidcSubject: "<value>",
  platform: "azure",
...
| `platform`                                                                                                                       | [models.CreateSetupRegistrationOperationRequestPlatformAzure](../models/createsetupregistrationoperationrequestplatformazure.md) | :heavy_check_mark:                                                                                                               | N/A                                                                                                                              |