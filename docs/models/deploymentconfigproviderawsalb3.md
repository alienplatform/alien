...
```typescript
import { DeploymentConfigProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: DeploymentConfigProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                     | [models.DeploymentConfigProviderAwsAlbEnum3](../models/deploymentconfigproviderawsalbenum3.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
