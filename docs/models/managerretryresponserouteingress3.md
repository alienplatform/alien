...
```typescript
import { ManagerRetryResponseRouteIngress3 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteIngress3 = {
...
| `provider`                                                        | *models.ManagerRetryResponseProviderUnion5*                       | :heavy_minus_sign:                                                | N/A                                                               |
