...
```typescript
import { DataAzureBlob } from "@alienplatform/platform-api/models";
...
| `status`                                                                       | [models.SyncReconcileRequestStatus3](../models/syncreconcilerequeststatus3.md) | :heavy_check_mark:                                                             | N/A                                                                            |
