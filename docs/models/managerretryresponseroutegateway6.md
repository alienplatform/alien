...
```typescript
import { ManagerRetryResponseRouteGateway6 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteGateway6 = {
...
| `provider`                                                           | *models.ManagerRetryResponseProviderUnion12*                         | :heavy_minus_sign:                                                   | N/A                                                                  |
