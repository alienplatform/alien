...
```typescript
import { NewDeploymentRequestRouteIngress1 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestRouteIngress1 = {
...
| `provider`                                                        | *models.NewDeploymentRequestProviderUnion1*                       | :heavy_minus_sign:                                                | N/A                                                               |
