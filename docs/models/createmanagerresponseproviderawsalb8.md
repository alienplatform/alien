...
```typescript
import { CreateManagerResponseProviderAwsAlb8 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseProviderAwsAlb8 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                               | [models.CreateManagerResponseProviderAwsAlbEnum8](../models/createmanagerresponseproviderawsalbenum8.md) | :heavy_check_mark:                                                                                       | N/A                                                                                                      |
