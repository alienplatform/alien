...
```typescript
import { TargetDeploymentRouteGateway1 } from "@alienplatform/platform-api/models";

let value: TargetDeploymentRouteGateway1 = {
...
| `provider`                                                           | *models.TargetDeploymentProviderUnion2*                              | :heavy_minus_sign:                                                   | N/A                                                                  |
