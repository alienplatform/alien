...
```typescript
import { CreateSetupRegistrationOperationRequestCertificateManagedAcmImport2 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestCertificateManagedAcmImport2 =
  {
