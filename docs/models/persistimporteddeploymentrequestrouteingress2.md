...
```typescript
import { PersistImportedDeploymentRequestRouteIngress2 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestRouteIngress2 = {
...
| `provider`                                                        | *models.PersistImportedDeploymentRequestProviderUnion3*           | :heavy_minus_sign:                                                | N/A                                                               |
