...
```typescript
import { DeploymentConfigDomainMetadata } from "@alienplatform/platform-api/models";

let value: DeploymentConfigDomainMetadata = {
  baseDomain: "<value>",
  hostedZoneId: "<id>",
...
| `resources`                                                                                | Record<string, [models.DeploymentConfigResources](../models/deploymentconfigresources.md)> | :heavy_check_mark:                                                                         | Metadata per resource ID.                                                                  |