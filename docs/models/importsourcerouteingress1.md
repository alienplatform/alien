...
```typescript
import { ImportSourceRouteIngress1 } from "@alienplatform/platform-api/models";

let value: ImportSourceRouteIngress1 = {
...
| `provider`                                                        | *models.ImportSourceProviderUnion1*                               | :heavy_minus_sign:                                                | N/A                                                               |
