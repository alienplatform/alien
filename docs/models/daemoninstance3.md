...
```typescript
import { DaemonInstance3 } from "@alienplatform/platform-api/models";
...
| ----------------------------------- | ----------------------------------- | ----------------------------------- | ----------------------------------- |
| `cpu`                               | *models.DaemonInstanceCpuUnion3*    | :heavy_minus_sign:                  | N/A                                 |
| `ip`                                | *string*                            | :heavy_minus_sign:                  | N/A                                 |
| `machineId`                         | *string*                            | :heavy_minus_sign:                  | N/A                                 |
| `memory`                            | *models.DaemonInstanceMemoryUnion3* | :heavy_minus_sign:                  | N/A                                 |
