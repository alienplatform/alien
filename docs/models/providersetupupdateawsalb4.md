...
```typescript
import { ProviderSetupUpdateAwsAlb4 } from "@alienplatform/platform-api/models";

let value: ProviderSetupUpdateAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                           | [models.SetupUpdateProviderAwsAlbEnum4](../models/setupupdateproviderawsalbenum4.md) | :heavy_check_mark:                                                                   | N/A                                                                                  |
