...
```typescript
import { ManagerRetryResponseProviderAwsAlb8 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseProviderAwsAlb8 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                             | [models.ManagerRetryResponseProviderAwsAlbEnum8](../models/managerretryresponseproviderawsalbenum8.md) | :heavy_check_mark:                                                                                     | N/A                                                                                                    |
