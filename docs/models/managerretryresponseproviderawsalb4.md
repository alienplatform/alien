...
```typescript
import { ManagerRetryResponseProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                             | [models.ManagerRetryResponseProviderAwsAlbEnum4](../models/managerretryresponseproviderawsalbenum4.md) | :heavy_check_mark:                                                                                     | N/A                                                                                                    |
