...
```typescript
import { CreateManagerResponseCertificateManagedAcmImport4 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseCertificateManagedAcmImport4 = {
