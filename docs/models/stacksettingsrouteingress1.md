...
```typescript
import { StackSettingsRouteIngress1 } from "@alienplatform/platform-api/models";

let value: StackSettingsRouteIngress1 = {
...
| `provider`                                                        | *models.StackSettingsProviderUnion1*                              | :heavy_minus_sign:                                                | N/A                                                               |
