...
```typescript
import { UpdateDeploymentComputeRequestCompute } from "@alienplatform/platform-api/models";

let value: UpdateDeploymentComputeRequestCompute = {};
```
...
| ----------------------------------------------------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------- |
| `pools`                                                           | Record<string, *models.UpdateDeploymentComputeRequestPoolsUnion*> | :heavy_minus_sign:                                                | Selected compute choices keyed by pool ID.                        |