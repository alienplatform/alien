...
```typescript
import { ManagerRetryResponseCertificateManagedAcmImport2 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseCertificateManagedAcmImport2 = {
