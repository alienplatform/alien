...
```typescript
import { ImportSourceProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: ImportSourceProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                             | [models.ImportSourceProviderAwsAlbEnum2](../models/importsourceproviderawsalbenum2.md) | :heavy_check_mark:                                                                     | N/A                                                                                    |
