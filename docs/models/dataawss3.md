...
```typescript
import { DataAwsS3 } from "@alienplatform/platform-api/models";
...
| `status`                                                                       | [models.SyncReconcileRequestStatus1](../models/syncreconcilerequeststatus1.md) | :heavy_check_mark:                                                             | N/A                                                                            |
