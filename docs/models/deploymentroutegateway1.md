...
```typescript
import { DeploymentRouteGateway1 } from "@alienplatform/platform-api/models";

let value: DeploymentRouteGateway1 = {
...
| `provider`                                                           | *models.DeploymentProviderUnion2*                                    | :heavy_minus_sign:                                                   | N/A                                                                  |
