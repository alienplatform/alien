...
```typescript
import { ImportSourceProviderAzureApplicationGatewayForContainers4 } from "@alienplatform/platform-api/models";

let value: ImportSourceProviderAzureApplicationGatewayForContainers4 = {
  frontend: "<value>",
...
| `provider`                                                                                                                                         | [models.ImportSourceProviderAzureApplicationGatewayForContainersEnum4](../models/importsourceproviderazureapplicationgatewayforcontainersenum4.md) | :heavy_check_mark:                                                                                                                                 | N/A                                                                                                                                                |