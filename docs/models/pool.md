...
| `selected`                                                                         | *models.ComputePoolSelection*                                                      | :heavy_check_mark:                                                                 | User-selected deployment settings for one compute pool.                            |
| `recommended`                                                                      | *models.ComputePoolSelection*                                                      | :heavy_check_mark:                                                                 | User-selected deployment settings for one compute pool.                            |
