...
```typescript
import { DeploymentSetupStackSettingsPolicyRouteIngress2 } from "@alienplatform/platform-api/models";

let value: DeploymentSetupStackSettingsPolicyRouteIngress2 = {
...
| `provider`                                                        | *models.DeploymentSetupStackSettingsPolicyProviderUnion3*         | :heavy_minus_sign:                                                | N/A                                                               |
