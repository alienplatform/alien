...
```typescript
import { CreateManagerResponseCertificateManagedAcmImport1 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseCertificateManagedAcmImport1 = {
