...
```typescript
import { NewDeploymentRequestRouteGateway2 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestRouteGateway2 = {
...
| `provider`                                                           | *models.NewDeploymentRequestProviderUnion4*                          | :heavy_minus_sign:                                                   | N/A                                                                  |
