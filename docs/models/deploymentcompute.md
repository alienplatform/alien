...
```typescript
import { DeploymentCompute } from "@alienplatform/platform-api/models";

let value: DeploymentCompute = {};
```
...
| --------------------------------------------- | --------------------------------------------- | --------------------------------------------- | --------------------------------------------- |
| `pools`                                       | Record<string, *models.DeploymentPoolsUnion*> | :heavy_minus_sign:                            | Selected compute choices keyed by pool ID.    |