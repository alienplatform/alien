...
```typescript
import { ProjectListItemResponseDeploymentPortalAppearance } from "@alienplatform/platform-api/models";

let value: ProjectListItemResponseDeploymentPortalAppearance = {};
```
