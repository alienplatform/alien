...
```typescript
import { PublishChildDeploymentRequestOverrideAzureGrant } from "@alienplatform/platform-api/models";

let value: PublishChildDeploymentRequestOverrideAzureGrant = {};
```
