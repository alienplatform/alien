...
```typescript
import { SyncListResponseRouteGateway2 } from "@alienplatform/platform-api/models";

let value: SyncListResponseRouteGateway2 = {
...
| `provider`                                                           | *models.SyncListResponseProviderUnion4*                              | :heavy_minus_sign:                                                   | N/A                                                                  |
