...
```typescript
import { PreparedDeploymentStackEnv } from "@alienplatform/platform-api/models";

let value: PreparedDeploymentStackEnv = {
  name: "<value>",
};
```
...
| `type`                                                                  | *models.PreparedDeploymentStackTypeUnion*                               | :heavy_minus_sign:                                                      | N/A                                                                     |