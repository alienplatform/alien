...
```typescript
import { CreateManagerResponseCertificateManagedAcmImport2 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseCertificateManagedAcmImport2 = {
