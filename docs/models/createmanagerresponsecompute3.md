...
```typescript
import { CreateManagerResponseCompute3 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseCompute3 = {};
```
...
| --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- |
| `pools`                                                   | Record<string, *models.CreateManagerResponsePoolsUnion3*> | :heavy_minus_sign:                                        | Selected compute choices keyed by pool ID.                |