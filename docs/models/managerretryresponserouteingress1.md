...
```typescript
import { ManagerRetryResponseRouteIngress1 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteIngress1 = {
...
| `provider`                                                        | *models.ManagerRetryResponseProviderUnion1*                       | :heavy_minus_sign:                                                | N/A                                                               |
