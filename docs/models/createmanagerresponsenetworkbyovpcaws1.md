...
```typescript
import { CreateManagerResponseNetworkByoVpcAws1 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseNetworkByoVpcAws1 = {
  privateSubnetIds: [],
  publicSubnetIds: [
    "<value 1>",
    "<value 2>",
...
| `type`                                                                                         | [models.CreateManagerResponseTypeByoVpcAws1](../models/createmanagerresponsetypebyovpcaws1.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
