...
```typescript
import { ProviderSetupUpdateAwsAlb3 } from "@alienplatform/platform-api/models";

let value: ProviderSetupUpdateAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                           | [models.SetupUpdateProviderAwsAlbEnum3](../models/setupupdateproviderawsalbenum3.md) | :heavy_check_mark:                                                                   | N/A                                                                                  |
