...
```typescript
import { DeploymentStatePendingPreparedStackExtendGcpGrant } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackExtendGcpGrant = {};
```
