...
```typescript
import { CurrentRelease } from "@alienplatform/platform-api/models";

let value: CurrentRelease = {
  stack: {
    id: "<id>",
    resources: {
      "key": {
...
| `stack`                                                                                                                                             | [models.CurrentReleaseStack](../models/currentreleasestack.md)                                                                                      | :heavy_check_mark:                                                                                                                                  | A bag of resources, unaware of any cloud.                                                                                                           |
