...
```typescript
import { DeploymentInfoRouteGateway2 } from "@alienplatform/platform-api/models";

let value: DeploymentInfoRouteGateway2 = {
...
| `provider`                                                           | *models.SetupUpdateProviderUnion4*                                   | :heavy_minus_sign:                                                   | N/A                                                                  |
