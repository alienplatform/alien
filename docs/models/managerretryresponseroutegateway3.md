...
```typescript
import { ManagerRetryResponseRouteGateway3 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteGateway3 = {
...
| `provider`                                                           | *models.ManagerRetryResponseProviderUnion6*                          | :heavy_minus_sign:                                                   | N/A                                                                  |
