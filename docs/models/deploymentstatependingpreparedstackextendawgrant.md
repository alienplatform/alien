...
```typescript
import { DeploymentStatePendingPreparedStackExtendAwGrant } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackExtendAwGrant = {};
```
