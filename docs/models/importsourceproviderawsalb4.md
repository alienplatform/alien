...
```typescript
import { ImportSourceProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: ImportSourceProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                             | [models.ImportSourceProviderAwsAlbEnum4](../models/importsourceproviderawsalbenum4.md) | :heavy_check_mark:                                                                     | N/A                                                                                    |
