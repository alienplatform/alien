...
```typescript
import { NewDeploymentRequestCertificateManagedTLSSecret2 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestCertificateManagedTLSSecret2 = {
