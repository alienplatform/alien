...
```typescript
import { SyncListResponseRouteIngress2 } from "@alienplatform/platform-api/models";

let value: SyncListResponseRouteIngress2 = {
...
| `provider`                                                        | *models.SyncListResponseProviderUnion3*                           | :heavy_minus_sign:                                                | N/A                                                               |
