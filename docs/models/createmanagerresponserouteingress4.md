...
```typescript
import { CreateManagerResponseRouteIngress4 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteIngress4 = {
...
| `provider`                                                        | *models.CreateManagerResponseProviderUnion7*                      | :heavy_minus_sign:                                                | N/A                                                               |
