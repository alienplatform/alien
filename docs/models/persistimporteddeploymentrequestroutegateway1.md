...
```typescript
import { PersistImportedDeploymentRequestRouteGateway1 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestRouteGateway1 = {
...
| `provider`                                                           | *models.PersistImportedDeploymentRequestProviderUnion2*              | :heavy_minus_sign:                                                   | N/A                                                                  |
