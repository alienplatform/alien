...
```typescript
import { DeploymentStatePendingPreparedStackOverrideAwGrant } from "@alienplatform/platform-api/models";

let value: DeploymentStatePendingPreparedStackOverrideAwGrant = {};
```
