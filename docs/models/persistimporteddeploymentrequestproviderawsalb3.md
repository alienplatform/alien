...
```typescript
import { PersistImportedDeploymentRequestProviderAwsAlb3 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                                     | [models.PersistImportedDeploymentRequestProviderAwsAlbEnum3](../models/persistimporteddeploymentrequestproviderawsalbenum3.md) | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |
