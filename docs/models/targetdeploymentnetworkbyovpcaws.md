...
```typescript
import { TargetDeploymentNetworkByoVpcAws } from "@alienplatform/platform-api/models";

let value: TargetDeploymentNetworkByoVpcAws = {
  privateSubnetIds: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
...
| `type`                                                                             | [models.TargetDeploymentTypeByoVpcAws](../models/targetdeploymenttypebyovpcaws.md) | :heavy_check_mark:                                                                 | N/A                                                                                |
