...
```typescript
import { SyncReconcileRequestEvent12 } from "@alienplatform/platform-api/models";

let value: SyncReconcileRequestEvent12 = {
  message: "<value>",
  reason: "<value>",
};
```
...
| `involvedObject`                                                                              | *models.InvolvedObjectUnion9*                                                                 | :heavy_minus_sign:                                                                            | N/A                                                                                           |
...
| `source`                                                                                      | *models.EventSourceUnion9*                                                                    | :heavy_minus_sign:                                                                            | N/A                                                                                           |
