...
```typescript
import { ImportSourceNetworkCreate } from "@alienplatform/platform-api/models";

let value: ImportSourceNetworkCreate = {
  type: "create",
};
```
...
| `type`                                                                                                              | [models.ImportSourceTypeCreate](../models/importsourcetypecreate.md)                                                | :heavy_check_mark:                                                                                                  | N/A                                                                                                                 |