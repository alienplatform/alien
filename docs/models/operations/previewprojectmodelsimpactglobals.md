# PreviewProjectModelsImpactGlobals

## Example Usage

```typescript
import { PreviewProjectModelsImpactGlobals } from "@alienplatform/platform-api/models/operations";

let value: PreviewProjectModelsImpactGlobals = {
