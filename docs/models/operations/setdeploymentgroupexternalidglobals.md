# SetDeploymentGroupExternalIdGlobals

## Example Usage

```typescript
import { SetDeploymentGroupExternalIdGlobals } from "@alienplatform/platform-api/models/operations";

let value: SetDeploymentGroupExternalIdGlobals = {
