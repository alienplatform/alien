...
```typescript
import { PrepareDeploymentStackProviderAwsAlb3 } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackProviderAwsAlb3 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                                   | [operations.PrepareDeploymentStackProviderAwsAlbEnum3](../../models/operations/preparedeploymentstackproviderawsalbenum3.md) | :heavy_check_mark:                                                                                                           | N/A                                                                                                                          |
