# GetProjectTemplateUrlsGlobals

## Example Usage

```typescript
import { GetProjectTemplateUrlsGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetProjectTemplateUrlsGlobals = {
