# ListReleaseDeploymentsGlobals

## Example Usage

```typescript
import { ListReleaseDeploymentsGlobals } from "@alienplatform/platform-api/models/operations";

let value: ListReleaseDeploymentsGlobals = {
