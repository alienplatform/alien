...
```typescript
import { PlanDeploymentComputeRouteIngress1 } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeRouteIngress1 = {
...
| `provider`                                                        | *operations.PlanDeploymentComputeProviderUnion1*                  | :heavy_minus_sign:                                                | N/A                                                               |
