# DeleteChildDeploymentGlobals

## Example Usage

```typescript
import { DeleteChildDeploymentGlobals } from "@alienplatform/platform-api/models/operations";

let value: DeleteChildDeploymentGlobals = {
