# ConfigureProjectModelsGlobals

## Example Usage

```typescript
import { ConfigureProjectModelsGlobals } from "@alienplatform/platform-api/models/operations";

let value: ConfigureProjectModelsGlobals = {
