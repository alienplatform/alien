# GetAccessRequestCoordinatesGlobals

## Example Usage

```typescript
import { GetAccessRequestCoordinatesGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetAccessRequestCoordinatesGlobals = {
