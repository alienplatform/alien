...
```typescript
import { PrepareDeploymentStackRouteGateway2 } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackRouteGateway2 = {
...
| `provider`                                                           | *operations.PrepareDeploymentStackProviderUnion4*                    | :heavy_minus_sign:                                                   | N/A                                                                  |
