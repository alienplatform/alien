# ConfigureProjectDeploymentsGlobals

## Example Usage

```typescript
import { ConfigureProjectDeploymentsGlobals } from "@alienplatform/platform-api/models/operations";

let value: ConfigureProjectDeploymentsGlobals = {
