# UpdateDeploymentGroupGlobals

## Example Usage

```typescript
import { UpdateDeploymentGroupGlobals } from "@alienplatform/platform-api/models/operations";

let value: UpdateDeploymentGroupGlobals = {
