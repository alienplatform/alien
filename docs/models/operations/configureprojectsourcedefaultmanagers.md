...
```typescript
import { ConfigureProjectSourceDefaultManagers } from "@alienplatform/platform-api/models/operations";

let value: ConfigureProjectSourceDefaultManagers = {
...
| `machines`                                       | *string*                                         | :heavy_minus_sign:                               | Unique identifier for a default private manager. | mgr_enxscjrqiiu2lrc672hwwuc5                     |
