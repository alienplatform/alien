# CancelMachinesMachineDrainGlobals

## Example Usage

```typescript
import { CancelMachinesMachineDrainGlobals } from "@alienplatform/platform-api/models/operations";

let value: CancelMachinesMachineDrainGlobals = {
