...
```typescript
import { CapacityGroup3 } from "@alienplatform/platform-api/models/operations";
...
| ---------------------------------- | ---------------------------------- | ---------------------------------- | ---------------------------------- |
| `capacityBlocker`                  | *operations.CapacityBlockerUnion3* | :heavy_minus_sign:                 | N/A                                |
| `currentMachines`                  | *number*                           | :heavy_check_mark:                 | N/A                                |
| `desiredMachines`                  | *number*                           | :heavy_check_mark:                 | N/A                                |
| `drainProgress`                    | *operations.DrainProgressUnion3*   | :heavy_minus_sign:                 | N/A                                |
...
| `recommendation`                   | *operations.RecommendationUnion3*  | :heavy_minus_sign:                 | N/A                                |