# GetResourceDeploymentDetailGlobals

## Example Usage

```typescript
import { GetResourceDeploymentDetailGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetResourceDeploymentDetailGlobals = {
