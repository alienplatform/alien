...
```typescript
import { DaemonInstance4 } from "@alienplatform/platform-api/models/operations";
...
| --------------------------------------- | --------------------------------------- | --------------------------------------- | --------------------------------------- |
| `cpu`                                   | *operations.DaemonInstanceCpuUnion4*    | :heavy_minus_sign:                      | N/A                                     |
| `ip`                                    | *string*                                | :heavy_minus_sign:                      | N/A                                     |
| `machineId`                             | *string*                                | :heavy_minus_sign:                      | N/A                                     |
| `memory`                                | *operations.DaemonInstanceMemoryUnion4* | :heavy_minus_sign:                      | N/A                                     |
