# ConfigureProjectRegistryGlobals

## Example Usage

```typescript
import { ConfigureProjectRegistryGlobals } from "@alienplatform/platform-api/models/operations";

let value: ConfigureProjectRegistryGlobals = {
