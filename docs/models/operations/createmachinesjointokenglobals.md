# CreateMachinesJoinTokenGlobals

## Example Usage

```typescript
import { CreateMachinesJoinTokenGlobals } from "@alienplatform/platform-api/models/operations";

let value: CreateMachinesJoinTokenGlobals = {
