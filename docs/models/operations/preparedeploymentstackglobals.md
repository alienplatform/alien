# PrepareDeploymentStackGlobals

## Example Usage

```typescript
import { PrepareDeploymentStackGlobals } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackGlobals = {
