# RenderOperatorManifestGlobals

## Example Usage

```typescript
import { RenderOperatorManifestGlobals } from "@alienplatform/platform-api/models/operations";

let value: RenderOperatorManifestGlobals = {
