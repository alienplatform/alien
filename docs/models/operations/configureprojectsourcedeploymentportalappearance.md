...
```typescript
import { ConfigureProjectSourceDeploymentPortalAppearance } from "@alienplatform/platform-api/models/operations";

let value: ConfigureProjectSourceDeploymentPortalAppearance = {};
```
