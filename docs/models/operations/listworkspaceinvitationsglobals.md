# ListWorkspaceInvitationsGlobals

## Example Usage

```typescript
import { ListWorkspaceInvitationsGlobals } from "@alienplatform/platform-api/models/operations";

let value: ListWorkspaceInvitationsGlobals = {
