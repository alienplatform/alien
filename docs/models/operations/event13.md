...
```typescript
import { Event13 } from "@alienplatform/platform-api/models/operations";
...
| `involvedObject`                                                                              | *operations.InvolvedObjectUnion10*                                                            | :heavy_minus_sign:                                                                            | N/A                                                                                           |
...
| `source`                                                                                      | *operations.SourceUnion10*                                                                    | :heavy_minus_sign:                                                                            | N/A                                                                                           |
