# CreateExternalAIModelCheckGlobals

## Example Usage

```typescript
import { CreateExternalAIModelCheckGlobals } from "@alienplatform/platform-api/models/operations";

let value: CreateExternalAIModelCheckGlobals = {
