# ConfigureProjectBucketsGlobals

## Example Usage

```typescript
import { ConfigureProjectBucketsGlobals } from "@alienplatform/platform-api/models/operations";

let value: ConfigureProjectBucketsGlobals = {
