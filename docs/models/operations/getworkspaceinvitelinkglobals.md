# GetWorkspaceInviteLinkGlobals

## Example Usage

```typescript
import { GetWorkspaceInviteLinkGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetWorkspaceInviteLinkGlobals = {
