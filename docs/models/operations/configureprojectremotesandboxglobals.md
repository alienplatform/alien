# ConfigureProjectRemoteSandboxGlobals

## Example Usage

```typescript
import { ConfigureProjectRemoteSandboxGlobals } from "@alienplatform/platform-api/models/operations";

let value: ConfigureProjectRemoteSandboxGlobals = {
