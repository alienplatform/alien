# CreateWorkspaceInviteLinkGlobals

## Example Usage

```typescript
import { CreateWorkspaceInviteLinkGlobals } from "@alienplatform/platform-api/models/operations";

let value: CreateWorkspaceInviteLinkGlobals = {
