# CreateChildDeploymentGlobals

## Example Usage

```typescript
import { CreateChildDeploymentGlobals } from "@alienplatform/platform-api/models/operations";

let value: CreateChildDeploymentGlobals = {
