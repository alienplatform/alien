# SlackIntegrationUninstallGlobals

## Example Usage

```typescript
import { SlackIntegrationUninstallGlobals } from "@alienplatform/platform-api/models/operations";

let value: SlackIntegrationUninstallGlobals = {
