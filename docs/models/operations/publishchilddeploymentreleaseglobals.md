# PublishChildDeploymentReleaseGlobals

## Example Usage

```typescript
import { PublishChildDeploymentReleaseGlobals } from "@alienplatform/platform-api/models/operations";

let value: PublishChildDeploymentReleaseGlobals = {
