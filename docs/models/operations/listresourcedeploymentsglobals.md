# ListResourceDeploymentsGlobals

## Example Usage

```typescript
import { ListResourceDeploymentsGlobals } from "@alienplatform/platform-api/models/operations";

let value: ListResourceDeploymentsGlobals = {
