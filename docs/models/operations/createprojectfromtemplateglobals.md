# CreateProjectFromTemplateGlobals

## Example Usage

```typescript
import { CreateProjectFromTemplateGlobals } from "@alienplatform/platform-api/models/operations";

let value: CreateProjectFromTemplateGlobals = {
