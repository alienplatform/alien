# RevokeMachinesJoinTokenGlobals

## Example Usage

```typescript
import { RevokeMachinesJoinTokenGlobals } from "@alienplatform/platform-api/models/operations";

let value: RevokeMachinesJoinTokenGlobals = {
