# EnsureDeploymentGroupByNameGlobals

## Example Usage

```typescript
import { EnsureDeploymentGroupByNameGlobals } from "@alienplatform/platform-api/models/operations";

let value: EnsureDeploymentGroupByNameGlobals = {
