# GetManagerDomainBindingGlobals

## Example Usage

```typescript
import { GetManagerDomainBindingGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetManagerDomainBindingGlobals = {
