# ListDeploymentMachinesGlobals

## Example Usage

```typescript
import { ListDeploymentMachinesGlobals } from "@alienplatform/platform-api/models/operations";

let value: ListDeploymentMachinesGlobals = {
