# UpdateManagerDomainBindingGlobals

## Example Usage

```typescript
import { UpdateManagerDomainBindingGlobals } from "@alienplatform/platform-api/models/operations";

let value: UpdateManagerDomainBindingGlobals = {
