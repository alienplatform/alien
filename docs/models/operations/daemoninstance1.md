...
```typescript
import { DaemonInstance1 } from "@alienplatform/platform-api/models/operations";
...
| --------------------------------------- | --------------------------------------- | --------------------------------------- | --------------------------------------- |
| `cpu`                                   | *operations.DaemonInstanceCpuUnion1*    | :heavy_minus_sign:                      | N/A                                     |
| `ip`                                    | *string*                                | :heavy_minus_sign:                      | N/A                                     |
| `machineId`                             | *string*                                | :heavy_minus_sign:                      | N/A                                     |
| `memory`                                | *operations.DaemonInstanceMemoryUnion1* | :heavy_minus_sign:                      | N/A                                     |
