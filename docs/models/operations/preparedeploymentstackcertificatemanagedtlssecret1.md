...
```typescript
import { PrepareDeploymentStackCertificateManagedTLSSecret1 } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackCertificateManagedTLSSecret1 = {
