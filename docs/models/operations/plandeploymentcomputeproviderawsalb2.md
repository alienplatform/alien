...
```typescript
import { PlanDeploymentComputeProviderAwsAlb2 } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                                                 | [operations.PlanDeploymentComputeProviderAwsAlbEnum2](../../models/operations/plandeploymentcomputeproviderawsalbenum2.md) | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
