...
```typescript
import { PrepareDeploymentStackCertificateManagedAcmImport2 } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackCertificateManagedAcmImport2 = {
