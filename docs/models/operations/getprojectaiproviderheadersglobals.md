# GetProjectAiProviderHeadersGlobals

## Example Usage

```typescript
import { GetProjectAiProviderHeadersGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetProjectAiProviderHeadersGlobals = {
