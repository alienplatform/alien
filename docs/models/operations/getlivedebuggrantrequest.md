...
| `debugTool`                                                                                   | [models.DebugGrantTool](../../models/debuggranttool.md)                                       | :heavy_check_mark:                                                                            | Requests a remote-debugging grant for this tool, alongside or instead of an operations grant. |                                                                                               |
