# SetDeploymentReleaseChannelGlobals

## Example Usage

```typescript
import { SetDeploymentReleaseChannelGlobals } from "@alienplatform/platform-api/models/operations";

let value: SetDeploymentReleaseChannelGlobals = {
