# ConfigureProjectSourceGlobals

## Example Usage

```typescript
import { ConfigureProjectSourceGlobals } from "@alienplatform/platform-api/models/operations";

let value: ConfigureProjectSourceGlobals = {
