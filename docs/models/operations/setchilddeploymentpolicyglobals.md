# SetChildDeploymentPolicyGlobals

## Example Usage

```typescript
import { SetChildDeploymentPolicyGlobals } from "@alienplatform/platform-api/models/operations";

let value: SetChildDeploymentPolicyGlobals = {
