# SetOperationsPluginEnabledGlobals

## Example Usage

```typescript
import { SetOperationsPluginEnabledGlobals } from "@alienplatform/platform-api/models/operations";

let value: SetOperationsPluginEnabledGlobals = {
