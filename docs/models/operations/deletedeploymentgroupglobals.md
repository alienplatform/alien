# DeleteDeploymentGroupGlobals

## Example Usage

```typescript
import { DeleteDeploymentGroupGlobals } from "@alienplatform/platform-api/models/operations";

let value: DeleteDeploymentGroupGlobals = {
