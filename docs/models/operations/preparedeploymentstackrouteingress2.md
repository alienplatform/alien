...
```typescript
import { PrepareDeploymentStackRouteIngress2 } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackRouteIngress2 = {
...
| `provider`                                                        | *operations.PrepareDeploymentStackProviderUnion3*                 | :heavy_minus_sign:                                                | N/A                                                               |
