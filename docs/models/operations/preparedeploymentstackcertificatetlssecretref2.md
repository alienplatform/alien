...
```typescript
import { PrepareDeploymentStackCertificateTLSSecretRef2 } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackCertificateTLSSecretRef2 = {
  secretName: "<value>",
  mode: "tlsSecretRef",
};
```
