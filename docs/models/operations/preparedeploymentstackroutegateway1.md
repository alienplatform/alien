...
```typescript
import { PrepareDeploymentStackRouteGateway1 } from "@alienplatform/platform-api/models/operations";

let value: PrepareDeploymentStackRouteGateway1 = {
...
| `provider`                                                           | *operations.PrepareDeploymentStackProviderUnion2*                    | :heavy_minus_sign:                                                   | N/A                                                                  |
