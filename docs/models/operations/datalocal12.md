...
```typescript
import { DataLocal12 } from "@alienplatform/platform-api/models/operations";
...
| `status`                                                                                                                 | [operations.GetResourceDeploymentDetailDataStatus77](../../models/operations/getresourcedeploymentdetaildatastatus77.md) | :heavy_check_mark:                                                                                                       | N/A                                                                                                                      |
