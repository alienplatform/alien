# ReportManagerHeartbeatGlobals

## Example Usage

```typescript
import { ReportManagerHeartbeatGlobals } from "@alienplatform/platform-api/models/operations";

let value: ReportManagerHeartbeatGlobals = {
