# GetDeploymentConnectionInfoGlobals

## Example Usage

```typescript
import { GetDeploymentConnectionInfoGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetDeploymentConnectionInfoGlobals = {
