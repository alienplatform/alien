# CreateDeploymentGroupTokenGlobals

## Example Usage

```typescript
import { CreateDeploymentGroupTokenGlobals } from "@alienplatform/platform-api/models/operations";

let value: CreateDeploymentGroupTokenGlobals = {
