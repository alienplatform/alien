# GenerateManagerBindingTokenGlobals

## Example Usage

```typescript
import { GenerateManagerBindingTokenGlobals } from "@alienplatform/platform-api/models/operations";

let value: GenerateManagerBindingTokenGlobals = {
