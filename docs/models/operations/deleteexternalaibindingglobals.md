# DeleteExternalAIBindingGlobals

## Example Usage

```typescript
import { DeleteExternalAIBindingGlobals } from "@alienplatform/platform-api/models/operations";

let value: DeleteExternalAIBindingGlobals = {
