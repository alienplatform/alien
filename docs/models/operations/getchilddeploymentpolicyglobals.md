# GetChildDeploymentPolicyGlobals

## Example Usage

```typescript
import { GetChildDeploymentPolicyGlobals } from "@alienplatform/platform-api/models/operations";

let value: GetChildDeploymentPolicyGlobals = {
