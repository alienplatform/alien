# UpdateDeploymentComputeGlobals

## Example Usage

```typescript
import { UpdateDeploymentComputeGlobals } from "@alienplatform/platform-api/models/operations";

let value: UpdateDeploymentComputeGlobals = {
