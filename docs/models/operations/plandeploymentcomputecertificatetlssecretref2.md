...
```typescript
import { PlanDeploymentComputeCertificateTLSSecretRef2 } from "@alienplatform/platform-api/models/operations";

let value: PlanDeploymentComputeCertificateTLSSecretRef2 = {
  secretName: "<value>",
  mode: "tlsSecretRef",
};
```
