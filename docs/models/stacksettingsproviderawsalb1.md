...
```typescript
import { StackSettingsProviderAwsAlb1 } from "@alienplatform/platform-api/models";

let value: StackSettingsProviderAwsAlb1 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                               | [models.StackSettingsProviderAwsAlbEnum1](../models/stacksettingsproviderawsalbenum1.md) | :heavy_check_mark:                                                                       | N/A                                                                                      |
