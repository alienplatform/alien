...
```typescript
import { CreateManagerResponseRouteIngress1 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteIngress1 = {
...
| `provider`                                                        | *models.CreateManagerResponseProviderUnion1*                      | :heavy_minus_sign:                                                | N/A                                                               |
