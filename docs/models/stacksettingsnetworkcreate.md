...
```typescript
import { StackSettingsNetworkCreate } from "@alienplatform/platform-api/models";

let value: StackSettingsNetworkCreate = {
  type: "create",
};
```
...
| `type`                                                                                                              | [models.StackSettingsTypeCreate](../models/stacksettingstypecreate.md)                                              | :heavy_check_mark:                                                                                                  | N/A                                                                                                                 |