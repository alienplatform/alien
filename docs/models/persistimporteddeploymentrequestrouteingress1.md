...
```typescript
import { PersistImportedDeploymentRequestRouteIngress1 } from "@alienplatform/platform-api/models";

let value: PersistImportedDeploymentRequestRouteIngress1 = {
...
| `provider`                                                        | *models.PersistImportedDeploymentRequestProviderUnion1*           | :heavy_minus_sign:                                                | N/A                                                               |
