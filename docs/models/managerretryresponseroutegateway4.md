...
```typescript
import { ManagerRetryResponseRouteGateway4 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseRouteGateway4 = {
...
| `provider`                                                           | *models.ManagerRetryResponseProviderUnion8*                          | :heavy_minus_sign:                                                   | N/A                                                                  |
