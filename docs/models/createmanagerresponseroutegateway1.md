...
```typescript
import { CreateManagerResponseRouteGateway1 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteGateway1 = {
...
| `provider`                                                           | *models.CreateManagerResponseProviderUnion2*                         | :heavy_minus_sign:                                                   | N/A                                                                  |
