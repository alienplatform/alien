...
```typescript
import { CreateManagerResponseRouteIngress6 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseRouteIngress6 = {
...
| `provider`                                                        | *models.CreateManagerResponseProviderUnion11*                     | :heavy_minus_sign:                                                | N/A                                                               |
