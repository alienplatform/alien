...
```typescript
import { ProviderSetupUpdateAzureApplicationGatewayForContainers4 } from "@alienplatform/platform-api/models";

let value: ProviderSetupUpdateAzureApplicationGatewayForContainers4 = {
  frontend: "<value>",
...
| `provider`                                                                                                                                       | [models.SetupUpdateProviderAzureApplicationGatewayForContainersEnum4](../models/setupupdateproviderazureapplicationgatewayforcontainersenum4.md) | :heavy_check_mark:                                                                                                                               | N/A                                                                                                                                              |