...
```typescript
import { TargetDeploymentProviderAwsAlb4 } from "@alienplatform/platform-api/models";

let value: TargetDeploymentProviderAwsAlb4 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                     | [models.TargetDeploymentProviderAwsAlbEnum4](../models/targetdeploymentproviderawsalbenum4.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
