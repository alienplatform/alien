...
```typescript
import { CreateManagerResponseCertificateManagedAcmImport6 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseCertificateManagedAcmImport6 = {
