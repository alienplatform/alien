...
```typescript
import { DeploymentInfoNetworkCreate } from "@alienplatform/platform-api/models";

let value: DeploymentInfoNetworkCreate = {
  type: "create",
};
```
...
| `type`                                                                                                              | [models.DeploymentInfoTypeCreate](../models/deploymentinfotypecreate.md)                                            | :heavy_check_mark:                                                                                                  | N/A                                                                                                                 |