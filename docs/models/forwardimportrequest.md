...
| `setupItem`                                                                                   | [models.ForwardImportRequestSetupItem](../models/forwardimportrequestsetupitem.md)            | :heavy_minus_sign:                                                                            | Exact item selected from a tailored customer setup link.                                      |                                                                                               |
