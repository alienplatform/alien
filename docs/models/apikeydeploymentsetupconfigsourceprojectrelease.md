...
```typescript
import { APIKeyDeploymentSetupConfigSourceProjectRelease } from "@alienplatform/platform-api/models";

let value: APIKeyDeploymentSetupConfigSourceProjectRelease = {
