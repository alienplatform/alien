...
```typescript
import { StackSettingsNetworkByoVpcAws } from "@alienplatform/platform-api/models";

let value: StackSettingsNetworkByoVpcAws = {
  privateSubnetIds: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
...
| `type`                                                                       | [models.StackSettingsTypeByoVpcAws](../models/stacksettingstypebyovpcaws.md) | :heavy_check_mark:                                                           | N/A                                                                          |
