...
```typescript
import { NewDeploymentRequestProviderAwsAlb1 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestProviderAwsAlb1 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                             | [models.NewDeploymentRequestProviderAwsAlbEnum1](../models/newdeploymentrequestproviderawsalbenum1.md) | :heavy_check_mark:                                                                                     | N/A                                                                                                    |
