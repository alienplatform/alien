...
```typescript
import { DeploymentConfigRouteGateway1 } from "@alienplatform/platform-api/models";

let value: DeploymentConfigRouteGateway1 = {
...
| `provider`                                                           | *models.DeploymentConfigProviderUnion2*                              | :heavy_minus_sign:                                                   | N/A                                                                  |
