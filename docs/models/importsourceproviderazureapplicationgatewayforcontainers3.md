...
```typescript
import { ImportSourceProviderAzureApplicationGatewayForContainers3 } from "@alienplatform/platform-api/models";

let value: ImportSourceProviderAzureApplicationGatewayForContainers3 = {
  frontend: "<value>",
...
| `provider`                                                                                                                                         | [models.ImportSourceProviderAzureApplicationGatewayForContainersEnum3](../models/importsourceproviderazureapplicationgatewayforcontainersenum3.md) | :heavy_check_mark:                                                                                                                                 | N/A                                                                                                                                                |