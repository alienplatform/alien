...
```typescript
import { SyncListResponseNetworkByoVpcAws } from "@alienplatform/platform-api/models";

let value: SyncListResponseNetworkByoVpcAws = {
  privateSubnetIds: [
    "<value 1>",
    "<value 2>",
  ],
...
| `type`                                                                             | [models.SyncListResponseTypeByoVpcAws](../models/synclistresponsetypebyovpcaws.md) | :heavy_check_mark:                                                                 | N/A                                                                                |
