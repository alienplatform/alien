...
```typescript
import { CreateSetupRegistrationOperationRequestCertificateTLSSecretRef2 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestCertificateTLSSecretRef2 = {
  secretName: "<value>",
  mode: "tlsSecretRef",
};
```
