...
```typescript
import { NewDeploymentRequestProviderAwsAlb2 } from "@alienplatform/platform-api/models";

let value: NewDeploymentRequestProviderAwsAlb2 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                             | [models.NewDeploymentRequestProviderAwsAlbEnum2](../models/newdeploymentrequestproviderawsalbenum2.md) | :heavy_check_mark:                                                                                     | N/A                                                                                                    |
