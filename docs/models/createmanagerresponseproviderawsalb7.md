...
```typescript
import { CreateManagerResponseProviderAwsAlb7 } from "@alienplatform/platform-api/models";

let value: CreateManagerResponseProviderAwsAlb7 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                               | [models.CreateManagerResponseProviderAwsAlbEnum7](../models/createmanagerresponseproviderawsalbenum7.md) | :heavy_check_mark:                                                                                       | N/A                                                                                                      |
