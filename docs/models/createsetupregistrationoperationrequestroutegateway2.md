...
```typescript
import { CreateSetupRegistrationOperationRequestRouteGateway2 } from "@alienplatform/platform-api/models";

let value: CreateSetupRegistrationOperationRequestRouteGateway2 = {
...
| `provider`                                                           | *models.CreateSetupRegistrationOperationRequestProviderUnion4*       | :heavy_minus_sign:                                                   | N/A                                                                  |
