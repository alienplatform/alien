...
```typescript
import { ManagerRetryResponseProviderAwsAlb5 } from "@alienplatform/platform-api/models";

let value: ManagerRetryResponseProviderAwsAlb5 = {
  provider: "awsAlb",
  scheme: "<value>",
  targetType: "<value>",
};
...
| `provider`                                                                                             | [models.ManagerRetryResponseProviderAwsAlbEnum5](../models/managerretryresponseproviderawsalbenum5.md) | :heavy_check_mark:                                                                                     | N/A                                                                                                    |
