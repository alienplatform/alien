...
```typescript
import { DeploymentConfigNetworkCreate } from "@alienplatform/platform-api/models";

let value: DeploymentConfigNetworkCreate = {
  type: "create",
};
```
...
| `type`                                                                                                              | [models.DeploymentConfigTypeCreate](../models/deploymentconfigtypecreate.md)                                        | :heavy_check_mark:                                                                                                  | N/A                                                                                                                 |