 ...
 */
export const BindingConfigurationGcpBindingSpecSchema = z
  .object({
    resource: z.optional(
      z
        .object({
...
export type BindingConfigurationGcpBindingSpec = z.infer<
  typeof BindingConfigurationGcpBindingSpecSchema
>;
