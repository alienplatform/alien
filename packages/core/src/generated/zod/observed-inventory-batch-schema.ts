...
export const ObservedInventoryBatchSchema = z.object({
  get backend() {
    return HeartbeatBackendSchema.describe(
  ...
  observedAt: z.iso
    .datetime()
    .describe("Time the inventory scope was observed."),
  get resources() {
...
export type ObservedInventoryBatch = z.infer<
  typeof ObservedInventoryBatchSchema
>;
