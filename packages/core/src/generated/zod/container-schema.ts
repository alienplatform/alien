...
export const ContainerSchema = z
  .object({
    ...
    cluster: z
      ...
      .nullish(),
    get code() {
      return ContainerCodeSchema.describe(
        "Specifies the source of the container's executable code."
      );
    },
    command: z
      .array(z.string())
      .describe("Command to override image default")
      .nullish(),
    ...
    environment: z.optional(
      z.object({}).catchall(z.string()).describe("Environment variables")
    ),
    ephemeralStorage: z
      .string()
      .describe('Ephemeral storage requirement (e.g., "10Gi")')
      .nullish(),
    get gpu() {
    ...
    get links() {
      return z
        ...
        .describe("Resource links (dependencies)");
    },
    get memory() {
      return ResourceSpecSchema.describe(
        "Resource specification with min/desired values."
    ...
    get ports() {
      return z
        .array(ContainerPortSchema.describe("Container port configuration."))
        .describe("Internal container ports (at least one required).");
    },
    get publicEndpoints() {
      return z
        .array(
        ...
        .describe("Public endpoints exposed by the container.")
        .optional();
    },
    replicas: z
      .int()
