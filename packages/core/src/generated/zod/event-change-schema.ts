 ...
 */
export const EventChangeSchema = z
  .union([
    z.object({
      createdAt: z.iso
        .datetime()
      ...
      get event() {
        return AlienEventSchema.describe(
      ...
      parentId: z
        .string()
        .describe("Parent event ID if this is a child event")
        .nullish(),
      get state() {
    ...
    z.object({
      ...
      updatedAt: z.iso
        .datetime()
        .describe("Timestamp when the event was updated"),
    }),
    z.object({
      id: z.string().describe("Unique identifier for the event"),
      get newState() {
