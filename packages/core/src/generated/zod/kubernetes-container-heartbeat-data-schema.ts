...
export const KubernetesContainerHeartbeatDataSchema = z.object({
    get "cpu"(){
...
export type KubernetesContainerHeartbeatData = z.infer<typeof KubernetesContainerHeartbeatDataSchema>