 ...
 */
export const PlatformPermissionsSchema = z
  .object({
    get aws() {
      return z
        .array(
          AwsPlatformPermissionSchema.describe(
            "AWS-specific platform permission configuration"
          )
        )
        .describe("AWS permission configurations")
        .nullish();
    },
    get azure() {
      return z
        .array(
          AzurePlatformPermissionSchema.describe(
            "Azure-specific platform permission configuration"
          )
        )
        .describe("Azure permission configurations")
        .nullish();
    },
    get gcp() {
      return z
        .array(
          GcpPlatformPermissionSchema.describe(
            "GCP-specific platform permission configuration"
          )
        )
        .describe("GCP permission configurations")
        .nullish();
    },
  })
