...
export const ArtifactRegistryHeartbeatDataSchema = z.union([
  z
    .lazy(() => AwsEcrArtifactRegistryHeartbeatDataSchema)
    .and(
      z.object({
  ...
  z
    .lazy(() => GcpArtifactRegistryHeartbeatDataSchema)
    .and(
      z.object({
  ...
  z
    .lazy(() => AzureContainerRegistryHeartbeatDataSchema)
    .and(
      z.object({
  ...
  z
    .lazy(() => LocalArtifactRegistryHeartbeatDataSchema)
    .and(
      z.object({
...
export type ArtifactRegistryHeartbeatData = z.infer<
  typeof ArtifactRegistryHeartbeatDataSchema
>;
