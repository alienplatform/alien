...
export const BuildConfigSchema = z
  .object({
    get computeType() {
      return ComputeTypeSchema.describe(
    ...
    image: z
      .string()
      .describe("Base container image to use for the build environment."),
    get monitoring() {
    ...
    timeoutSeconds: z
      .int()
      .min(0)
      .describe("Maximum execution time for the build in seconds."),
  })
