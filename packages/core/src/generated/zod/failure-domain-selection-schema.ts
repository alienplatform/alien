 ...
 */
export const FailureDomainSelectionSchema = z
  .object({
    selectedFailureDomains: z.optional(
      z
        .array(z.string())
        .describe(
...
export type FailureDomainSelection = z.infer<
  typeof FailureDomainSelectionSchema
>;
