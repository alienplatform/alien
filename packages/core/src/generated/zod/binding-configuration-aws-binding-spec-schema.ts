 ...
 */
export const BindingConfigurationAwsBindingSpecSchema = z
  .object({
    resource: z.optional(
      z
        .object({
          condition: z
            ...
            .describe("Optional condition for additional filtering (rare)")
            .nullish(),
...
export type BindingConfigurationAwsBindingSpec = z.infer<
  typeof BindingConfigurationAwsBindingSpecSchema
>;
