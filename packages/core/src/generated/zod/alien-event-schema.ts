 ...
 */
export const AlienEventSchema = z
  .union([
    z.object({
    ...
    z.object({
      ...
      resourceType: z
        .string()
        .describe('Type of the resource: "worker", "container"'),
    ...
    z.object({
      destination: z
        .string()
        .describe("Human-readable destination for pushed images")
        .nullish(),
    ...
    z.object({
      language: z
        .string()
        .describe("Language being compiled (rust, typescript, etc.)"),
      progress: z
        .string()
        .describe("Current progress/status line from the build output")
        .nullish(),
      type: z.enum(["CompilingCode"]),
    }),
    z.object({
      get nextState() {
        return StackStateSchema.describe(
    ...
    z.object({
      platform: z
        .string()
        .describe("Platform for which the template is being generated"),
    ...
    z.object({
      ...
      releaseId: z
        .string()
        .describe("ID of the release being deployed to the agent"),
    ...
    z.object({
      ...
      releaseId: z
        .string()
        .describe("ID of the new release being deployed to the agent"),
    ...
    z.object({
      ...
      releaseId: z
        .string()
        .describe("ID of the release that was running on the agent"),
    ...
    z.object({
      strategyName: z
        .string()
        .describe("Name of the deployment strategy being used"),
    ...
    z.object({
      ...
      strategyName: z
        .string()
        .describe("Name of the deployment strategy being used for cleanup"),
    ...
    z.object({
      platformName: z
        .string()
        .describe('Name of the platform (e.g., "AWS", "GCP")'),
    ...
    z.object({
      bucketNames: z
        .array(z.string())
        .describe("Names of the S3 buckets being emptied"),
