 ...
 */
export const AwsEmailImportDataSchema = z
  .object({
    configurationSet: z
      .string()
      .describe("SES configuration set name (used when sending)."),
    domains: z
      .object({})
      .catchall(
        z
          .lazy(() => AwsEmailDomainImportDataSchema)
          .describe("Per-domain import payload for an AWS Email resource.")
      )
      .describe("Per-seed-domain DNS data, keyed by mail domain."),
    ruleSetName: z
      .string()
      .describe(
