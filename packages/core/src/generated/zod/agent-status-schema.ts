...
export const AgentStatusSchema = z
  .object({
    commandsUrl: z
      .string()
      .describe("Commands endpoint URL for the deployment")
      .nullish(),
    ...
    resources: z
      ...
      .catchall(
        z
          .lazy(() => DevResourceInfoSchema)
          .describe("Information about a deployed resource")
      )
      .describe("Resources deployed by this agent (keyed by resource name)"),
    get status() {
      return DeploymentStatusSchema.describe(
