...
export const MonitoringConfigSchema = z
  .object({
    ...
    logsUri: z.optional(
      z.string().describe('Optional URI path for logs (defaults to "/v1/logs")')
    ),
    tlsEnabled: z.optional(
      z.boolean().describe("Whether to enable TLS/HTTPS (defaults to true)")
    ),
    tlsVerify: z.optional(
      z
        .boolean()
