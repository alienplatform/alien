 ...
 */
export const CustomCertificateConfigSchema = z
  .object({
    get aws() {
    ...
    get kubernetes() {
      return z
        .union([KubernetesCustomCertificateConfigSchema, z.null()])
        .optional();
    },
  })
  .describe("Platform-specific certificate references for custom domains.");

export type CustomCertificateConfig = z.infer<
  typeof CustomCertificateConfigSchema
>;
