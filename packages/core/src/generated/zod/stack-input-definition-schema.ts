 ...
 */
export const StackInputDefinitionSchema = z
  .object({
    get default() {
    ...
    get env() {
      return z
        .array(
          StackInputEnvironmentMappingSchema.describe(
            "How a resolved stack input is injected into runtime environment variables."
          )
        )
        .describe("Runtime env-var mappings for v1 input resolution.")
        .optional();
    },
    ...
    placeholder: z
      .string()
      .describe("Example placeholder shown in UI.")
      .nullish(),
    get platforms() {
      return z
        .array(PlatformSchema.describe("Represents the target cloud platform."))
        .describe("Platforms where this input applies.")
        .nullish();
    },
    get providedBy() {
      return z
        .array(
          StackInputProviderSchema.describe(
            "Who can provide a stack input value."
          )
        )
        .describe("Who can provide this value.");
    },
    required: z
      .boolean()
      .describe(
