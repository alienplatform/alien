...
export const ServiceActivationHeartbeatStatusSchema = z.object({
...
export type ServiceActivationHeartbeatStatus = z.infer<typeof ServiceActivationHeartbeatStatusSchema>