 ...
 */
export const StorageEventSchema = z
  .object({
    bucketName: z
      .string()
      .describe(
    ...
    contentType: z
      .string()
      .describe("Optional content type (MIME type) of the object.")
      .nullish(),
    copySource: z
      .string()
      .describe("Optional information about the source object for copy events.")
      .nullish(),
    currentTier: z
      .string()
      .describe(
    ...
    etag: z
      .string()
      .describe("Optional ETag or hash of the object content.")
      .nullish(),
    get eventType() {
      return StorageEventTypeSchema.describe(
    ...
    metadata: z.optional(
      z
        .object({})
        .catchall(z.string())
        .describe("Optional metadata associated with the object.")
    ),
    objectKey: z
      .string()
      .describe("The key or path of the object involved in the event."),
    previousTier: z
      .string()
      .describe(
    ...
    region: z
      .string()
      .describe("Optional region where the event originated.")
      .nullish(),
    size: z
      .int()
      .min(0)
      .describe("Optional size of the object in bytes.")
      .nullish(),
    timestamp: z.iso
      .datetime()
      .describe("The timestamp when the event occurred."),
    versionId: z
      .string()
      .describe(
