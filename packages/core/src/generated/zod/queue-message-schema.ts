...
export const QueueMessageSchema = z
  .object({
    ...
    get payload() {
      return MessagePayloadSchema.describe(
        "JSON-first message payload that supports both structured JSON and UTF-8 text"
      );
    },
    receiptHandle: z
      .string()
      .describe("Platform-specific receipt handle for acknowledgment"),
    source: z
      .string()
      .describe("Source queue/topic name (derived from ARN/source/topic)"),
    timestamp: z.iso
      .datetime()
      .describe(
