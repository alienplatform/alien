...
export const RemoteStackManagementHeartbeatStatusSchema = z.object({
...
export type RemoteStackManagementHeartbeatStatus = z.infer<typeof RemoteStackManagementHeartbeatStatusSchema>