...
export const ComputeClusterHeartbeatDataSchema = z.union([
  z
    .lazy(() => AwsComputeClusterHeartbeatDataSchema)
    .and(
      z.object({
        backend: z.enum(["aws"]),
      })
  ...
  z
    .lazy(() => GcpComputeClusterHeartbeatDataSchema)
    .and(
      z.object({
        backend: z.enum(["gcp"]),
      })
  ...
  z
    .lazy(() => AzureComputeClusterHeartbeatDataSchema)
    .and(
      z.object({
  ...
  z
    .lazy(() => MachinesComputeClusterHeartbeatDataSchema)
    .and(
      z.object({
  ...
  z
    .lazy(() => LocalComputeClusterHeartbeatDataSchema)
    .and(
      z.object({
...
export type ComputeClusterHeartbeatData = z.infer<
  typeof ComputeClusterHeartbeatDataSchema
>;
