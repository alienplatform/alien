 ...
 */
export const AwsOpenSearchSchema = z
  .object({
    get capacity() {
      return z.union([AwsOpenSearchCapacitySchema, z.null()]).optional();
    },
    get collectionType() {
      return AwsOpenSearchCollectionTypeSchema.describe(
