 ...
 */
export const StackResourceStateSchema = z
  .object({
    _internal: z.optional(
      z
        .any()
        .describe(
    ...
    get config() {
      return BaseResourceSchema.describe(
    ...
    remoteBindingParams: z.optional(
      z
        .any()
        .describe(
    ...
    get status() {
      return ResourceStatusSchema.describe(
