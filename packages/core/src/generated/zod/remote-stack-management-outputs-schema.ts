 ...
 */
export const RemoteStackManagementOutputsSchema = z
  .object({
...
export type RemoteStackManagementOutputs = z.infer<
  typeof RemoteStackManagementOutputsSchema
>;
