 ...
 */
export const AzureFlexibleServerPostgresImportDataSchema = z
  .object({
...
export type AzureFlexibleServerPostgresImportData = z.infer<
  typeof AzureFlexibleServerPostgresImportDataSchema
>;
