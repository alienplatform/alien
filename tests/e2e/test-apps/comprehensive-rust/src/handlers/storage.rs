...
pub async fn test_storage(
    ...
    // Note: WriteMultipart convenience API test was removed due to AWS S3 compatibility issues
    // The put_multipart_opts + put_part + complete pattern above already covers multipart uploads
