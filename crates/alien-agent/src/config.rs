...
use alien_core::{ExternalBindings, Platform, StackSettings, TelemetryMode, UpdatesMode};
use bon::Builder;
...
pub struct AgentConfig {
    ...
    /// External bindings for pre-existing infrastructure (Kubernetes platform only).
