...
use crate::{ImagePullCredentials, Platform, StackState};
...
pub struct RuntimeMetadata {
    ...
    /// Registry pull credentials for platforms that need explicit auth (Azure ACR).
    /// Generated by `reconcile_registry_access` and consumed by the deployment loop.
    #[serde(skip_serializing_if = "Option::is_none")]
