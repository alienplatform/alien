...
#[openapi(components(schemas(
    ...
    DaemonRolloutHeartbeatData,
    DaemonRolloutHeartbeatStatus,
    DaemonMachineRolloutHeartbeatData,
    DaemonMachineRolloutHeartbeatStatus,
    HeartbeatBackend,
    ...
    AwsWorkerImportData,
    AwsEmailImportData,
    AwsEmailDomainImportData,
    AwsEmailDkimTokenImportData,
    AwsOpenSearchImportData,
    AwsQueueImportData,
    AwsKvImportData,
    AwsKeyImportData,
    AwsVaultImportData,
