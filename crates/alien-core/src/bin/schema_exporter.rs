...
#[openapi(components(schemas(
    ...
    AwsContainerClusterImportData,
    GcpStorageImportData,
    GcpFunctionImportData,
    GcpQueueImportData,
    GcpKvImportData,
    GcpVaultImportData,
    ...
    GcpContainerClusterImportData,
    AzureStorageImportData,
    AzureFunctionImportData,
    ...
    AzureContainerClusterImportData,
