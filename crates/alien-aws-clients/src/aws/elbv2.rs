...
mod wire_tests {
    ...
    async fn modify_load_balancer_attributes_sends_aws_query_request() {
        ...
        Elbv2Client::new(Client::new(), AwsCredentialProvider::from_config_sync(config))
            .modify_load_balancer_attributes(ModifyLoadBalancerAttributesRequest::builder()
                .load_balancer_arn("arn:aws:elasticloadbalancing:us-east-1:123456789012:loadbalancer/net/example/abc".to_string())
                .attributes(vec![LoadBalancerAttribute { key: "load_balancing.cross_zone.enabled".to_string(), value: "true".to_string() }]).build())
