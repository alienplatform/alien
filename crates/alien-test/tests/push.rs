...
e2e_test_context!(AwsPushRust, Platform::Aws, DeploymentModel::Push, Language::Rust);
...
e2e_test_context!(AwsPushTypeScript, Platform::Aws, DeploymentModel::Push, Language::TypeScript);
...
e2e_test_context!(GcpPushRust, Platform::Gcp, DeploymentModel::Push, Language::Rust);
...
e2e_test_context!(GcpPushTypeScript, Platform::Gcp, DeploymentModel::Push, Language::TypeScript);
...
e2e_test_context!(AzurePushRust, Platform::Azure, DeploymentModel::Push, Language::Rust);
...
e2e_test_context!(AzurePushTypeScript, Platform::Azure, DeploymentModel::Push, Language::TypeScript);
