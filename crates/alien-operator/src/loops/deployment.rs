...
/// External bindings also populate DeploymentConfig for executor preflights.
...
mod tests {
    ...
    #[tokio::test]
    async fn enrich_config_passes_operator_bindings_to_executor() {
