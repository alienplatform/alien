...
pub struct BackendAddressInboundNatRulePortMappings {
    ...
    pub inbound_nat_rule_port_mappings: ::std::vec::Vec<InboundNatRulePortMapping>,
}
impl ::std::convert::From<&BackendAddressInboundNatRulePortMappings>
    for BackendAddressInboundNatRulePortMappings
{
    fn from(value: &BackendAddressInboundNatRulePortMappings) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for BackendAddressInboundNatRulePortMappings {
    fn default() -> Self {
        Self {
            inbound_nat_rule_port_mappings: Default::default(),
        }
    }
}
...
pub struct InboundNatPool {
    ...
    pub properties: ::std::option::Option<InboundNatPoolPropertiesFormat>,
    ///Type of the resource.
    #[serde(
        rename = "type",
        default,
...
impl ::std::convert::From<&InboundNatPool> for InboundNatPool {
    fn from(value: &InboundNatPool) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for InboundNatPool {
    fn default() -> Self {
        Self {
            etag: Default::default(),
            id: Default::default(),
...
impl ::std::convert::From<&InboundNatPoolPropertiesFormat> for InboundNatPoolPropertiesFormat {
    fn from(value: &InboundNatPoolPropertiesFormat) -> Self {
        value.clone()
    }
}
...
pub struct InboundNatRuleListResult {
    ...
    pub value: ::std::vec::Vec<InboundNatRule>,
}
impl ::std::convert::From<&InboundNatRuleListResult> for InboundNatRuleListResult {
    fn from(value: &InboundNatRuleListResult) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for InboundNatRuleListResult {
    fn default() -> Self {
        Self {
...
impl ::std::convert::From<&InboundNatRulePortMapping> for InboundNatRulePortMapping {
    fn from(value: &InboundNatRulePortMapping) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for InboundNatRulePortMapping {
    fn default() -> Self {
        Self {
...
pub struct IpConfigurationPropertiesFormat {
    ...
    pub public_ip_address: ::std::boxed::Box<::std::option::Option<PublicIpAddress>>,
    #[serde(
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
...
pub struct LoadBalancer {
    ...
    pub properties: ::std::option::Option<LoadBalancerPropertiesFormat>,
    #[serde(
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
    )]
    pub sku: ::std::option::Option<LoadBalancerSku>,
    ///Resource tags.
    #[serde(
        default,
        skip_serializing_if = ":: std :: collections :: HashMap::is_empty",
...
impl ::std::convert::From<&LoadBalancer> for LoadBalancer {
    fn from(value: &LoadBalancer) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancer {
    fn default() -> Self {
        Self {
            etag: Default::default(),
...
pub struct LoadBalancerBackendAddressPoolListResult {
    ...
    pub value: ::std::vec::Vec<BackendAddressPool>,
}
impl ::std::convert::From<&LoadBalancerBackendAddressPoolListResult>
    for LoadBalancerBackendAddressPoolListResult
{
    fn from(value: &LoadBalancerBackendAddressPoolListResult) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerBackendAddressPoolListResult {
    fn default() -> Self {
        Self {
            next_link: Default::default(),
            value: Default::default(),
...
pub struct LoadBalancerFrontendIpConfigurationListResult {
    ...
    pub value: ::std::vec::Vec<FrontendIpConfiguration>,
}
impl ::std::convert::From<&LoadBalancerFrontendIpConfigurationListResult>
    for LoadBalancerFrontendIpConfigurationListResult
{
    fn from(value: &LoadBalancerFrontendIpConfigurationListResult) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerFrontendIpConfigurationListResult {
    fn default() -> Self {
        Self {
            next_link: Default::default(),
            value: Default::default(),
...
///      "type": "array",
///      "items": {
///        "$ref": "#/components/schemas/LoadBalancerHealthPerRulePerBackendAddress"
///      }
///    },
///    "up": {
...
/// </details>
#[derive(::serde::Deserialize, ::serde::Serialize, Clone, Debug)]
pub struct LoadBalancerHealthPerRule {
    ...
    pub down: ::std::option::Option<i32>,
    ...
    pub load_balancer_backend_addresses:
        ::std::vec::Vec<LoadBalancerHealthPerRulePerBackendAddress>,
    ...
    pub up: ::std::option::Option<i32>,
}
impl ::std::convert::From<&LoadBalancerHealthPerRule> for LoadBalancerHealthPerRule {
    fn from(value: &LoadBalancerHealthPerRule) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerHealthPerRule {
    fn default() -> Self {
        Self {
...
/// </details>
#[derive(::serde::Deserialize, ::serde::Serialize, Clone, Debug)]
pub struct LoadBalancerHealthPerRulePerBackendAddress {
    ...
    #[serde(
        rename = "networkInterfaceIPConfigurationId",
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
    )]
    pub network_interface_ip_configuration_id: ::std::option::Option<::std::string::String>,
...
impl ::std::convert::From<&LoadBalancerHealthPerRulePerBackendAddress>
    for LoadBalancerHealthPerRulePerBackendAddress
{
    fn from(value: &LoadBalancerHealthPerRulePerBackendAddress) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerHealthPerRulePerBackendAddress {
    fn default() -> Self {
        Self {
            ip_address: Default::default(),
            network_interface_ip_configuration_id: Default::default(),
...
pub struct LoadBalancerListResult {
    ...
    pub value: ::std::vec::Vec<LoadBalancer>,
}
impl ::std::convert::From<&LoadBalancerListResult> for LoadBalancerListResult {
    fn from(value: &LoadBalancerListResult) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerListResult {
    fn default() -> Self {
        Self {
            next_link: Default::default(),
            value: Default::default(),
...
pub struct LoadBalancerLoadBalancingRuleListResult {
    ...
    pub value: ::std::vec::Vec<LoadBalancingRule>,
}
impl ::std::convert::From<&LoadBalancerLoadBalancingRuleListResult>
    for LoadBalancerLoadBalancingRuleListResult
{
    fn from(value: &LoadBalancerLoadBalancingRuleListResult) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerLoadBalancingRuleListResult {
    fn default() -> Self {
        Self {
            next_link: Default::default(),
            value: Default::default(),
...
pub struct LoadBalancerOutboundRuleListResult {
    ...
    pub value: ::std::vec::Vec<OutboundRule>,
}
impl ::std::convert::From<&LoadBalancerOutboundRuleListResult>
    for LoadBalancerOutboundRuleListResult
{
    fn from(value: &LoadBalancerOutboundRuleListResult) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerOutboundRuleListResult {
    fn default() -> Self {
        Self {
            next_link: Default::default(),
            value: Default::default(),
...
pub struct LoadBalancerProbeListResult {
    ...
    pub value: ::std::vec::Vec<Probe>,
}
impl ::std::convert::From<&LoadBalancerProbeListResult> for LoadBalancerProbeListResult {
    fn from(value: &LoadBalancerProbeListResult) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerProbeListResult {
    fn default() -> Self {
        Self {
            next_link: Default::default(),
            value: Default::default(),
...
pub struct LoadBalancerPropertiesFormat {
    ...
    pub backend_address_pools: ::std::vec::Vec<BackendAddressPool>,
    ...
    pub frontend_ip_configurations: ::std::vec::Vec<FrontendIpConfiguration>,
    ...
    pub inbound_nat_pools: ::std::vec::Vec<InboundNatPool>,
    ...
    pub inbound_nat_rules: ::std::vec::Vec<InboundNatRule>,
    ...
    pub load_balancing_rules: ::std::vec::Vec<LoadBalancingRule>,
    ///The outbound rules.
    #[serde(
        rename = "outboundRules",
        default,
    ...
    pub outbound_rules: ::std::vec::Vec<OutboundRule>,
    ...
    pub scope: ::std::option::Option<LoadBalancerPropertiesFormatScope>,
}
impl ::std::convert::From<&LoadBalancerPropertiesFormat> for LoadBalancerPropertiesFormat {
    fn from(value: &LoadBalancerPropertiesFormat) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerPropertiesFormat {
    fn default() -> Self {
        Self {
            backend_address_pools: Default::default(),
            frontend_ip_configurations: Default::default(),
            inbound_nat_pools: Default::default(),
            inbound_nat_rules: Default::default(),
            load_balancing_rules: Default::default(),
            outbound_rules: Default::default(),
...
#[serde(try_from = "String")]
pub enum LoadBalancerPropertiesFormatScope {
    Public,
    Private,
}
impl ::std::convert::From<&Self> for LoadBalancerPropertiesFormatScope {
    fn from(value: &LoadBalancerPropertiesFormatScope) -> Self {
        value.clone()
    }
}
impl ::std::fmt::Display for LoadBalancerPropertiesFormatScope {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
...
impl ::std::str::FromStr for LoadBalancerPropertiesFormatScope {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value.to_ascii_lowercase().as_str() {
...
impl ::std::convert::TryFrom<&str> for LoadBalancerPropertiesFormatScope {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for LoadBalancerPropertiesFormatScope {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
pub struct LoadBalancerSku {
    ...
    pub name: ::std::option::Option<LoadBalancerSkuName>,
    ...
    pub tier: ::std::option::Option<LoadBalancerSkuTier>,
}
impl ::std::convert::From<&LoadBalancerSku> for LoadBalancerSku {
    fn from(value: &LoadBalancerSku) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerSku {
    fn default() -> Self {
        Self {
            name: Default::default(),
...
impl ::std::convert::From<&Self> for LoadBalancerSkuName {
    fn from(value: &LoadBalancerSkuName) -> Self {
        value.clone()
    }
}
impl ::std::fmt::Display for LoadBalancerSkuName {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
...
impl ::std::str::FromStr for LoadBalancerSkuName {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value.to_ascii_lowercase().as_str() {
            "basic" => Ok(Self::Basic),
...
impl ::std::convert::TryFrom<&str> for LoadBalancerSkuName {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for LoadBalancerSkuName {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::From<&Self> for LoadBalancerSkuTier {
    fn from(value: &LoadBalancerSkuTier) -> Self {
        value.clone()
    }
}
impl ::std::fmt::Display for LoadBalancerSkuTier {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
...
impl ::std::str::FromStr for LoadBalancerSkuTier {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value.to_ascii_lowercase().as_str() {
...
impl ::std::convert::TryFrom<&str> for LoadBalancerSkuTier {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for LoadBalancerSkuTier {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
pub struct LoadBalancerVipSwapRequest {
    ...
    pub frontend_ip_configurations:
        ::std::vec::Vec<LoadBalancerVipSwapRequestFrontendIpConfiguration>,
}
impl ::std::convert::From<&LoadBalancerVipSwapRequest> for LoadBalancerVipSwapRequest {
    fn from(value: &LoadBalancerVipSwapRequest) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerVipSwapRequest {
    fn default() -> Self {
        Self {
            frontend_ip_configurations: Default::default(),
        }
...
///    },
///    "properties": {
///      "$ref": "#/components/schemas/LoadBalancerVipSwapRequestFrontendIPConfigurationProperties"
///    }
///  }
///}
/// ```
...
pub struct LoadBalancerVipSwapRequestFrontendIpConfiguration {
    ...
    pub properties:
        ::std::option::Option<LoadBalancerVipSwapRequestFrontendIpConfigurationProperties>,
}
impl ::std::convert::From<&LoadBalancerVipSwapRequestFrontendIpConfiguration>
    for LoadBalancerVipSwapRequestFrontendIpConfiguration
{
    fn from(value: &LoadBalancerVipSwapRequestFrontendIpConfiguration) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerVipSwapRequestFrontendIpConfiguration {
    fn default() -> Self {
        Self {
            id: Default::default(),
            properties: Default::default(),
...
pub struct LoadBalancerVipSwapRequestFrontendIpConfigurationProperties {
    ...
    pub public_ip_address: ::std::option::Option<SubResource>,
}
impl ::std::convert::From<&LoadBalancerVipSwapRequestFrontendIpConfigurationProperties>
    for LoadBalancerVipSwapRequestFrontendIpConfigurationProperties
{
    fn from(value: &LoadBalancerVipSwapRequestFrontendIpConfigurationProperties) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancerVipSwapRequestFrontendIpConfigurationProperties {
    fn default() -> Self {
        Self {
            public_ip_address: Default::default(),
        }
...
pub struct LoadBalancingRule {
    ...
    pub properties: ::std::option::Option<LoadBalancingRulePropertiesFormat>,
    ///Type of the resource.
    #[serde(
        rename = "type",
        default,
...
impl ::std::convert::From<&LoadBalancingRule> for LoadBalancingRule {
    fn from(value: &LoadBalancingRule) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for LoadBalancingRule {
    fn default() -> Self {
        Self {
            etag: Default::default(),
            id: Default::default(),
...
pub struct LoadBalancingRulePropertiesFormat {
    ...
    pub backend_address_pools: ::std::vec::Vec<SubResource>,
    ...
    #[serde(
        rename = "disableOutboundSnat",
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
    )]
    pub disable_outbound_snat: ::std::option::Option<bool>,
    ...
    #[serde(
        rename = "enableConnectionTracking",
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
    )]
    pub enable_connection_tracking: ::std::option::Option<bool>,
    ///Configures a virtual machine's endpoint for the floating IP capability required to configure a SQL AlwaysOn Availability Group. This setting is required when using the SQL AlwaysOn Availability Groups in SQL server. This setting can't be changed after you create the endpoint.
    #[serde(
        rename = "enableFloatingIP",
        default,
    ...
    pub load_distribution: ::std::option::Option<LoadBalancingRulePropertiesFormatLoadDistribution>,
    #[serde(
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
    )]
    pub probe: ::std::option::Option<SubResource>,
    pub protocol: TransportProtocol,
    #[serde(
        rename = "provisioningState",
        default,
...
impl ::std::convert::From<&LoadBalancingRulePropertiesFormat>
    for LoadBalancingRulePropertiesFormat
{
    fn from(value: &LoadBalancingRulePropertiesFormat) -> Self {
        value.clone()
    }
}
///The load distribution policy for this rule.
...
#[serde(try_from = "String")]
pub enum LoadBalancingRulePropertiesFormatLoadDistribution {
    Default,
...
impl ::std::convert::From<&Self> for LoadBalancingRulePropertiesFormatLoadDistribution {
    fn from(value: &LoadBalancingRulePropertiesFormatLoadDistribution) -> Self {
        value.clone()
    }
}
impl ::std::fmt::Display for LoadBalancingRulePropertiesFormatLoadDistribution {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::Default => f.write_str("Default"),
            Self::SourceIp => f.write_str("SourceIP"),
            Self::SourceIpProtocol => f.write_str("SourceIPProtocol"),
        }
    }
}
impl ::std::str::FromStr for LoadBalancingRulePropertiesFormatLoadDistribution {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value.to_ascii_lowercase().as_str() {
...
impl ::std::convert::TryFrom<&str> for LoadBalancingRulePropertiesFormatLoadDistribution {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
...
impl ::std::convert::TryFrom<&::std::string::String>
    for LoadBalancingRulePropertiesFormatLoadDistribution
{
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
...
pub struct MigrateLoadBalancerToIpBasedRequest {
    ...
    pub pools: ::std::vec::Vec<::std::string::String>,
}
impl ::std::convert::From<&MigrateLoadBalancerToIpBasedRequest>
    for MigrateLoadBalancerToIpBasedRequest
{
    fn from(value: &MigrateLoadBalancerToIpBasedRequest) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for MigrateLoadBalancerToIpBasedRequest {
    fn default() -> Self {
        Self {
...
pub struct MigratedPools {
    ...
    pub migrated_pools: ::std::vec::Vec<::std::string::String>,
}
impl ::std::convert::From<&MigratedPools> for MigratedPools {
    fn from(value: &MigratedPools) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for MigratedPools {
    fn default() -> Self {
        Self {
            migrated_pools: Default::default(),
        }
    }
}
...
pub struct NetworkInterfaceListResult {
    ...
    pub value: ::std::vec::Vec<NetworkInterface>,
}
impl ::std::convert::From<&NetworkInterfaceListResult> for NetworkInterfaceListResult {
    fn from(value: &NetworkInterfaceListResult) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for NetworkInterfaceListResult {
    fn default() -> Self {
        Self {
            next_link: Default::default(),
            value: Default::default(),
...
///    },
///    "properties": {
///      "$ref": "#/components/schemas/OutboundRulePropertiesFormat"
///    },
///    "type": {
///      "description": "Type of the resource.",
///      "readOnly": true,
...
pub struct OutboundRule {
    ...
    pub properties: ::std::option::Option<OutboundRulePropertiesFormat>,
    ///Type of the resource.
    #[serde(
        rename = "type",
        default,
...
impl ::std::convert::From<&OutboundRule> for OutboundRule {
    fn from(value: &OutboundRule) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for OutboundRule {
    fn default() -> Self {
        Self {
            etag: Default::default(),
            id: Default::default(),
...
pub struct OutboundRulePropertiesFormat {
    ...
    #[serde(
        rename = "allocatedOutboundPorts",
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
    )]
    pub allocated_outbound_ports: ::std::option::Option<i32>,
    ...
    pub frontend_ip_configurations: ::std::vec::Vec<SubResource>,
    ...
    pub idle_timeout_in_minutes: ::std::option::Option<i64>,
    ///The protocol for the outbound rule in load balancer.
    pub protocol: OutboundRulePropertiesFormatProtocol,
    #[serde(
        rename = "provisioningState",
        default,
        skip_serializing_if = "::std::option::Option::is_none",
...
impl ::std::convert::From<&OutboundRulePropertiesFormat> for OutboundRulePropertiesFormat {
    fn from(value: &OutboundRulePropertiesFormat) -> Self {
        value.clone()
    }
}
///The protocol for the outbound rule in load balancer.
...
#[serde(try_from = "String")]
pub enum OutboundRulePropertiesFormatProtocol {
    Tcp,
    Udp,
    All,
}
impl ::std::convert::From<&Self> for OutboundRulePropertiesFormatProtocol {
    fn from(value: &OutboundRulePropertiesFormatProtocol) -> Self {
        value.clone()
    }
}
impl ::std::fmt::Display for OutboundRulePropertiesFormatProtocol {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
...
impl ::std::str::FromStr for OutboundRulePropertiesFormatProtocol {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value.to_ascii_lowercase().as_str() {
            "tcp" => Ok(Self::Tcp),
...
impl ::std::convert::TryFrom<&str> for OutboundRulePropertiesFormatProtocol {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for OutboundRulePropertiesFormatProtocol {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
pub struct Probe {
    ...
    pub properties: ::std::option::Option<ProbePropertiesFormat>,
    ///Type of the resource.
    #[serde(
        rename = "type",
        default,
...
pub struct ProbePropertiesFormat {
    ...
    #[serde(
        rename = "noHealthyBackendsBehavior",
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
    )]
    pub no_healthy_backends_behavior:
        ::std::option::Option<ProbePropertiesFormatNoHealthyBackendsBehavior>,
    ///The number of probes where if no response, will result in stopping further traffic from being delivered to the endpoint. This values allows endpoints to be taken out of rotation faster or slower than the typical times used in Azure.
    #[serde(
        rename = "numberOfProbes",
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
    )]
    pub number_of_probes: ::std::option::Option<i32>,
    ...
    pub protocol: ProbePropertiesFormatProtocol,
    #[serde(
        rename = "provisioningState",
        default,
        skip_serializing_if = "::std::option::Option::is_none",
...
impl ::std::convert::From<&ProbePropertiesFormat> for ProbePropertiesFormat {
    fn from(value: &ProbePropertiesFormat) -> Self {
        value.clone()
    }
}
///Determines how new connections are handled by the load balancer when all backend instances are probed down.
...
#[serde(try_from = "String")]
pub enum ProbePropertiesFormatNoHealthyBackendsBehavior {
    AllProbedDown,
    AllProbedUp,
}
impl ::std::convert::From<&Self> for ProbePropertiesFormatNoHealthyBackendsBehavior {
    fn from(value: &ProbePropertiesFormatNoHealthyBackendsBehavior) -> Self {
        value.clone()
    }
}
impl ::std::fmt::Display for ProbePropertiesFormatNoHealthyBackendsBehavior {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::AllProbedDown => f.write_str("AllProbedDown"),
            Self::AllProbedUp => f.write_str("AllProbedUp"),
        }
    }
}
impl ::std::str::FromStr for ProbePropertiesFormatNoHealthyBackendsBehavior {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value.to_ascii_lowercase().as_str() {
...
impl ::std::convert::TryFrom<&str> for ProbePropertiesFormatNoHealthyBackendsBehavior {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
...
impl ::std::convert::TryFrom<&::std::string::String>
    for ProbePropertiesFormatNoHealthyBackendsBehavior
{
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
...
#[serde(try_from = "String")]
pub enum ProbePropertiesFormatProtocol {
    Http,
    Tcp,
    Https,
}
impl ::std::convert::From<&Self> for ProbePropertiesFormatProtocol {
    fn from(value: &ProbePropertiesFormatProtocol) -> Self {
        value.clone()
    }
}
impl ::std::fmt::Display for ProbePropertiesFormatProtocol {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
...
impl ::std::str::FromStr for ProbePropertiesFormatProtocol {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value.to_ascii_lowercase().as_str() {
            "http" => Ok(Self::Http),
...
impl ::std::convert::TryFrom<&str> for ProbePropertiesFormatProtocol {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for ProbePropertiesFormatProtocol {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
pub struct PublicIpAddress {
    ...
    pub properties: ::std::option::Option<PublicIpAddressPropertiesFormat>,
    #[serde(
        default,
        skip_serializing_if = "::std::option::Option::is_none",
        deserialize_with = "serde_aux::field_attributes::deserialize_default_from_null"
...
pub struct QueryInboundNatRulePortMappingRequest {
    ...
    pub ip_configuration: ::std::option::Option<SubResource>,
}
impl ::std::convert::From<&QueryInboundNatRulePortMappingRequest>
    for QueryInboundNatRulePortMappingRequest
{
    fn from(value: &QueryInboundNatRulePortMappingRequest) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for QueryInboundNatRulePortMappingRequest {
    fn default() -> Self {
        Self {
            ip_address: Default::default(),
            ip_configuration: Default::default(),
