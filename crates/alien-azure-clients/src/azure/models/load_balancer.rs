...
impl ::std::convert::From<&InboundNatPoolPropertiesFormat>
for InboundNatPoolPropertiesFormat {
...
pub struct LoadBalancerHealthPerRule {
    ...
    pub load_balancer_backend_addresses: ::std::vec::Vec<
...
pub struct LoadBalancerHealthPerRulePerBackendAddress {
    ...
    pub network_interface_ip_configuration_id: ::std::option::Option<
        ::std::string::String,
    >,
...
impl ::std::convert::From<&LoadBalancerPropertiesFormat>
for LoadBalancerPropertiesFormat {
...
impl ::std::convert::TryFrom<&::std::string::String>
for LoadBalancerPropertiesFormatScope {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
pub struct LoadBalancerVipSwapRequest {
    ...
    pub frontend_ip_configurations: ::std::vec::Vec<
...
for LoadBalancerVipSwapRequestFrontendIpConfigurationProperties {
    fn from(
        value: &LoadBalancerVipSwapRequestFrontendIpConfigurationProperties,
    ) -> Self {
        value.clone()
    }
}
...
pub struct LoadBalancingRulePropertiesFormat {
    ...
    pub load_distribution: ::std::option::Option<
...
impl ::std::convert::From<&OutboundRulePropertiesFormat>
for OutboundRulePropertiesFormat {
...
impl ::std::convert::TryFrom<&::std::string::String>
for OutboundRulePropertiesFormatProtocol {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
pub struct ProbePropertiesFormat {
    ...
    pub no_healthy_backends_behavior: ::std::option::Option<
        ProbePropertiesFormatNoHealthyBackendsBehavior,
    >,
