...
impl ::std::default::Default for NetworkSecurityGroupListResult {
    fn default() -> Self {
        Self {
...
pub struct SecurityRuleListResult {
    ...
    pub value: ::std::vec::Vec<SecurityRule>,
}
impl ::std::convert::From<&SecurityRuleListResult> for SecurityRuleListResult {
    fn from(value: &SecurityRuleListResult) -> Self {
        value.clone()
    }
}
impl ::std::default::Default for SecurityRuleListResult {
    fn default() -> Self {
        Self {
            next_link: Default::default(),
            value: Default::default(),
