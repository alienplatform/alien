...
impl AsyncTestContext for ContainerAppTestContext {
    async fn setup() -> Self {
        ...
        let (application_port, transport_port) = test_utils::distinct_free_local_ports()
            .expect("Failed to find distinct ports for app and ContainerApp transport");
        info!(%application_port, %transport_port, "Resolved application and ContainerApp transport ports");
        ...
        info!("Starting alien-worker-runtime programmatically with ContainerApp transport...");
