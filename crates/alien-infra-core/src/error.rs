...
pub enum ErrorData {
    /// A provider service was registered more than once.
    #[error(
        code = "SERVICE_ALREADY_REGISTERED",
        message = "Provider service '{service_type}' is already registered",
        retryable = "false",
        internal = "true"
    )]
    ServiceAlreadyRegistered {
        /// Rust type name used as the service registry key.
        service_type: String,
    },

    /// A required provider service was not registered.
    #[error(
        code = "SERVICE_NOT_REGISTERED",
        message = "Required provider service '{service_type}' is not registered",
        retryable = "false",
        internal = "true"
    )]
