...
impl AwsSandboxController {
    ...
    async fn creating_image(
        ...
        let client = ctx
            .services
            .require::<dyn crate::core::AwsServiceProvider>()?
...
impl AwsSandboxController {
    ...
    pub fn from_persisted(mut value: serde_json::Value) -> serde_json::Result<Self> {
    ...
    pub fn merge_imported_state(existing: Self, imported: Self) -> Self {
        Self {
            build_role_arn: imported.build_role_arn.or(existing.build_role_arn.clone()),
            egress_connector_arns: imported.egress_connector_arns,
            allow_egress: imported.allow_egress,
            preview_ports: imported.preview_ports,
            region: imported.region.or(existing.region.clone()),
            ..existing
        }
    }
