...
impl AwsFunctionController {
    ...
    async fn applying_resource_permissions(
        ...
        {
            self.apply_resource_scoped_permissions(ctx, &function_name)
                .await?;
        }
...
impl AwsFunctionController {
    /// Applies resource-scoped permissions to the Lambda function from stack permission profiles
    async fn apply_resource_scoped_permissions(
        ...
        let mut permission_context = alien_permissions::PermissionContext::new()
            ...
            .with_resource_name(function_name.to_string());
    ...
    async fn process_profile_permissions(
        ...
        for permission_set_ref in permission_set_refs {
            ...
            info!(
                ...
                "Applied resource-scoped function permission"
            );
        }
