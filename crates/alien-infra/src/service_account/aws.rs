...
impl AwsServiceAccountController {
    ...
    fn generate_assume_role_policy_for_service_account(
        ...
        // Serialize to JSON
        serde_json::to_string(&trust_policy).map_err(|e| {
            AlienError::new(ErrorData::InfrastructureError {
                message: format!("Failed to serialize trust policy document: {}", e),
    ...
    fn generate_stack_policy_document(
        ...
        let policy_document = serde_json::to_string_pretty(&final_policy).map_err(|e| {
            AlienError::new(ErrorData::InfrastructureError {
