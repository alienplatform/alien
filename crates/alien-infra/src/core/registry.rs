...
impl ResourceRegistry {
    ...
    pub fn with_built_ins() -> Self {
        ...
        // Register AWS ContainerCluster controller
        #[cfg(feature = "aws")]
        registry.register_controller_factory(
            ContainerCluster::RESOURCE_TYPE,
            Platform::Aws,
            Box::new(DefaultControllerFactory::<
                crate::container_cluster::AwsContainerClusterController,
            >::new()),
        );

        // Register AWS ContainerCluster CloudFormation importer
        #[cfg(feature = "aws")]
        {
            registry.register_cloudformation_importer_factory(
                ContainerCluster::RESOURCE_TYPE,
                Platform::Aws,
                Box::new(DefaultCloudFormationImporterFactory::<
                    crate::container_cluster::AwsContainerClusterCloudFormationImporter,
                >::new()),
            );
        }

        // Register GCP ContainerCluster controller
        #[cfg(feature = "gcp")]
        registry.register_controller_factory(
            ContainerCluster::RESOURCE_TYPE,
            Platform::Gcp,
            Box::new(DefaultControllerFactory::<
                crate::container_cluster::GcpContainerClusterController,
            >::new()),
        );

        // Register Azure ContainerCluster controller
        #[cfg(feature = "azure")]
        registry.register_controller_factory(
            ContainerCluster::RESOURCE_TYPE,
            Platform::Azure,
            Box::new(DefaultControllerFactory::<
                crate::container_cluster::AzureContainerClusterController,
            >::new()),
        );
        ...
        // Register AWS Container controller
        #[cfg(feature = "aws")]
        registry.register_controller_factory(
            Container::RESOURCE_TYPE,
            Platform::Aws,
            Box::new(DefaultControllerFactory::<
                crate::container::AwsContainerController,
            >::new()),
        );

        // Register GCP Container controller
        #[cfg(feature = "gcp")]
        registry.register_controller_factory(
            Container::RESOURCE_TYPE,
            Platform::Gcp,
            Box::new(DefaultControllerFactory::<
                crate::container::GcpContainerController,
            >::new()),
        );

        // Register Azure Container controller
        #[cfg(feature = "azure")]
        registry.register_controller_factory(
            Container::RESOURCE_TYPE,
            Platform::Azure,
            Box::new(DefaultControllerFactory::<
                crate::container::AzureContainerController,
            >::new()),
        );
