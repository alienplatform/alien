...
pub struct AzureNetworkController {
    ...
    pub(crate) vnet_name: Option<String>,
    pub(crate) vnet_resource_id: Option<String>,
    pub(crate) public_subnet_name: Option<String>,
    pub(crate) private_subnet_name: Option<String>,
