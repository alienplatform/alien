...
use alien_core::{
    import::ImportSourceKind, sync::OperatorCapabilityReport, DeploymentConfig, DeploymentState,
    EnvironmentInfo, EnvironmentVariable, ManagementConfig, ObservedInventoryBatch, Platform,
