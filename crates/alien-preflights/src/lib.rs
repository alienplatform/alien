...
impl PreflightRegistry {
    ...
    pub fn with_built_ins() -> Self {
        ...
        registry.add_compile_time_check(Box::new(compile_time::KubernetesSecretMountsCheck));
        ...
        registry.add_mutation(Box::new(mutations::GcpAgentPlatformEngineMutation));
